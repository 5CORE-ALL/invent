...
namespace App\Http\Controllers\AdvertisementMaster\MetaParent;
...
class ProductWiseMetaParentController extends Controller
{
    ...
    public function FacebookImage(Request $request)
    {
        ...
        return view('advertisement-master.promoted-advt-ebay', [
            ...
            'subtitle' => 'Facebook',
            'pagination_title' => 'Facebook Analysis',
            'mode' => $mode,
            'demo' => $demo,
            'amazonPercentage' => $percentage
        ]);
    }
     public function InstagramImage(Request $request)
    {
        $mode = $request->query('mode');
        $demo = $request->query('demo');
        ...
        return view('advertisement-master.promoted-advt-ebay', [
            ...
            'subtitle' => 'Instagram',
            'pagination_title' => 'Instagram Analysis',
            'mode' => $mode,
            'demo' => $demo,
            'amazonPercentage' => $percentage
        ]);
    }
     public function FacebookVideo(Request $request)
    {
        $mode = $request->query('mode');
        $demo = $request->query('demo');
     ...
     public function InstagramVideo(Request $request)
    {
        $mode = $request->query('mode');
        $demo = $request->query('demo');
