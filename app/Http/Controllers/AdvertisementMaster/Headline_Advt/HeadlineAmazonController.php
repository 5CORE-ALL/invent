...
namespace App\Http\Controllers\AdvertisementMaster\Headline_Advt;

use App\Http\Controllers\ApiController;
use App\Http\Controllers\Controller;
use App\Models\ProductMaster;
use App\Models\ShopifySku;
use App\Models\HeadAmazon;
...
class HeadlineAmazonController extends Controller
{
    ...
    public function Amazon(Request $request)
    {
        ...
        $skuFlags = HeadAmazon::select('sku', 'ra', 'nra', 'running', 'to_pause', 'paused')
        ->get()
        ...
        return view('advertisement-master.headline-advt-amazon', [
    ...
    public function update(Request $request)
    {
        ...
        $item = HeadAmazon::firstOrNew(['sku' => $sku]);
        $item->$field = $value;
        $item->save();
