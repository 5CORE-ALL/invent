...
class TrustImageController extends Controller
{
    public function trustImagesMaster()
    {
        return view('trust-images-master');
    }

    public function getTrustImagesMasterData(Request $request)
    {
