...
class BenefitsImageController extends Controller
{
    public function benefitsImagesMaster()
    {
        return view('benefits-images-master');
    }

    public function getBenefitsImagesMasterData(Request $request)
    {
