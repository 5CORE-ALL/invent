...
class InfographicsImageController extends Controller
{
    public function infographicsImagesMaster()
    {
        return view('infographics-images-master');
    }

    public function getInfographicsImagesMasterData(Request $request)
    {
