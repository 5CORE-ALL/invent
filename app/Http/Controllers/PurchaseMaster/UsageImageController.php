...
class UsageImageController extends Controller
{
    public function usageImagesMaster()
    {
        return view('usage-images-master');
    }

    public function getUsageImagesMasterData(Request $request)
    {
