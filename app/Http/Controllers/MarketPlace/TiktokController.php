...
class TiktokController extends Controller
{
    ...
    public function getViewTiktokData(Request $request)
    {
        ...
        foreach ($productMasterRows as $productMaster) {
            ...
            if (isset($tiktokData[$sku])) {
                $tiktokItem = $tiktokData[$sku];
                $tiktokPrice = $tiktokItem->price ?? 0;
                $ship = $values["ship"] ?? 0;

                $processedItem["price"] = $tiktokPrice > 0 ? $tiktokPrice + $ship : 0;
                $processedItem["t_l30"] = $tiktokItem->shopify_tiktokl30 ?? 0;
                $processedItem["t_l60"] = $tiktokItem->shopify_tiktokl60 ?? 0;
            } else {
                $processedItem["price"] = 0;
                $processedItem["t_l30"] = 0;
                $processedItem["t_l60"] = 0;
            }
