...
class FaireListingVariationVerifyController extends Controller
{
    ...
    {
        return view('market-places.faire_listing_variation_verify');
    }
    ...
    public function pullListings(Request $request)
    {
        try {
            ...
            Log::error('Faire Listing Variation Verify: pull listings failed', [
                'error' => $e->getMessage(),
            ]);
    ...
    /**
     * Same normalize as FaireController::normalizeFaireSkuExact.
     */
