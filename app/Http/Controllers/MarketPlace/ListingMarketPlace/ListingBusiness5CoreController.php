...
{
    public function listingBusiness5Core(Request $request)
    {
        ...
        return view('market-places.listing-market-places.listingBusiness5Core', [
            'business5CorePercentage' => $percentage,
            'mode' => $mode,
            'demo' => $demo,
        ]);
    }

    public function getViewListingBusiness5CoreData(Request $request)
    {
    ...
    public function saveStatus(Request $request)
    {
        ...
        $sku = $validated['sku'];
        $status = Business5CoreListingStatus::where('sku', $sku)->first();
        ...
        Business5CoreListingStatus::updateOrCreate(
            ['sku' => $validated['sku']],
            ['value' => $existing]
        );
