...
class ListingShopifyB2CController extends Controller
{
    public function listingShopifyB2C(Request $request)
    {
        ...
        return view('market-places.listing-market-places.listingShopifyB2C', [
    ...
    public function getViewListingShopifyB2CData(Request $request)
    {
        return response()->json([
            'status' => 200,
            'data' => AutomatedListingPage::rows('shopifyb2c'),
        ]);
    }
    ...
    {
        return ChannelListingRegistry::nrReqCountArray('shopifyb2c');
    }
