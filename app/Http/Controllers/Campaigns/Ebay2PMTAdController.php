...
class Ebay2PMTAdController extends Controller
{
    public function index()
    {
        ...
        $data = DB::table('ebay_2_general_reports')
            ->selectRaw('
        ...
        return view('campaign.ebay-two.pmt-ads', compact('ebayPercentage','ebayAdPercentage', 'dates', 'clicks', 'spend', 'adSales', 'adSold', 'acos', 'cvr'));
    }
    ...
    public function filterEbay2PmtAds(Request $request)
    {
