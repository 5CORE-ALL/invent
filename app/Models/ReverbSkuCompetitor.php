...
class ReverbSkuCompetitor extends Model
{
    protected $table = 'reverb_sku_competitors';
     ...
     */
    public static function getLowestPriceForSku($sku, $marketplace = 'reverb')
    {
        ...
        if (\Illuminate\Support\Facades\Schema::hasColumn('reverb_sku_competitors', 'ignored')) {
            $q->where(function ($qq) {
     ...
     */
    public static function getCompetitorsForSku($sku, $marketplace = 'reverb')
    {
        $normalizedSku = strtoupper(preg_replace('/\s+/', ' ', trim($sku)));
     ...
     */
    public static function buildGroupedLookup(string $marketplace = 'reverb'): array
    {
