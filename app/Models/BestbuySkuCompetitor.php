...
class BestbuySkuCompetitor extends Model
{
    protected $table = 'bestbuy_sku_competitors';
     ...
     */
    public static function getLowestPriceForSku($sku, $marketplace = 'bestbuy')
    {
        ...
        if (\Illuminate\Support\Facades\Schema::hasColumn('bestbuy_sku_competitors', 'ignored')) {
            $q->where(function ($qq) {
     ...
     */
    public static function getCompetitorsForSku($sku, $marketplace = 'bestbuy')
    {
        $normalizedSku = strtoupper(preg_replace('/\s+/', ' ', trim($sku)));
     ...
     */
    public static function buildGroupedLookup(string $marketplace = 'bestbuy'): array
    {
