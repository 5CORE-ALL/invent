...
/**
 * Best Buy USA order lines in mirakl_daily_data (Marketplace Manager).
 */
class BestBuyOrderMetric extends Model
{
    ...
    {
        static::addGlobalScope('best_buy_usa', function (Builder $query) {
            $query->where('channel_name', 'Best Buy USA');
        });
    }
