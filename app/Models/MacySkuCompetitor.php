...
class MacySkuCompetitor extends Model
{
    protected $table = 'macy_sku_competitors';
     ...
     */
    public static function getLowestPriceForSku($sku, $marketplace = 'macy')
    {
        ...
        if (\Illuminate\Support\Facades\Schema::hasColumn('macy_sku_competitors', 'ignored')) {
            $q->where(function ($qq) {
     ...
     */
    public static function getCompetitorsForSku($sku, $marketplace = 'macy')
    {
        $normalizedSku = strtoupper(preg_replace('/\s+/', ' ', trim($sku)));
     ...
     */
    public static function buildGroupedLookup(string $marketplace = 'macy'): array
    {
