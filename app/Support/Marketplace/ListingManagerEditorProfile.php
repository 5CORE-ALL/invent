    ...
    public static function forChannel(?string $channelName): array
    {
        ...
        $profiles = [
            ...
            'wayfair' => [
                ...
                'identifier_fields' => ['sku', 'asin', 'brand', 'manufacturer', 'upc'],
                'category_placeholder' => 'Search Wayfair classes (e.g. lighting stand)',
                ...
                'category_help' => 'Search and select a Wayfair class (taxonomy). Publish copies this class ID into product addition.',
