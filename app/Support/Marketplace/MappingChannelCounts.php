...
class MappingChannelCounts
{
    ...
    public const INACTIVE_TOTAL_CACHE_KEY = 'inactive_listings_total_v15';

    public const INACTIVE_MASTER_ROWS_CACHE_KEY = 'inactive_listings_master_rows_v15';

    public const INACTIVE_CP_TOTAL_CACHE_KEY = 'inactive_listings_cp_total_v15';
