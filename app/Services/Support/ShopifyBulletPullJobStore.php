...
class ShopifyBulletPullJobStore
{
    ...
    /**
     * An "active" job whose worker has not touched it for a while is dead/stuck.
     * Such a job must not block new pulls forever.
     */
    ...
    /**
     * Force the job inactive so Stop/Cancel always works, even if the worker is gone.
     */
