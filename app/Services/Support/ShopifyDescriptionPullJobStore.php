...
class ShopifyDescriptionPullJobStore
{
    ...
    public function create(array $skus, int $delaySeconds = 6): array
    {
        ...
        $state = array_merge($this->defaultState(), [
            ...
            'last_message' => 'Background Shopify description pull started.',
            'messages' => [[
    ...
    /**
     * Force the job inactive immediately so Stop/Cancel always works.
     */
    ...
    {
        return storage_path('app/shopify-description-pull/job.json');
    }
