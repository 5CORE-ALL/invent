...
class ProductMasterMarketplaceMaps
{
    ...
    public static function bulletServiceMap(): array
    {
        return [
            ...
            'shopify_b5c' => \App\Services\ShopifyB5CApiService::class,
    ...
    public static function descriptionServiceMap(): array
    {
        return [
            ...
            'shopify_b5c' => [\App\Services\ShopifyB5CApiService::class, 'updateDescription'],
    ...
    public static function imagePushMap(): array
    {
        return [
            ...
            'shopify_b5c' => [\App\Services\ShopifyB5CApiService::class, 'updateImages'],
    ...
    public static function videoPushMap(): array
    {
        return [
            ...
            'shopify_b5c' => [\App\Services\ShopifyB5CApiService::class, 'updateVideos'],
