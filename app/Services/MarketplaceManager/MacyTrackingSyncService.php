 ...
 */
class MacyTrackingSyncService
{
    /**
     * @return array{success: bool, skipped?: bool, message: string, action?: string|null}
     */
    public function pushTrackingForOrder(MacyOrderMetric $order): array
    {
        unset($order);
        ...
        if (! self::canPushTracking()) {
            return [
                'success' => false,
                'skipped' => true,
                'message' => 'Push tracking to Macy\'s is Off in settings.',
            ];
        }
        ...
        return [
            ...
            'message' => 'Macy\'s tracking push is not implemented yet.',
        ];
    }
    ...
    public function syncPending(int $limit = 40): array
    {
        ...
        Log::info('MacyTrackingSyncService: syncPending skipped (not implemented)');
