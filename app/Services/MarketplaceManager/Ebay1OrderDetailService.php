...
/**
 * Order detail helpers for MM eBay 1 order show / Shopify push.
 */
class Ebay1OrderDetailService
{
    /**
     * @return array{order: array<string, mixed>, lines: list<array<string, mixed>>, raw: ?array}
     */
    public function detail(Ebay1OrderMetric $metric): array
    {
    ...
    public function fetchAndPersistOrderDetail(string $orderId): array
    {
        ...
        if (! $token) {
            return ['success' => false, 'message' => 'eBay 1 token unavailable.'];
        }
        ...
        try {
            ...
            $order = $response->json();
            if (! is_array($order)) {
                return ['success' => false, 'message' => 'Order not found on eBay 1'];
            }
        } catch (\Throwable $e) {
        ...
        return ['success' => true, 'message' => 'Order details updated from eBay 1.'];
    }
     ...
     */
    public function resolveOrderRoot(Ebay1OrderMetric $line): array
    {
        ...
        return $this->normalizeEbay1Order($raw, $line);
    }
     ...
     * @return array<string, mixed>
     */
    protected function normalizeEbay1Order(array $order, Ebay1OrderMetric $line): array
    {
        ...
        // Keys match Ebay1DetailFormatter::formatOrder (Shein-shaped aliases).
        $receiptAddress = [
    ...
    protected function getAccessToken(): ?string
    {
        ...
        try {
            ...
            Log::warning('Ebay1OrderDetailService: token failed', ['error' => $e->getMessage()]);
