...
/**
 * Live listing helpers for Macy\'s listings UI.
 */
class MacyLiveListingsService
{
    private const CACHE_KEY = 'mm.macy.live_listings.v1';
    ...
    public function liveDetailsByProductIds(array $productIds): array
    {
        ...
        if ($ids === [] || ! Schema::hasTable('macy_products')) {
            return [];
        }

        $rows = MacyProduct::query()->whereIn('sku', $ids)->get();
     ...
     */
    protected function mapProduct(MacyProduct $row): ?array
    {
