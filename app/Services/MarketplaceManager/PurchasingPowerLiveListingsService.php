...
/**
 * Live listing helpers for Purchasing Power listings UI.
 */
class PurchasingPowerLiveListingsService
{
    private const CACHE_KEY = 'mm.purchasingpower.live_listings.v1';
    ...
    public function liveDetailsByProductIds(array $productIds): array
    {
        ...
        if ($ids === [] || ! Schema::hasTable('purchasing_power_products')) {
            return [];
        }

        $rows = PurchasingPowerProduct::query()->whereIn('sku', $ids)->get();
     ...
     */
    protected function mapProduct(PurchasingPowerProduct $row): ?array
    {
