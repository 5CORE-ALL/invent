...
class MacyDetailFormatter
{
    /**
     * @param  array<string, mixed>|null  $bbLive
     * @return array<string, mixed>
     */
    public function formatProduct(?array $bbLive, ?MacyProduct $product, ShopifySku $shopify): array
    {
     ...
     * @param  Collection<int, MacyOrderMetric>  $lines
     * @return array<string, mixed>
     */
    public function formatOrder(array $orderRoot, Collection $lines, MacyOrderMetric $primaryLine): array
    {
        $order = $orderRoot;
        ...
        return [
            ...
            'lines' => $lines->map(fn (MacyOrderMetric $line) => [
                'sku' => $line->sku,
