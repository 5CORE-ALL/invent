...
class TikTok2OrderPushService
{
    ...
    public function buildImportPlan(Tiktok2Order $order): array
    {
        ...
        [$buyerEmail, $customer, $emailIsPlaceholder] = $this->tikTokShopifyCustomerAndEmail($orderId, $rawJson, $shipping, 'tiktok2');
        $payload['email'] = $buyerEmail;
        $payload['customer'] = $customer;
        if ($emailIsPlaceholder) {
            $payload['note_attributes'][] = ['name' => 'tiktok2_email_is_placeholder', 'value' => 'true'];
        }
