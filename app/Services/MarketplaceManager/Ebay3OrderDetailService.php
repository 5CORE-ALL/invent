...
/**
 * Order detail helpers for MM eBay 3 order show / Shopify push.
 */
class Ebay3OrderDetailService
{
    /**
     * @return array{order: array<string, mixed>, lines: list<array<string, mixed>>, raw: ?array}
     */
    public function detail(Ebay3OrderMetric $metric): array
    {
    ...
    public function fetchAndPersistOrderDetail(string $orderId): array
    {
        ...
        if (! $token) {
            return ['success' => false, 'message' => 'eBay 3 token unavailable.'];
        }
        ...
        try {
            ...
            $order = $response->json();
            if (! is_array($order)) {
                return ['success' => false, 'message' => 'Order not found on eBay 3'];
            }
        } catch (\Throwable $e) {
        ...
        return ['success' => true, 'message' => 'Order details updated from eBay 3.'];
    }
     ...
     */
    public function resolveOrderRoot(Ebay3OrderMetric $line): array
    {
        ...
        return $this->normalizeEbay3Order($raw, $line);
    }
     ...
     * @return array<string, mixed>
     */
    protected function normalizeEbay3Order(array $order, Ebay3OrderMetric $line): array
    {
        ...
        // Keys match Ebay3DetailFormatter::formatOrder (Shein-shaped aliases).
        $receiptAddress = [
    ...
    protected function getAccessToken(): ?string
    {
        ...
        try {
            ...
            Log::warning('Ebay3OrderDetailService: token failed', ['error' => $e->getMessage()]);
