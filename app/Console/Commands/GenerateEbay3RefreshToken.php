...
class GenerateEbay3RefreshToken extends Command
{
    protected $signature = 'ebay3:generate-refresh-token {--code= : Authorization code from eBay}';
    protected $description = 'Generate a new eBay3 refresh token using RuName';

    private $ruName = 'Kaneer_Kaur_Kal-KaneerKa-5CoreI-yoyoa';
    ...
    public function handle()
    {
        ...
        if (!$authCode) {
            ...
            $this->newLine();
            $this->line('php artisan ebay3:generate-refresh-token --code=YOUR_AUTHORIZATION_CODE');
            $this->newLine();
        ...
        try {
            ...
            if ($response->successful()) {
                ...
                if (isset($data['refresh_token'])) {
                    ...
                    $this->line('EBAY_3_REFRESH_TOKEN=' . $data['refresh_token']);
                    $this->newLine();
                    ...
                    // Log the success
                    Log::info('eBay3 Refresh Token Generated Successfully', [
                        'ruName' => $this->ruName,
                ...
                Log::error('eBay3 Refresh Token Generation Failed', [
            ...
            Log::error('eBay3 Refresh Token Generation Exception', [
