...
class AutoUpdateAmazonFbaOverKwBids extends Command
{
    ...
    protected string $monitorJobName = 'Amazon FBA Bid Sync (KW Over)';
    ...
    /**
     * Build bid update candidates for FBA over-utilized keyword campaigns.
     *
    ...
    public function getAutomateAmzUtilizedBgtKw(): array
    {
        try {
            ...
            Log::error('Error in getAutomateAmzUtilizedBgtKw (FBA Over KW): ' . $e->getMessage());
            return [];
        }
    }
