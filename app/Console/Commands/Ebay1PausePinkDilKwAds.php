...
class Ebay1PausePinkDilKwAds extends Command
{
    ...
    protected $description = 'Automatically pause eBay1 campaigns if l7_views >= 50 AND acos >= 10. Only for RUNNING campaigns.';
    ...
    public function getEbay1PinkDilCampaigns($testCampaignId = null)
    {
        try {
            ...
            foreach ($additionalRunningCampaigns as $campaignSku) {
                ...
                $ebayMetric = EbayMetric::where('sku', $matchedCampaignL30->campaign_name)->first();
