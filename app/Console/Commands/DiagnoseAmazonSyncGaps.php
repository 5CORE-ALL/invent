...
class DiagnoseAmazonSyncGaps extends Command
{
    ...
    public function handle(): int
    {
        ...
        $this->line('Note: /amazon/daily-sales uses '.\App\Http\Controllers\Sales\AmazonSalesController::DAILY_SALES_WINDOW_DAYS.' days ending **yesterday** PT — align mentally when comparing.');
        $this->newLine();
