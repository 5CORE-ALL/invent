...
class Ebay2PausePinkDilKwAds extends Command
{
    protected $signature = 'ebay2:auto-pause-pink-dil-kw-ads {--dry-run : Run without actually pausing ads} {--campaign-id= : Test with specific campaign ID only}';
    protected $description = 'Automatically pause eBay2 campaigns if l7_views >= 50 AND acos >= 10. Only for RUNNING campaigns.';
    ...
    public function handle()
    {
        try {
            ...
            $this->info("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
            $this->info("🚀 Starting eBay2 Auto-Pause Pink DIL KW Ads");
            if ($isDryRun) {
            ...
            $campaigns = $this->getEbay2PinkDilCampaigns($testCampaignId);
                ...
                try {
                    ...
                    try {
                        ...
                        if ($response->successful()) {
                            ...
                            $updatedCount = Ebay2PriorityReport::where('campaign_id', $campaignId)
    ...
    public function getEbay2PinkDilCampaigns($testCampaignId = null)
    {
        try {
            ...
            $reportsQuery = Ebay2PriorityReport::where('report_range', 'L30')
                ->where('campaignStatus', 'RUNNING')
            ...
            $additionalL7 = Ebay2PriorityReport::where('report_range', 'L7')
                ->where('campaignStatus', 'RUNNING')
                ->where('campaign_name', 'NOT LIKE', 'Campaign %')
                ->where('campaign_name', 'NOT LIKE', 'General - %')
                ->where('campaign_name', 'NOT LIKE', 'Default%')
            ...
            $additionalL30 = Ebay2PriorityReport::where('report_range', 'L30')
                ->where('campaignStatus', 'RUNNING')
                ->where('campaign_name', 'NOT LIKE', 'Campaign %')
                ->where('campaign_name', 'NOT LIKE', 'General - %')
                ->where('campaign_name', 'NOT LIKE', 'Default%')
            ...
            $allL30Reports = Ebay2PriorityReport::where('report_range', 'L30')
                ->where('campaignStatus', 'RUNNING')
                ->where('campaign_name', 'NOT LIKE', 'Campaign %')
                ->where('campaign_name', 'NOT LIKE', 'General - %')
                ->where('campaign_name', 'NOT LIKE', 'Default%')
            ...
            foreach ($additionalRunningCampaigns as $campaignSku) {
                ...
                $ebayMetric = Ebay2Metric::where('sku', $matchedCampaignL30->campaign_name)->first();
            ...
            $this->error("Error in getEbay2PinkDilCampaigns: " . $e->getMessage());
            $this->error("Stack trace: " . $e->getTraceAsString());
            return [];
        } finally {
            DB::connection()->disconnect();
