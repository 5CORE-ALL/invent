...
class GenerateEbay1RefreshToken extends Command
{
    protected $signature = 'ebay1:generate-refresh-token {--code= : Authorization code from eBay}';
    ...
    {
        $this->info('=== eBay1 Refresh Token Generator ===');
        $this->newLine();
        ...
        if (!$clientId || !$clientSecret) {
            $this->error('✗ Missing EBAY_APP_ID or EBAY_CERT_ID in .env file');
            return 1;
        }
        ...
        try {
            ...
            if ($response->successful()) {
                ...
                if (isset($data['refresh_token'])) {
                    ...
                    $this->line('EBAY_REFRESH_TOKEN=' . $data['refresh_token']);
                    $this->newLine();
                    ...
                    // Log the success
                    Log::info('eBay1 Refresh Token Generated Successfully', [
                        'ruName' => $this->ruName,
            ...
            Log::error('eBay1 Refresh Token Generation Exception', [
