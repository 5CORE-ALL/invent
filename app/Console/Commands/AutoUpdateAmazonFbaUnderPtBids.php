...
{
    protected $signature = 'amazon-fba:auto-update-under-pt-bids {--dry-run : Run without updating Amazon} {--verbose : Detailed output}';
    ...
    /**
     * Build bid update candidates for FBA under-utilized product targeting campaigns.
     *
     * @return array<int, object> objects containing: campaign_id, sbid, ub7, ub1, l7_cpc, l1_cpc, l7_spend, l1_spend, inv
     */
    public function getAutomateAmzFbaUnderUtilizedBgtKw(): array
    {
        try {
