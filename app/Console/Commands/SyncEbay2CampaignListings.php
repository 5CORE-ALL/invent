...
class SyncEbay2CampaignListings extends Command
{
    ...
    protected $signature   = 'ebay2:sync-campaign-listings {--dry-run : Show what would be inserted without writing} {--chunk= : Override DB write chunk size (default from cron-monitor config)}';
