...
class SyncTemuManagerOrders extends Command
{
    protected $signature = 'temu:sync-orders
    ...
    {
        if (! $this->option('force') && ! MarketplaceSyncSettings::canFetchOrders('temu')) {
            $this->info('Skipped: Fetch orders is Off in Temu Marketplace Manager settings.');
