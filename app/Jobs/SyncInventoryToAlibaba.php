...
class SyncInventoryToAlibaba implements ShouldQueue, ShouldBeUnique
{
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            Log::error('SyncInventoryToAlibaba: failed', ['error' => $e->getMessage()]);
            throw $e;
        }
    }
}
