...
<div class="row g-3 mb-3">
        ...
        <div class="card shadow-sm h-100">
            <div class="card-body">
                ...
                <dl class="row mb-0 small">
                    ...
                    <dt class="col-5">API calls</dt><dd class="col-7">{{ $log->api_calls }}</dd>
                </dl>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-4">
        <div class="card shadow-sm h-100">
            <div class="card-header"><h6 class="mb-0">Validation & anomalies</h6></div>
            <div class="card-body">
    ...
    <div class="table-responsive">
        <table class="table table-sm mb-0">
            ...
            <tbody>
                ...
                @empty
                    <tr><td colspan="6" class="text-muted p-3">No per-record failures logged.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
