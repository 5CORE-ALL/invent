@extends('layouts.vertical', ['title' => 'Reverb Competitor Search', 'mode' => 'light'])
...
<div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Reverb Competitor Search</li>
                    </ol>
                </div>
                <h4 class="page-title">Reverb Competitor Discovery</h4>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="search-container">
                <h5 class="mb-3">Search Reverb Listings</h5>
                <p class="text-muted mb-4">Enter a search query to discover Reverb competitor listings and analyze their pricing, condition, and seller information.</p>
                ...
                <form id="searchForm">
                    ...
                    <button type="submit" class="btn btn-primary btn-lg">
                        <i class="mdi mdi-magnify me-2"></i>Search Reverb
                    </button>
    ...
    <div class="loading-spinner" id="loadingSpinner">
        ...
        <p class="mt-3 text-muted">Searching Reverb... This may take a moment.</p>
    </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" id="sortBy">
                                        <option value="position">Reverb Position (Default)</option>
...
$(document).ready(function() {
    ...
    function performSearch(query, marketplace) {
        ...
        $.ajax({
            url: '/repricer/reverb-search/search',
            method: 'POST',
            data: {
                query: query,
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    console.error('Reverb API Error:', response);
                }
            },
            error: function(xhr) {
                $('#loadingSpinner').hide();
    ...
    function applyFiltersAndSort() {
        ...
        $.ajax({
            url: '/repricer/reverb-search/results',
            method: 'GET',
            data: {
    ...
    function loadFilterOptions(query) {
        $.ajax({
            url: '/repricer/reverb-search/filter-options',
            method: 'GET',
            data: { query: query },
            success: function(response) {
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 mb-3">
                        <div class="product-card">
                            <input type="checkbox" class="competitor-checkbox product-checkbox form-check-input" 
                                   ...
                                   data-marketplace="${item.marketplace || 'reverb'}"
    ...
    function loadSearchHistory() {
        $.ajax({
            url: '/repricer/reverb-search/history',
            method: 'GET',
            success: function(response) {
    ...
    function loadSkus() {
        $.ajax({
            url: '/repricer/reverb-search/skus',
            method: 'GET',
            success: function(response) {
                if (response.success) {
    ...
    function saveSelectedCompetitors() {
        ...
        $.ajax({
            url: '/repricer/reverb-search/store-competitors',
            method: 'POST',
    ...
    window.loadHistoryQuery = function(query) {
        ...
        $('#resultsContainer').hide();
        currentSearchQuery = query;
        $.get('/repricer/reverb-search/results', { query: query })
