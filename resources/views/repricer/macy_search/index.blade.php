@extends('layouts.vertical', ['title' => "Macy's Competitor Search", 'mode' => 'light'])
...
<div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Macy's Competitor Search</li>
                    </ol>
                </div>
                <h4 class="page-title">Macy's Competitor Discovery</h4>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="search-container">
                <h5 class="mb-3">Search Macy's Products</h5>
                <p class="text-muted mb-4">Enter a search query to discover Macy's competitor products and analyze their pricing, condition, and seller information.</p>
                ...
                <form id="searchForm">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="marketplace" name="marketplace">
                                    <option value="macy" selected>Macy's</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary btn-lg">
                        <i class="mdi mdi-magnify me-2"></i>Search Macy's
                    </button>
    ...
    <div class="loading-spinner" id="loadingSpinner">
        ...
        <p class="mt-3 text-muted">Searching Macy's... This may take a moment.</p>
    </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" id="sortBy">
                                        <option value="position">Macy's Position (Default)</option>
...
$(document).ready(function() {
    ...
    function performSearch(query, marketplace) {
        ...
        $.ajax({
            url: '/repricer/macy-search/search',
            method: 'POST',
            data: {
                query: query,
    ...
    function applyFiltersAndSort() {
        ...
        $.ajax({
            url: '/repricer/macy-search/results',
            method: 'GET',
            data: {
    ...
    function loadFilterOptions(query) {
        $.ajax({
            url: '/repricer/macy-search/filter-options',
            method: 'GET',
            data: { query: query },
            success: function(response) {
    ...
    function displayResults(response) {
        ...
        if (results.length === 0) {
            ...
            results.forEach(function(item) {
                ...
                const productLink = item.link || `https://www.macys.com/shop/product/${item.item_id}`;
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 mb-3">
                        <div class="product-card">
                            <input type="checkbox" class="competitor-checkbox product-checkbox form-check-input" 
                                   ...
                                   data-marketplace="${item.marketplace || 'macy'}"
    ...
    function loadSearchHistory() {
        $.ajax({
            url: '/repricer/macy-search/history',
            method: 'GET',
            success: function(response) {
    ...
    function saveSelectedCompetitors() {
        ...
        $.ajax({
            url: '/repricer/macy-search/store-competitors',
            method: 'POST',
    ...
    window.loadHistoryQuery = function(query) {
        ...
        $('#resultsContainer').hide();
        currentSearchQuery = query;
        $.get('/repricer/macy-search/results', { query: query })
