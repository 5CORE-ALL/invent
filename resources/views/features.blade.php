                            ...
                            <table id="product-table">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th><input type="text" class="form-control form-control-sm search-input" placeholder="Search Feature 2" data-column="feature2"></th>
                                        <th><input type="text" class="form-control form-control-sm search-input" placeholder="Search Feature 3" data-column="feature3"></th>
                                        <th><input type="text" class="form-control form-control-sm search-input" placeholder="Search Feature 4" data-column="feature4"></th>
                                        <th></th>
                                    </tr>
                                </thead>
                                <tbody id="table-body">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTitle">Add Features</h5>
                    ...
                    <form id="featureForm">
                        ...
                        <div class="mb-3">
                            <label for="feature1" class="form-label">
                                Feature 1 <span class="char-counter" id="counter1">0/100</span>
                            </label>
                            <textarea class="form-control" id="feature1" name="feature1" rows="2" maxlength="100"></textarea>
                        </div>

                        <div class="mb-3">
                            <label for="feature2" class="form-label">
                                Feature 2 <span class="char-counter" id="counter2">0/100</span>
                            </label>
                            <textarea class="form-control" id="feature2" name="feature2" rows="2" maxlength="100"></textarea>
                        </div>

                        <div class="mb-3">
                            <label for="feature3" class="form-label">
                                Feature 3 <span class="char-counter" id="counter3">0/100</span>
                            </label>
                            <textarea class="form-control" id="feature3" name="feature3" rows="2" maxlength="100"></textarea>
                        </div>

                        <div class="mb-3">
                            <label for="feature4" class="form-label">
                                Feature 4 <span class="char-counter" id="counter4">0/100</span>
                            </label>
                            <textarea class="form-control" id="feature4" name="feature4" rows="2" maxlength="100"></textarea>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-primary" onclick="saveFeatures()">
...
@section('script')
    ...
    <script>
        ...
        function renderTable(data) {
            ...
            filteredData.forEach(item => {
                ...
                for (let i = 1; i <= 4; i++) {
                    ...
                    const feature = item[`feature${i}`] || '';
                    featureCell.textContent = feature.length > 50 ? feature.substring(0, 50) + '...' : feature;
                    featureCell.style.maxWidth = '200px';
        ...
        function setupCharCounters() {
            for (let i = 1; i <= 4; i++) {
                const textarea = document.getElementById(`feature${i}`);
        ...
        function updateCharCounter(index) {
            const textarea = document.getElementById(`feature${index}`);
        ...
        function openModal(sku = null) {
            ...
            if (sku) {
                ...
                if (item) {
                    document.getElementById('modalParent').value = item.Parent || '';
                    for (let i = 1; i <= 4; i++) {
                        document.getElementById(`feature${i}`).value = item[`feature${i}`] || '';
                        updateCharCounter(i);
                    }
                }
            } else {
        ...
        function exportToExcel() {
            ...
            const exportData = tableData
                ...
                .map(item => ({
                    ...
                    'Feature 2': item.feature2 || '',
                    'Feature 3': item.feature3 || '',
                    'Feature 4': item.feature4 || ''
                }));
            ...
            XLSX.writeFile(wb, `features_${timestamp}.xlsx`);
        }
            ...
            reader.onload = function(e) {
                try {
                    ...
                    const importPromises = jsonData.map(row => {
                        ...
                        const feature1 = row['Feature 1'] || row['feature1'] || '';
                        const feature2 = row['Feature 2'] || row['feature2'] || '';
                        const feature3 = row['Feature 3'] || row['feature3'] || '';
                        const feature4 = row['Feature 4'] || row['feature4'] || '';
