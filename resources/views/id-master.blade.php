@extends('layouts.vertical', ['title' => 'ID Master', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    ...
    @include('layouts.shared.page-title', [
        'page_title' => 'ID Master',
        'sub_title' => 'ID Master Analysis',
    ])
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="id-master-datatable" class="table dt-responsive nowrap w-100">
                            <thead>
                                <tr>
                                    <th>Image</th>
                                    <th>
                    ...
                    <div id="rainbow-loader" class="rainbow-loader">
                        ...
                        <div class="wave"></div>
                        <div class="wave"></div>
                        <div class="loading-text">Loading ID Master Data...</div>
                    </div>
                </div>
            </div>
        </div>
...
@section('script')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Load ID data from server
            function loadData() {
                const cacheParam = '?ts=' + new Date().getTime();
                makeRequest('/id-master-data-view' + cacheParam, 'GET')
                    .then(response => {
                        if (!response.ok) {
                    ...
                    .catch(error => {
                        console.error('Failed to load ID data: ' + error.message);
                        document.getElementById('rainbow-loader').style.display = 'none';
                    });
            }
            ...
            function renderTable(data) {
                ...
                if (data.length === 0) {
                    tbody.innerHTML = '<tr><td colspan="6" class="text-center">No IDs found</td></tr>';
                    return;
                }
                ...
                document.getElementById('downloadExcel').addEventListener('click', function() {
                    ...
                    setTimeout(() => {
                        try {
                            ...
                            XLSX.utils.book_append_sheet(wb, ws, "ID Master");

                            // Generate Excel file and trigger download
                            XLSX.writeFile(wb, "id_master_export.xlsx");
