@extends('layouts.vertical', ['title' => 'Target Keywords Master', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    ...
    @include('layouts.shared.page-title', [
        'page_title' => 'Target Keywords Master',
        'sub_title' => 'Target Keywords Master Analysis',
    ])
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="target-keywords-master-datatable" class="table dt-responsive nowrap w-100">
                            <thead>
                                <tr>
                                    <th>Image</th>
                                    <th>
                    ...
                    <div id="rainbow-loader" class="rainbow-loader">
                        ...
                        <div class="wave"></div>
                        <div class="wave"></div>
                        <div class="loading-text">Loading Target Keywords Master Data...</div>
                    </div>
                </div>
            </div>
        </div>
...
@section('script')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Load target keywords data from server
            function loadData() {
                const cacheParam = '?ts=' + new Date().getTime();
                makeRequest('/target-keywords-master-data-view' + cacheParam, 'GET')
                    .then(response => {
                        if (!response.ok) {
                    ...
                    .catch(error => {
                        console.error('Failed to load target keywords data: ' + error.message);
                        document.getElementById('rainbow-loader').style.display = 'none';
                    });
            }
            ...
            function renderTable(data) {
                ...
                if (data.length === 0) {
                    tbody.innerHTML = '<tr><td colspan="6" class="text-center">No target keywords found</td></tr>';
                    return;
                }
                ...
                document.getElementById('downloadExcel').addEventListener('click', function() {
                    ...
                    setTimeout(() => {
                        try {
                            ...
                            XLSX.utils.book_append_sheet(wb, ws, "Target Keywords Master");

                            // Generate Excel file and trigger download
                            XLSX.writeFile(wb, "target_keywords_master_export.xlsx");
