@extends('layouts.vertical', ['title' => 'Benefits Image Masters', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared.page-title', [
        'page_title' => 'Benefits Images Masters',
        'sub_title' => 'Benefits Images Master Data',
    ])
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body" style="padding: 0;">
                <div id="aplus-table-wrapper" style="height: calc(100vh - 200px); display: flex; flex-direction: column;">
                    ...
                    <!-- Table -->
                    <div id="benefits-table" style="flex: 1;"></div>
                </div>
            </div>
        </div>
    </div>
...
<script>
    const COLUMN_VIS_KEY = "benefits_tabulator_column_visibility";
    let table = null;
    let tableData = [];
    ...
    $(document).ready(function() {
        ...
        table = new Tabulator("#benefits-table", {
            ajaxURL: "/benefits-images-master-data-view",
            ajaxSorting: false,
            layout: "fitData",
            pagination: true,
            paginationSize: 100,
