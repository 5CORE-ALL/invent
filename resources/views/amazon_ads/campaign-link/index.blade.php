@extends('layouts.vertical', ['title' => 'Amz Campaign Link'])
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    <h4 class="mb-0"><i class="mdi mdi-link-variant"></i> Amz Campaign Link</h4>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function linkedCellFormatter(cell) {
        ...
        if (others.length > 0) {
            html += '<button type="button" class="btn btn-sm btn-outline-info acl-compare-btn ms-1" data-campaign="' + campAttr + '" title="Live-check Amz: what is actually missing vs linked campaign(s)">'
    ...
    document.getElementById('acl-bulk-push').addEventListener('click', async function () {
        if (!confirm('Import keywords into ALL linked campaigns now? This creates keywords on Amz.')) return;
        const btn = this;
