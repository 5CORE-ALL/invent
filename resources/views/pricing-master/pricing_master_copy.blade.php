            ...
            columns: [{
...

               {
                ...
                ajaxResponse: function(url, params, response) {
                    ...
                    // Sort inside each group: child rows first, parent bottom, and remove the last parent row if present
                    let finalData = [];
                    Object.values(grouped).forEach(rows => {
                        ...
                        // Remove the last row if it's a parent
                        if (rows.length > 1 && rows[rows.length - 1].is_parent) {
                            rows.pop();
                        }
