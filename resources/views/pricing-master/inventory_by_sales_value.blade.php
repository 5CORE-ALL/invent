    ...
    function updateHeaderTotals() {
        ...
        if (invValueHeader) {
            invValueHeader.textContent = `${formattedInvValue}`;
             ...
             //    send data to task-manager dashboard
                    const INVpayload = {
                         inv_route: "pricing-masters.pricing_masters.invValueHeader",
                         inv_value: invValueHeader.textContent,
                     };
        ...
        if (cogsHeader) {
            cogsHeader.textContent = `${formattedCogs}`;
              //    send data to task-manager dashboard
                    const LPpayload = {
                         inv_route: "pricing-masters.pricing_masters.lpValueHeader",
                         inv_value: cogsHeader.textContent,
                     };
                     const apiUrl = "https://new-tm.5coremanagement.com/api/save-channel-stats";
