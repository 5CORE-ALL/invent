                    ...
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="img-container">
                                <img id="image" src="/images/small/small-1.jpg" alt="Picture" class="img-fluid">
                            </div>
                        </div>
                        <div class="col-lg-3">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-9 img-crop-preview-btns docs-buttons">
                            <div class="btn-group">
                                <button type="button" class="btn btn-success btn-sm" data-method="setDragMode"
                                    data-option="move" title="Move">
                                    <span class="docs-tooltip" data-bs-toggle="tooltip" data-bs-animation="false"
                            ...
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-success btn-sm" data-method="zoom"
                                    ...
                                    <span class="mdi mdi-magnify-minus-outline" data-bs-toggle="tooltip"
                                        data-bs-animation="false" title="$().cropper(&quot;zoom&quot;, -0.1)">
                                    </span>
                                </button>
                            </div>
                            ...
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-success btn-sm" data-method="move" data-option="0"
                                ...
                                <button type="button" class="btn btn-success btn-sm" data-method="move" data-option="0"
                                    ...
                                    <span class="mdi mdi-arrow-down" data-bs-toggle="tooltip" data-bs-animation="false"
                                        title="$().cropper(&quot;move&quot;, 0, 10)">
                                    </span>
                                </button>
                            </div>
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-success btn-sm" data-method="rotate"
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-success btn-sm" data-method="scaleX"
                                ...
                                <button type="button" class="btn btn-success btn-sm" data-method="scaleY"
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-success btn-sm" data-method="crop" title="Crop">
                                    <span class="docs-tooltip" data-bs-toggle="tooltip" data-bs-animation="false"
                                        title="$().cropper(&quot;crop&quot;)">
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-success btn-sm" data-method="disable"
                                    title="Disable">
                                    <span class="docs-tooltip" data-bs-toggle="tooltip" data-bs-animation="false"
                                ...
                                <button type="button" class="btn btn-success btn-sm" data-method="enable"
                                    title="Enable">
                                    <span class="docs-tooltip" data-bs-toggle="tooltip" data-bs-animation="false"
                            ...
                            <div class="btn-group">
                                ...
                                <label class="btn btn-success mb-0 btn-upload btn-sm" for="inputImage"
                                    ...
                                    <input type="file" class="visually-hidden" id="inputImage" name="file"
                                ...
                                <button type="button" class="btn btn-danger btn-sm" data-method="destroy"
                                    title="Destroy">
                                    <span class="docs-tooltip" data-bs-toggle="tooltip" data-bs-animation="false"
                            ...
                            <div class="btn-group btn-group-crop">
                                <button type="button" class="btn btn-success btn-sm" data-method="getCroppedCanvas"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a class="btn btn-outline-info" id="download" href="javascript:void(0);"
                            ...
                            <button type="button" class="btn btn-primary btn-sm" data-method="getData" data-option
                                data-target="#putData">
                            ...
                            <button type="button" class="btn btn-primary btn-sm" data-method="getContainerData"
                            ...
                            <button type="button" class="btn btn-primary btn-sm" data-method="getImageData" data-option
                                data-target="#putData">
                                <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                            ...
                            <button type="button" class="btn btn-primary btn-sm" data-method="getCanvasData" data-option
                                data-target="#putData">
                                <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                            ...
                            <button type="button" class="btn btn-primary btn-sm" data-method="setCanvasData"
                                data-target="#putData">
                                <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                            ...
                            <button type="button" class="btn btn-primary btn-sm" data-method="getCropBoxData"
                                data-option data-target="#putData">
                                <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                            ...
                            <button type="button" class="btn btn-primary btn-sm" data-method="setCropBoxData"
                                data-target="#putData">
                                <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                            ...
                            <button type="button" class="btn btn-primary btn-sm" data-method="moveTo" data-option="0">
                                <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                                    title="cropper.moveTo(0)">
                                    Move to [0,0]
                                </span>
                            </button>
                            <button type="button" class="btn btn-primary btn-sm" data-method="zoomTo" data-option="1">
                                <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                            ...
                            <button type="button" class="btn btn-primary btn-sm" data-method="scale" data-option="-2"
                        ...
                        <div class="col-lg-3 docs-toggles">
                            <div class="btn-group btn-group-sm d-flex flex-nowrap mb-2" data-bs-toggle="buttons">
                            ...
                            <div class="dropdown dropup docs-options">
                                ...
                                <ul class="dropdown-menu docs-drop-options" aria-labelledby="toggleOptions"
                                    role="menu">
                                    ...
                                    <li class="dropdown-item">
                                        <div class="form-check">
                                            <input id="checkbox5" class="form-check-input" type="checkbox"
                                                name="guides" checked>
                                    ...
                                    <li class="dropdown-item">
                                        <div class="form-check">
                                            <input id="checkbox6" class="form-check-input" type="checkbox"
                                                name="center" checked>
                                    ...
                                    <li class="dropdown-item">
                                        <div class="form-check">
                                            <input id="checkbox7" class="form-check-input" type="checkbox"
                                    ...
                                    <li class="dropdown-item">
                                        <div class="form-check">
                                            <input id="checkbox8" class="form-check-input" type="checkbox"
                                    ...
                                    <li class="dropdown-item">
                                        <div class="form-check">
                                            <input id="checkbox9" class="form-check-input" type="checkbox"
                                    ...
                                    <li class="dropdown-item">
                                        <div class="form-check">
                                            <input id="checkbox10" class="form-check-input" type="checkbox"
                                    ...
                                    <li class="dropdown-item">
                                        <div class="form-check">
                                            <input id="checkbox12" class="form-check-input" type="checkbox"
                                    ...
                                    <li class="dropdown-item">
                                        <div class="form-check">
                                            <input id="checkbox13" class="form-check-input" type="checkbox"
                                    ...
                                    <li class="dropdown-item">
                                        <div class="form-check">
                                            <input id="checkbox14" class="form-check-input" type="checkbox"
                                    ...
                                    <li class="dropdown-item">
                                        <div class="form-check">
                                            <input id="checkbox15" class="form-check-input" type="checkbox"
                                    ...
                                    <li class="dropdown-item">
                                        <div class="form-check">
                                            <input id="checkbox16" class="form-check-input" type="checkbox"
                                    ...
                                    <li class="dropdown-item">
                                        <div class="form-check">
                                            <input id="checkbox17" class="form-check-input" type="checkbox"
                                    ...
                                    <li class="dropdown-item">
                                        <div class="form-check">
                                            <input id="checkbox18" class="form-check-input" type="checkbox"
