...
@section('content')
    ...
    @include('layouts.shared.page-title', [
        ...
        'sub_title' => 'Category Master Analysis',
    ])
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="category-master-datatable" class="table dt-responsive nowrap w-100">
                            <thead>
                                <tr>
                                    <th>Image</th>
                                    <th>
                    ...
                    <div id="rainbow-loader" class="rainbow-loader">
                        ...
                        <div class="wave"></div>
                        <div class="wave"></div>
                        <div class="loading-text">Loading Category Master Data...</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadData() {
                ...
                makeRequest('/category-master-data-view' + cacheParam, 'GET')
                    .then(response => {
                        if (!response.ok) {
                    ...
                    .catch(error => {
                        console.error('Failed to load category data: ' + error.message);
                        document.getElementById('rainbow-loader').style.display = 'none';
                    });
            }
                ...
                document.getElementById('downloadExcel').addEventListener('click', function() {
                    ...
                    setTimeout(() => {
                        try {
                            ...
                            XLSX.writeFile(wb, "category_master_export.xlsx");
