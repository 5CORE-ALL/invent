                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th title="Shopify, extended">
                                        <div class="small fw-bold">SHOP + MORE</div>
                                        <div class="d-flex flex-wrap gap-1 justify-content-center mt-1">
                                            ...
                                            <span class="marketplace-btn btn-walmart" style="pointer-events:none;">W</span>
                                            <span class="marketplace-btn btn-wayfair" style="pointer-events:none;">WF</span>
                                            <span class="marketplace-btn btn-shein" style="pointer-events:none;">SH</span>
                                            <span class="marketplace-btn btn-doba" style="pointer-events:none;">D</span>
                                            <span class="marketplace-btn btn-aliexpress" style="pointer-events:none;">AE</span>
                                            <span class="marketplace-btn btn-bestbuy" style="pointer-events:none;">BB</span>
                                        </div>
                                    </th>
                                </tr>
                            </thead>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const MARKETPLACES = ['ebay','ebay2','ebay3','amazon','temu','macy','reverb','shopify_main','shopify_pls','walmart','wayfair','shein','doba','aliexpress','bestbuy'];
    const LABELS = {
        ebay:'eBay1', ebay2:'eBay2', ebay3:'eBay3', amazon:'Amazon', temu:'Temu', macy:"Macy's", reverb:'Reverb',
        shopify_main:'Shopify Main', shopify_pls:'Shopify PLS', walmart:'Walmart', wayfair:'Wayfair', shein:'Shein',
        doba:'Doba', aliexpress:'AliExpress', bestbuy:'Best Buy',
    };
    const MP_TILE = {
        ebay:'btn-ebay1', ebay2:'btn-ebay2', ebay3:'btn-ebay3', amazon:'btn-amazon', temu:'btn-temu', macy:'btn-macy', reverb:'btn-reverb',
        shopify_main:'btn-shopify', shopify_pls:'btn-shopify-pls', walmart:'btn-walmart', wayfair:'btn-wayfair', shein:'btn-shein',
        doba:'btn-doba', aliexpress:'btn-aliexpress', bestbuy:'btn-bestbuy',
    };
    const MP_SHORT = {
        ebay:'E1', ebay2:'E2', ebay3:'E3', amazon:'A', temu:'T', macy:'M', reverb:'R',
        shopify_main:'SM', shopify_pls:'PLS', walmart:'W', wayfair:'WF', shein:'SH', doba:'D', aliexpress:'AE', bestbuy:'BB',
    };
    const GROUPS = {
        g1: ['ebay','ebay2','ebay3','macy','reverb'],
        g2: ['amazon','temu'],
        g3: ['shopify_main','shopify_pls','walmart','wayfair','shein','doba','aliexpress','bestbuy'],
    };
    ...
    document.getElementById('pushModalBtn')?.addEventListener('click', async () => {
        ...
        const updates = checks.map(mp => ({ marketplace: mp, images: modalUrls }));
        ...
        const j = await r.json();
        if (j.success) { toast(j.message||'Pushed'); loadData(); if (editModal) editModal.hide(); }
        else toast(j.message||'Push failed', false);
    });
    ...
    function quickPush(sku, mp) {
        ...
        fetch('/image-master/push', {
            ...
            if (j.success) { toast(LABELS[mp]+' pushed'); loadData(); }
