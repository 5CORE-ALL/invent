    ...
    <div class="col-12">
        ...
        <div class="card mt-3">
            ...
            <div class="card-body d-flex flex-wrap gap-2">
                ...
                @if($slug === 'tiktok')
                    <a href="{{ route('tiktok.pricing') }}" class="btn btn-outline-secondary"><i class="ri-line-chart-line me-1"></i> Pricing / Analytics</a>
                    <a href="{{ route('tiktok.listing.variation.verify') }}" class="btn btn-outline-secondary"><i class="ri-external-link-line me-1"></i> LVV</a>
                @elseif($slug === 'tiktok2')
