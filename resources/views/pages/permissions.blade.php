                        ...
                        $menuGroups = [
                            ...
                            'Channel' => [
                             ...
                             'Marketing Masters' => [
                                ...
                                ['value' => 'lqs_masters', 'text' => 'LQS'],
                                ['value' => 'lqs_master', 'text' => 'LQS Master'],
                                ['value' => 'overall_lqs_cvr', 'text' => 'OverAll LQS - CVR'],
                                ['value' => 'listing_LQS_masters', 'text' => 'LQS - Listing'],
                                ['value' => 'cvr_LQS_masters', 'text' => 'Amz LQS - CVR'],
                                ['value' => 'lqs_ebay', 'text' => 'LQS eBay'],
                                ['value' => 'lqs_ebay2', 'text' => 'LQS eBay 2'],
                                ['value' => 'lqs_ebay3', 'text' => 'LQS eBay 3'],
                                ['value' => 'lqs_shopify', 'text' => 'LQS Shopify'],
                                ['value' => 'lqs_temu', 'text' => 'LQS Temu'],
                                ['value' => 'lqs_temu2', 'text' => 'LQS Temu 2'],
                                ['value' => 'lqs_temu3', 'text' => 'LQS Temu 3'],
                                ['value' => 'lqs_tiktok', 'text' => 'LQS TikTok'],
                                ['value' => 'lqs_tiktok2', 'text' => 'LQS TikTok 2'],
                                ['value' => 'lqs_aliexpress', 'text' => 'LQS AliExpress'],
                                ['value' => 'lqs_alibaba', 'text' => 'LQS Alibaba'],
                                ['value' => 'lqs_reverb', 'text' => 'LQS Reverb'],
                                ['value' => 'lqs_newegg', 'text' => 'LQS Newegg'],
                                ['value' => 'lqs_shein', 'text' => 'LQS Shein'],
                                ['value' => 'lqs_wayfair', 'text' => 'LQS Wayfair'],
                                ['value' => 'lqs_bestbuy', 'text' => 'LQS Best Buy'],
                                ['value' => 'lqs_macy', 'text' => "LQS Macy's"],
                                ['value' => 'lqs_doba', 'text' => 'LQS Doba'],
                                ['value' => 'lqs_faire', 'text' => 'LQS Faire'],
                                ['value' => 'lqs_pls', 'text' => 'LQS PLS'],
                                ['value' => 'lqs_purchasingpower', 'text' => 'LQS Purchasing Power'],
                                ['value' => 'lqs_walmart', 'text' => 'LQS Walmart'],
                                ['value' => 'lqs_fbmarketplace', 'text' => 'LQS FB Marketplace'],
                                ['value' => 'lqs_topdawg', 'text' => 'LQS TopDawg'],
                                ['value' => 'lqs_b5cb2b', 'text' => 'LQS Business 5 Core'],
                            ],
                            ...
                            'Marketplace' => [
                                ...
                                ['value' => 'amazon_pricing', 'text' => 'Amz Pricing'],
                                ['value' => 'listing_amazon', 'text' => 'Listing Amz'],
