@extends('layouts.vertical', ['title' => 'Return Analysis', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="header d-flex align-items-center">
            <div>
                <h4><i class="bi bi-bar-chart-line me-2"></i> Return Master Dashboard</h4>
            </div>
