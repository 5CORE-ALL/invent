...
@section('content')
    ...
    <div class="modal fade" id="ecStatusHistoryModal" tabindex="-1" aria-labelledby="ecStatusHistoryModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header py-2">
                    <h6 class="modal-title fw-semibold mb-0" id="ecStatusHistoryModalLabel">
