@extends('layouts.vertical', ['title' => 'Escalated Claims'])
...
@section('css')
    ...
    <style>
        #escalated-claims-tabulator .tabulator .tabulator-header .tabulator-col .tabulator-col-content {
            text-align: center;
        }

        #escalated-claims-tabulator .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-title {
            font-weight: 600;
            text-align: center;
            width: 100%;
        }

        #escalated-claims-tabulator .tabulator .tabulator-cell {
            text-align: center;
        }

        #escalated-claims-tabulator .tabulator .tabulator-footer .tabulator-paginator .tabulator-page.active {
            background: #2563eb;
            color: #fff;
        }

        #escalated-claims-tabulator .tabulator .tabulator-tableholder .tabulator-frozen {
            z-index: 2;
        }

        #escalated-claims-tabulator .ec-channel-logo {
            max-width: 36px;
            max-height: 36px;
            object-fit: contain;
        ...
        #escalated-claims-tabulator .ec-channel-logo-placeholder {
            display: inline-flex;
            align-items: center;
        ...
        #escalated-claims-tabulator .ec-link-arrow {
            width: 28px;
            height: 28px;
            object-fit: contain;
            display: inline-block;
        ...
        #escalated-claims-tabulator .ec-link-arrow-btn {
            display: inline-flex;
            align-items: center;
            justify-content: center;
            border: 0;
        ...
        #escalated-claims-tabulator .ec-action-btn {
            display: inline-flex;
            align-items: center;
            justify-content: center;
            gap: 4px;
        ...
        #escalated-claims-tabulator .ec-action-btn:hover {
            background: #2563eb;
            color: #fff;
        }

        #escalated-claims-tabulator .ec-history {
            font-weight: 600;
            font-size: 0.85rem;
            white-space: nowrap;
        }

        #escalated-claims-tabulator .ec-history.fresh {
            color: #16a34a;
        }

        #escalated-claims-tabulator .ec-history.stale {
            color: #dc2626;
        }

        #escalated-claims-tabulator .ec-history.empty {
            color: #9ca3af;
            font-weight: 400;
        }

        #escalated-claims-tabulator .ec-param {
            font-weight: 600;
        }

        #escalated-claims-tabulator .ec-param.empty {
            color: #9ca3af;
            font-weight: 400;
        }

        #escalated-claims-tabulator .ec-param.required {
            color: #374151;
        }
        ...
        /* Current vs Required:
           ...
           - otherwise → green */
        #escalated-claims-tabulator .ec-param.current.red {
            color: #dc2626;
        }

        #escalated-claims-tabulator .ec-param.current.yellow {
            color: #a67c00;
        }

        #escalated-claims-tabulator .ec-param.current.green {
            color: #16a34a;
        }
        ...
        #escalated-claims-tabulator .ec-text-cell {
            display: block;
            max-width: 220px;
            margin: 0 auto;
        ...
        #escalated-claims-tabulator .ec-text-cell.empty {
            color: #9ca3af;
            text-align: center;
        }
        ...
        #ecStatusHistoryModal .modal-dialog {
            width: 100% !important;
            max-width: none !important;
            margin: 0.5rem 0 0 0 !important;
        }
        #ecStatusHistoryModal .modal-content {
            border-radius: 0;
            width: 100%;
            max-width: 100%;
        }
        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="d-flex align-items-center flex-wrap gap-2">
                    <h4 class="page-title mb-0">Escalated Claims</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card shadow-sm">
                <div class="card-body py-2 px-3">
                    <div class="d-flex justify-content-end mb-1">
                        <span id="ec-pie-filter-badge" class="ec-pie-filter-badge text-muted small d-none">
                            <span>Filter: <strong id="ec-pie-filter-label">—</strong></span>
                            <button type="button" class="btn btn-link btn-sm p-0" id="ec-pie-clear-filter">Show all</button>
                        </span>
                    </div>
                    <div class="ec-pie-layout">
                        <div class="ec-pie-side">
                            <button type="button" class="ec-legend-btn" data-tone="red"
                                title="View last 60 days history">
                                <span class="ec-pie-legend-dot" style="background:#dc2626;"></span>
                                Red <strong id="ec-count-red">0</strong>
                            </button>
                            <button type="button" class="ec-legend-btn" data-tone="yellow"
                                title="View last 60 days history">
                                <span class="ec-pie-legend-dot" style="background:#eab308;"></span>
                                Yellow <strong id="ec-count-yellow">0</strong>
                            </button>
                            <button type="button" class="ec-legend-btn" data-tone="green"
                                title="View last 60 days history">
                                <span class="ec-pie-legend-dot" style="background:#16a34a;"></span>
                                Green <strong id="ec-count-green">0</strong>
                            </button>
                        </div>
                        <div class="ec-pie-wrap">
                            <canvas id="ec-status-pie" width="80" height="80"></canvas>
                        </div>
                    </div>
                    <p class="ec-pie-hint mb-0">Pie: filter · Labels: 60-day history</p>
                </div>
            </div>
        </div>
    </div>

    <div class="modal fade p-0" id="ecStatusHistoryModal" tabindex="-1" aria-labelledby="ecStatusHistoryModalLabel"
        aria-hidden="true">
        <div class="modal-dialog shadow-none m-0 mx-0">
            <div class="modal-content" style="overflow: hidden;">
                <div class="modal-header bg-info text-white py-1 px-3">
                    <h6 class="modal-title mb-0" style="font-size: 13px;" id="ecStatusHistoryModalLabel">
                ...
                <div class="modal-body p-2">
                    <div style="height: 20vh; position: relative;">
                        <canvas id="ec-status-history-chart"></canvas>
                    </div>
                    <p class="small text-muted text-center mb-0 mt-2 d-none" id="ec-status-history-empty">
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body p-0">
                    <div id="escalated-claims-tabulator"></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="small text-muted mb-2">
                        <span id="ec-update-modal-channel">—</span>
                    </div>
                    <div class="mb-2">
                        <label class="form-label small mb-1" for="ec-update-required">Required Parameter (min %)</label>
                        <input type="number" step="0.01" min="0" max="100"
                            class="form-control form-control-sm" id="ec-update-required"
                            placeholder="e.g. 99" autocomplete="off">
                    </div>
                    <div class="mb-2">
                        <label class="form-label small mb-1" for="ec-update-current">Current Parameters (%)</label>
                        <input type="number" step="0.01" min="0" max="100"
                ...
                <div class="modal-footer py-2">
                    ...
                    <button type="button" class="btn btn-sm btn-primary" id="ec-update-modal-save">Save</button>
                </div>
            </div>
        </div>
    </div>
...
@section('script')
    ...
    <script>
        (function() {
            const el = document.getElementById('escalated-claims-tabulator');
            if (!el) {
                return;
            }

            const urlData = @json(route('escalated.claims.tabulator.data'));
            const urlLinkSave = @json(route('escalated.claims.link.save'));
            const urlHistory = @json(route('escalated.claims.history'));
            ...
            function channelLogoFormatter(cell) {
                ...
                if (!logo) {
                    return '<span class="ec-channel-logo-placeholder" title="No logo">—</span>';
                }
                return '<img src="/storage/' + escAttr(logo) + '" alt="' + escAttr(channel) +
                    '" class="ec-channel-logo" onerror="this.outerHTML=\'<span class=&quot;ec-channel-logo-placeholder&quot; title=&quot;No logo&quot;>—</span>\'" />';
            }
            ...
            function requiredParameterFormatter(cell) {
                ...
                if (pct === null) {
                    span.className = 'ec-param empty';
                    span.textContent = '—';
                    return span;
                }
                span.className = 'ec-param required';
            ...
            function currentParameterFormatter(cell) {
                ...
                span.className = 'ec-param current' + (tone ? (' ' + tone) : '');
            ...
            function updateCountLabels(counts) {
                const redEl = document.getElementById('ec-count-red');
                const yellowEl = document.getElementById('ec-count-yellow');
                const greenEl = document.getElementById('ec-count-green');
            ...
            function setToneFilter(tone) {
                ...
                const badge = document.getElementById('ec-pie-filter-badge');
                const label = document.getElementById('ec-pie-filter-label');
                if (!table) {
                    return;
                }
            ...
            function renderStatusPie(rows) {
                const canvas = document.getElementById('ec-status-pie');
            ...
            function openStatusHistory(tone) {
                const titleEl = document.getElementById('ecStatusHistoryModalLabel');
                const emptyEl = document.getElementById('ec-status-history-empty');
                ...
                const modalEl = document.getElementById('ecStatusHistoryModal');
                ...
                api(urlHistory + '?days=60&tone=' + encodeURIComponent(tone || '')).then(function(res) {
                    ...
                    const canvas = document.getElementById('ec-status-history-chart');
                    if (!canvas || typeof Chart === 'undefined') {
                        return;
                    }
            ...
            function linkArrowFormatter(cell) {
                ...
                const img = '<img src="' + escAttr(linkArrowSrc) +
                    '" alt="Link" class="ec-link-arrow" title="Link" />';

                if (href) {
                    return '<a href="' + escAttr(href) +
                        '" target="_blank" rel="noopener noreferrer" class="ec-link-arrow-btn" title="Open link">' +
                        img + '</a>';
                }

                return '<span class="ec-link-arrow-btn" title="No link yet">' + img + '</span>';
            }
            ...
            function historyFormatter(cell) {
                ...
                if (!data.updated_at_ts || !data.history_display) {
                    span.className = 'ec-history empty';
                    span.textContent = '—';
                    return span;
                }
                span.className = 'ec-history ' + (data.is_stale ? 'stale' : 'fresh');
            ...
            function textCellFormatter(cell) {
                ...
                if (!text) {
                    span.className = 'ec-text-cell empty';
                    span.textContent = '—';
                    return span;
                }
                span.className = 'ec-text-cell';
            ...
            function openUpdateModal(data) {
                ...
                const modalEl = document.getElementById('ecUpdateModal');
                if (modalEl && window.bootstrap && bootstrap.Modal) {
                    bootstrap.Modal.getOrCreateInstance(modalEl).show();
                    setTimeout(function() {
                        if (currentEl) {
            ...
            const clearFilterBtn = document.getElementById('ec-pie-clear-filter');
            if (clearFilterBtn) {
            ...
            document.querySelectorAll('.ec-legend-btn').forEach(function(btn) {
            ...
            api(urlData).then(function(rows) {
                ...
                table = new Tabulator('#escalated-claims-tabulator', {
                    layout: 'fitColumns',
                ...
                console.error('Escalated Claims data load failed', err);
                el.innerHTML =
                    '<div class="p-3 text-danger small">Failed to load escalated claims data.</div>';
            });
        })();
    </script>
@endsection
