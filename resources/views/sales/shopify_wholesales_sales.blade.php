@extends('layouts.vertical', ['title' => 'Shopify Wholesales Sales', 'sidenav' => 'condensed'])
...
@section('content')
    @include('layouts.shared.page-title', [
        'page_title' => 'Shopify Wholesales Sales',
        'sub_title' => 'Shopify Wholesales Sales Analysis - Draft Orders (Last 30 Days)',
    ])
    <div class="toast-container"></div>
    <div class="row">
        <div class="card shadow-sm">
            <div class="card-body py-3">
                <h4>Shopify Wholesales Sales (L30) - Draft Orders</h4>
            ...
            <div class="card-body" style="padding: 0;">
                <div id="shopify-wholesales-table-wrapper" style="height: calc(100vh - 200px); display: flex; flex-direction: column;">
                    <!-- SKU Search -->
                    <div class="p-2 bg-light border-bottom">
                        <input type="text" id="sku-search" class="form-control form-control-sm" placeholder="Search by SKU...">
                    </div>
                    <!-- Table body (scrollable section) -->
                    <div id="shopify-wholesales-table" style="flex: 1;"></div>
                </div>
            </div>
        </div>
    </div>
...
<script src="https://unpkg.com/tabulator-tables@6.3.1/dist/js/tabulator.min.js"></script>
<script>
    const COLUMN_VIS_KEY = "shopify_wholesales_column_visibility";
    let table = null;
    ...
    $(document).ready(function() {
        ...
        console.log("Initializing Tabulator for Shopify Wholesales Sales...");
        table = new Tabulator("#shopify-wholesales-table", {
            ajaxURL: "/shopify-wholesales/sales-data",
            ajaxSorting: false,
        ...
        function buildColumnDropdown() {
            ...
            fetch('/shopify-wholesales-column-visibility', {
                    method: 'GET',
                    headers: {
        ...
        $('#export-btn').on('click', function() {
            table.download("csv", "shopify_wholesales_sales.csv");
        });
    });
</script>
@endsection
