@extends('layouts.vertical', ['title' => 'Tiendamia Daily Sales Data', 'sidenav' => 'condensed'])
...
@section('content')
    @include('layouts.shared.page-title', [
        'page_title' => 'Tiendamia Daily Sales Data',
        'sub_title' => 'Tiendamia Daily Sales Data Analysis (L30)',
    ])
    <div class="toast-container"></div>
    <div class="row">
        <div class="card shadow-sm">
            <div class="card-body py-3">
                <h4>Tiendamia Daily Sales Data (L30)</h4>
            ...
            <div class="card-body" style="padding: 0;">
                <div id="tiendamia-table-wrapper" style="height: calc(100vh - 200px); display: flex; flex-direction: column;">
                    <!-- SKU Search -->
...
@section('script-bottom')
    ...
    <script src="https://unpkg.com/tabulator-tables@6.3.1/dist/js/tabulator.min.js"></script>
    <script>
        const COLUMN_VIS_KEY = "tiendamia_sales_column_visibility";
        let table = null;
        ...
        $(document).ready(function() {
            ...
            console.log("Initializing Tabulator for Tiendamia Daily Sales Data...");
            table = new Tabulator("#tiendamia-table", {
                ajaxURL: "/tiendamia/daily-sales-data",
                ajaxSorting: false,
            ...
            function buildColumnDropdown() {
                ...
                fetch('/tiendamia-daily-sales-column-visibility', {
                        method: 'GET',
                        headers: {
            ...
            $('#export-btn').on('click', function() {
                table.download("csv", "tiendamia_daily_sales_data.csv");
            });
        });
    </script>
@endsection
