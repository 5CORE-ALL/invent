@extends('layouts.vertical', ['title' => 'Best Buy Daily Sales Data', 'sidenav' => 'condensed'])
    ...
    <div class="row">
        <div class="card shadow-sm">
            <div class="card-body py-3">
                <h4>Best Buy Daily Sales Data (L30)</h4>
...
@section('script-bottom')
    ...
    <script src="https://unpkg.com/tabulator-tables@6.3.1/dist/js/tabulator.min.js"></script>
    <script>
        const COLUMN_VIS_KEY = "bestbuy_sales_column_visibility";
        let table = null;
