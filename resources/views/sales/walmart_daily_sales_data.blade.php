@extends('layouts.vertical', ['title' => 'Walmart Daily Sales Data', 'sidenav' => 'condensed'])
...
@section('script-bottom')
    ...
    const WALMART_SPENT = {{ $walmartSpent ?? 0 }};
        ...
        $(document).ready(function() {
            ...
            console.log("Initializing Tabulator for Walmart Daily Sales Data...");
            table = new Tabulator("#walmart-table", {
                ajaxURL: "/walmart/daily-sales-data",
                ajaxSorting: false,
