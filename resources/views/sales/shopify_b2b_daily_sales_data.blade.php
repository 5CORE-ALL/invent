@extends('layouts.vertical', ['title' => 'Shopify B2B Daily Sales Data', 'sidenav' => 'condensed'])
    ...
    <div class="row">
        <div class="card shadow-sm">
            ...
            <div class="card-body" style="padding: 0;">
                <div id="shopify-b2b-table-wrapper" style="height: calc(100vh - 200px); display: flex; flex-direction: column;">
                    <!-- SKU Search -->
                    <div class="p-2 bg-light border-bottom">
                        <input type="text" id="sku-search" class="form-control form-control-sm" placeholder="Search by SKU...">
                    </div>
                    <!-- Table body (scrollable section) -->
                    <div id="shopify-b2b-table" style="flex: 1;"></div>
                </div>
            </div>
        </div>
    </div>
...
<script src="https://unpkg.com/tabulator-tables@6.3.1/dist/js/tabulator.min.js"></script>
<script>
    const COLUMN_VIS_KEY = "shopify_b2b_sales_column_visibility";
    let table = null;
    ...
    $(document).ready(function() {
        ...
        console.log("Initializing Tabulator for Shopify B2B Daily Sales Data...");
        table = new Tabulator("#shopify-b2b-table", {
            ajaxURL: "/shopify-b2b/daily-sales-data",
            ajaxSorting: false,
        ...
        function buildColumnDropdown() {
            ...
            fetch('/shopify-b2b-column-visibility', {
                    method: 'GET',
                    headers: {
        ...
        $('#export-btn').on('click', function() {
            table.download("csv", "shopify_b2b_daily_sales_data.csv");
        });
    });
</script>
@endsection
