@extends('layouts.vertical', ['title' => 'Doba Daily Sales Data', 'sidenav' => 'condensed'])
...
@section('content')
    @include('layouts.shared.page-title', [
        'page_title' => 'Doba Daily Sales Data',
        'sub_title' => 'Doba Daily Sales Data Analysis (L30)',
    ])
    <div class="toast-container"></div>
    <div class="row">
        <div class="card shadow-sm">
            <div class="card-body py-3">
                <h4>Doba Daily Sales Data (L30)</h4>
...
<script>
    ...
    $(document).ready(function() {
            ...
            columns: [
                ...
                },
                {
                    ...
                    formatter: function(cell) {
                        ...
                        if (value.toLowerCase().includes('shipped')) badgeClass = 'bg-success';
                        else if (value.toLowerCase().includes('pending')) badgeClass = 'bg-warning';
                        else if (value.toLowerCase().includes('cancelled')) badgeClass = 'bg-danger';
                ...
                },
                {
                    ...
                    formatter: function(cell) {
                        ...
                        return `<span style="color: ${color};">$${parseFloat(value).toFixed(2)}</span>`;
                    }
                },
                {
                    title: "PFT Each %",
        ...
        function updateSummary() {
            ...
            // Calculate PFT Percentage: (Sum of PFT / Sum of Total Sales) * 100
            ...
            const tacosPercentage = 0;
            const mPft = pftPercentage;
            const nRoi = roiPercentage;
            const adsPercentage = 0;
            const pftPercentageFiltered = pftPercentage;
                ...
                .then(savedVisibility => {
                    table.getColumns().forEach(col => {
                        ...
                        if (def.field) {
                            ...
                            checkbox.id = 'col-' + def.field;
                            const label = document.createElement('label');
                            label.htmlFor = 'col-' + def.field;
        ...
        $('#export-btn').on('click', function() {
            table.download("csv", "doba_daily_sales_data.csv");
        });
    });
</script>
@endsection