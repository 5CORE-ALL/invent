@extends('layouts.vertical', ['title' => 'Wayfair Daily Sales Data', 'sidenav' => 'condensed'])
...
@section('content')
    @include('layouts.shared.page-title', [
        'page_title' => 'Wayfair Daily Sales Data',
        'sub_title' => 'Wayfair Daily Sales Data Analysis (L30)',
    ])
    ...
    <div class="row">
        <div class="card shadow-sm">
            ...
            <div class="card-body" style="padding: 0;">
                <div id="wayfair-table-wrapper" style="height: calc(100vh - 200px); display: flex; flex-direction: column;">
                    <!-- SKU Search -->
                    ...
                    <div id="wayfair-table" style="flex: 1;"></div>
                </div>
            </div>
        </div>
    </div>
...
@section('script-bottom')
    ...
    <script src="https://unpkg.com/tabulator-tables@6.3.1/dist/js/tabulator.min.js"></script>
    <script>
        const COLUMN_VIS_KEY = "wayfair_sales_column_visibility";
        let table = null;
        ...
        $(document).ready(function() {
            ...
            console.log("Initializing Tabulator for Wayfair Daily Sales Data...");
            table = new Tabulator("#wayfair-table", {
                ajaxURL: "/wayfair/daily-sales-data",
                ajaxSorting: false,
            ...
            function updateSummary() {
                ...
                data.forEach(row => {
                    // Skip rows with empty SKU or po_number
                    if (!row.sku || row.sku === '' || !row.po_number || row.po_number === '') {
                        return;
                    }
            ...
            function buildColumnDropdown() {
                ...
                fetch('/wayfair-daily-sales-column-visibility', {
                        method: 'GET',
                        headers: {
            ...
            $('#export-btn').on('click', function() {
                table.download("csv", "wayfair_daily_sales_data.csv");
            });
        });
    </script>
@endsection
