@extends('layouts.vertical', ['title' => 'Mercari Daily Sales Data', 'sidenav' => 'condensed'])
...
@section('content')
    @include('layouts.shared.page-title', [
        'page_title' => 'Mercari Daily Sales Data',
        'sub_title' => 'Mercari Daily Sales Data Analysis',
    ])
    <div class="toast-container"></div>
    <div class="row">
        <div class="card shadow-sm">
            <div class="card-body py-3">
                <h4>Mercari Daily Sales Data</h4>
...
@section('script-bottom')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            console.log("Initializing Tabulator for Mercari Daily Sales Data...");
            table = new Tabulator("#mercari-table", {
                ajaxURL: "/mercari/daily-data",
                ajaxSorting: false,
            ...
            $('#export-btn').on('click', function() {
                table.download("csv", "mercari_daily_sales_data.csv");
            });
