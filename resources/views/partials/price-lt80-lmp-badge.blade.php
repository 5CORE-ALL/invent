...
<span class="badge fs-6 p-2 price-lt80-lmp-badge" id="{{ $pltBadgeId }}"
    ...
    data-metric="price_lt80_lmp_count" data-invert="1" data-live-value="0" data-format="number"
    style="background-color:#28a745;color:#fff;font-weight:700;cursor:pointer;"
    title="price &lt; 80% of LMP: SKUs where Price is more than 20% below LMP (purple triangle). Green = 0. Click badge to filter. Click dot for rolling history.">
...
@once
<script src="{{ asset('js/price-lt80-lmp-badge.js') }}?v=5"></script>
<script>
