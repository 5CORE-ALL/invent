...
@php
    ...
    $ebaySprcDilBtnTitle = 'Dil slabs → Target '.$ebaySprcDilTargetLabel.'%.';
...
@endif
                        ...
                        <table class="table table-sm table-bordered align-middle mb-0" id="ebay-dil-groi-table">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="text-end" style="width:130px;">Target {{ $ebaySprcDilTargetLabel }}%</th>
                    ...
                    @if(!empty($ebaySprcDilCvrGroiAdj))
                    <div class="ebay-dg-rules-title mt-3">CVR overlay — Target {{ $ebaySprcDilTargetLabel }}</div>
                    <div class="table-responsive">
...
@if($ebaySprcDilPart === 'script' || $ebaySprcDilPart === 'all')
        ...
        const EBAY_DIL_TARGET_NROI = @json(!empty($ebaySprcDilTargetNroi));
        const EBAY_DIL_TARGET_LABEL = @json($ebaySprcDilTargetLabel ?? 'GROI');
        ...
        function ebayDgCvr30(d) {
            ...
            if (EBAY_DIL_GROI_CHANNEL === 'shopify_b2b') {
                ...
                const l30 = Number(d && d['B2B L30']) || 0;
                const views = Number(d && (d.Views != null ? d.Views : d.views)) || 0;
                return views > 0 ? (l30 / views) * 100 : 0;
            }
        ...
        function ebayDgCvrTrend(d) {
            ...
            const hasCvr60 = !!(d && ((d.CVR_60 != null && d.CVR_60 !== '')
        ...
        function ebayDilTakehomeMargin(d) {
            ...
            if (typeof chPromoTakehomeMargin === 'function') {
                try {
                    ...
                    if (isFinite(rowM) && rowM > 0) return rowM > 1 ? (rowM / 100) : rowM;
        ...
        function ebayDgCellSpriceToSave(d) {
            const painters = [
                typeof bestbuyDisplayedSprice === 'function' ? bestbuyDisplayedSprice : null,
                typeof shopifyB2cShownSprice === 'function' ? shopifyB2cShownSprice : null,
                typeof shopifyB2bDisplayedSprice === 'function' ? shopifyB2bDisplayedSprice : null,
                typeof sheinVisibleSprice === 'function' ? sheinVisibleSprice : null,
