@php
    ...
    $pglTitle = $pglTitle ?? 'Price > landed LMP (red LMP / red triangle), INV > 0 only. Click badge to filter. Click dot for rolling history.';
@endphp
...
@once
<script src="{{ asset('js/price-gt-lmp-badge.js') }}?v=10"></script>
