@extends('layouts.vertical', ['title' => 'Youtube Ads'])
...
@section('content')
@include('layouts.shared.page-title', ['page_title' => 'Youtube Ads', 'sub_title' => 'Youtube Ads'])
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const table = new Tabulator("#youtube-video-ads", {
            index: "Sku",
            ajaxURL: "/youtube-video-ads",
            ajaxConfig: "GET",
            layout: "fitColumns",
            pagination: true,
            paginationSize: 50,
            ...
            columns: [
                ...
                },
                {
                    ...
                    titleFormatter: function () {
                        return `<div>
                            16:9 Video <i class='fa fa-link'></i>
                        </div>`;
                    },
                    hozAlign: "center",
                },
        ...
        table.on("cellEdited", function(cell) {
            ...
            const payload = {
                sku: rowData.Sku,
                value: {
                    sixteen_ratio_link: rowData.sixteen_ratio_link || '',
                    posted: rowData.posted || '',
                }
            };

            fetch("/youtube-video-ads/save", {
                method: "POST",
                headers: {
        ...
        document.addEventListener("change", function (e) {
            ...
            const tableInstance = Tabulator.findTable("#youtube-video-ads")[0];
