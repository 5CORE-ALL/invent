@extends('layouts.vertical', ['title' => 'Instagram Ads'])
...
@section('content')
@include('layouts.shared.page-title', ['page_title' => 'Instagram Ads', 'sub_title' => 'Instagram Ads'])
    ...
    <div class="col-12">
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <div id="instagram-video-ads"></div>
            </div>
        </div>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const table = new Tabulator("#instagram-video-ads", {
            index: "Sku",
            ajaxURL: "/instagram-video-ads",
            ajaxConfig: "GET",
            layout: "fitColumns",
            pagination: true,
            paginationSize: 50,
        ...
        table.on("cellEdited", function(cell) {
            ...
            fetch("/instagram-video-ads/save", {
                method: "POST",
                headers: {
        ...
        document.addEventListener("change", function (e) {
            ...
            const tableInstance = Tabulator.findTable("#instagram-video-ads")[0];
