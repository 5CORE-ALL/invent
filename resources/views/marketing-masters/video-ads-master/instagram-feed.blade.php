@extends('layouts.vertical', ['title' => 'Instagram In Feed Ads'])
...
@section('content')
@include('layouts.shared.page-title', ['page_title' => 'Instagram In Feed Ads', 'sub_title' => 'Instagram In Feed Ads'])
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const table = new Tabulator("#instagram-feed-ads", {
            index: "Sku",
            ajaxURL: "/instagram-feed-ads",
            ajaxConfig: "GET",
            layout: "fitColumns",
            pagination: true,
            paginationSize: 50,
            ...
            columns: [
                ...
                },
                {
                    ...
                    titleFormatter: function () {
                        return `<div>
                            1:1 Video <i class='fa fa-link'></i>
                        </div>`;
                    },
                    hozAlign: "center",
                },
        ...
        table.on("cellEdited", function(cell) {
            ...
            const payload = {
                sku: rowData.Sku,
                value: {
                    oneratio_link: rowData.oneratio_link || '',
                    posted: rowData.posted || '',
                }
            };

            fetch("/instagram-feed-ads/save", {
                method: "POST",
                headers: {
        ...
        document.addEventListener("change", function (e) {
            ...
            const tableInstance = Tabulator.findTable("#instagram-feed-ads")[0];
