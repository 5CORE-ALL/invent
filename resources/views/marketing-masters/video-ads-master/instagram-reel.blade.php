@extends('layouts.vertical', ['title' => 'Instagram Reel Ads'])
...
@section('content')
@include('layouts.shared.page-title', ['page_title' => 'Instagram Reel Ads', 'sub_title' => 'Instagram Reel Ads'])
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const table = new Tabulator("#instagram-reel-ads", {
            index: "Sku",
            ajaxURL: "/instagram-reel-ads",
            ajaxConfig: "GET",
            layout: "fitColumns",
            pagination: true,
            paginationSize: 50,
        ...
        document.addEventListener("change", function (e) {
            ...
            const tableInstance = Tabulator.findTable("#instagram-reel-ads")[0];
