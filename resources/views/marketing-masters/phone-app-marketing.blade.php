@extends('layouts.vertical', ['title' => 'Phone Appt Marketing', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Phone Appt Marketing', 'sub_title' => 'Marketing Master'])
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <!-- <h4 class="header-title">Email Marketing</h4> -->
                    ...
                    <div id="data-loader" class="card-loader-overlay" style="display: none;">
                        <div class="loader-content">
                            ...
                            <div class="loader-text">Loading Phone Appt Marketing data...</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        $(document).ready(function() {
            ...
            function renderTable() {
                ...
                filteredData.forEach(item => {
                    ...
                    //     const $nrCheckbox = $('<input type="checkbox" class="nr-checkbox" disabled />')
                    ...
                    //     );
                    //     $nrContainer.append($nrCheckbox, $nrEditIcon);
                    //     $row.append($('<td>').append($nrContainer));
