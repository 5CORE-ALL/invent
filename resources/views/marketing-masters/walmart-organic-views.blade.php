@extends('layouts.vertical', ['title' => 'Walmart
 Organic Views', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Walmart
     Organic Views Analysis', 'sub_title' => 'Walmart
     Organic Views'])
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function loadData() {
                showLoader();
                return $.ajax({
                    url: '/organic-views-walmart-data',
                    type: 'GET',
                    dataType: 'json',
                    success: function(response) {
