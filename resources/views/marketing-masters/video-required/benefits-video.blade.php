@extends('layouts.vertical', ['title' => 'Benefits Video Required'])
...
@section('content')
@include('layouts.shared.page-title', ['page_title' => 'Benefits Video Required', 'sub_title' => 'Benefits Video Required'])
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const table = new Tabulator("#benefits-video-req", {
            index: "Sku",
            ajaxURL: "/benefits-video-req/view-data",
            ajaxConfig: "GET",
            layout: "fitColumns",
            pagination: true,
            paginationSize: 50,
        ...
        function updateTotalInvAndL30(table) {
            ...
            const totalVideoLink = data.filter(row => row["VideoLink"] && row["VideoLink"].trim() !== "").length;
            ...
            const pendingVideos = totalSKUs - totalNR - totalVideoLink;
        ...
        document.addEventListener("change", function (e) {
            ...
            const tableInstance = Tabulator.findTable("#benefits-video-req")[0];
            ...
            if (field === "Approved" && value === true && (!rowData.VideoLink || rowData.VideoLink.trim() === "")) {
                alert("Please update Video link first.");
