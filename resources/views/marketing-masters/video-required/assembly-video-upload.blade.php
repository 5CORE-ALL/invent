@extends('layouts.vertical', ['title' => 'Assembly Video Upload'])
...
@section('content')
@include('layouts.shared.page-title', ['page_title' => 'Assembly Video Upload', 'sub_title' => 'Assembly Video Upload'])
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const table = new Tabulator("#posted-video-req", {
            index: "Sku",
            ajaxURL: "/assembly-video-upload/view-data",
            ajaxConfig: "GET",
            layout: "fitDataFill",
            pagination: true,
            paginationSize: 50,
        ...
        table.on("cellEdited", function(cell) {
            ...
            fetch("/assembly-video-upload/save", {
                method: "POST",
                headers: {
