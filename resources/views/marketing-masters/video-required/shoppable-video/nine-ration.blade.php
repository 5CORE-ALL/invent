        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <div class="mb-3 d-flex flex-wrap align-items-center gap-3">
                    ...
                    <!-- Export Button -->
                    <a href="/nine-ration-video/export" class="btn btn-outline-success d-flex align-items-center gap-1">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="importModalLabel">
                    <i class="fas fa-upload"></i> Import Nine Ration Video
                </h5>
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <div>
                        <a href="{{ asset('sample_excel/sample_nine_ration_video.csv') }}" 
                           download 
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('confirmImportBtn').addEventListener('click', function() {
            ...
            fetch('/nine-ration-video/import', {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
                },
