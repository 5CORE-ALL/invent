@extends('layouts.vertical', ['title' => 'One Ration Video'])
...
@section('content')
@include('layouts.shared.page-title', ['page_title' => 'One Ration Video', 'sub_title' => 'One Ration Video'])
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const table = new Tabulator("#one-ration-video", {
            index: "Sku",
            ajaxURL: "/one-ration-video/view-data",
            ajaxConfig: "GET",
            layout: "fitColumns",
            pagination: true,
            paginationSize: 50,
