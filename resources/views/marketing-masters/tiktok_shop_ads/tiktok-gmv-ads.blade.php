@extends('layouts.vertical', ['title' => 'Tiktok - GMV Ads', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
@section('css')
...
@section('content')
    @include('layouts.shared.page-title', [
        'page_title' => 'Tiktok GMV Ads',
        'sub_title' => 'Tiktok GMV Ads',
    ])
    <div class="row">
        <div class="col-12">
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        formatter: function(value, row) {
                            if (row.ad_sales > 0) {
                                return ((row.spend / row.ad_sales) * 100).toFixed(2) + '%';
                            }
                            return '0%';
                        },
                        visible: true
                    ...
                    },
                    {
                        ...
                        formatter: function(cell) {
                            ...
                            let bgClass = value === "active" ? "status-active" : "status-inactive";

                            return `
                                <select class="editable-status-select ${bgClass}"
                                        data-sku="${sku}"
                                        data-field="ad_status">
                                    <option value="active" class="status-active-option" ${value === "active" ? "selected" : ""}>Active</option>
                                    <option value="inactive" class="status-inactive-option" ${value === "inactive" ? "selected" : ""}>Inactive</option>
                                </select>
                            `;
                        }
                    },
