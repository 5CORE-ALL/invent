@extends('layouts.vertical', ['title' => 'Tiktok - GMV MAX', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
@section('css')
...
@section('content')
    @include('layouts.shared.page-title', [
        'page_title' => 'Tiktok GMV MAX',
        'sub_title' => 'Tiktok GMV MAX',
    ])
    <div class="row">
        <div class="col-12">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            $('#export-btn').on('click', function () {
                ...
                link.setAttribute('download', 'tiktok_gmv_max_' + new Date().getTime() + '.csv');
