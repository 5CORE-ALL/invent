@extends('layouts.vertical', ['title' => 'Meta - Instagram Existing Post', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
@section('css')
...
@section('content')
    @include('layouts.shared.page-title', [
        'page_title' => 'Instagram Existing Post Ads',
        'sub_title' => 'Instagram Existing Post',
    ])
    <div class="row">
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-body py-3">
                    @include('marketing-masters.meta_ads_manager.partials.filters', [
                        'adType' => 'INSTAGRAM EXISTING POST',
