@extends('layouts.vertical', ['title' => 'Meta Ads Manager - Create Automation Rule', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['sub_title' => 'Marketing Masters', 'page_title' => 'Create Automation Rule'])

    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('meta.ads.manager.automation.store') }}" method="POST" id="ruleForm">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-check mt-4">
                                    <input class="form-check-input" type="checkbox" id="dry_run_mode" name="dry_run_mode" value="1">
                            ...
                            <div class="condition-item mb-3 p-3 border rounded">
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select condition-field" name="conditions[0][field]" required>
                                            <option value="">Select...</option>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select class="form-select condition-operator" name="conditions[0][operator]" required>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" class="form-control condition-value" name="conditions[0][value]" required>
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">Time Period</label>
                                        <select class="form-select condition-aggregation" name="conditions[0][aggregation]">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="hidden" name="conditions[0][type]" value="metric">
                            ...
                            <div class="action-item mb-3 p-3 border rounded">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select action-type" name="actions[0][type]" required>
                                            <option value="">Select...</option>
                                    ...
                                    <div class="col-md-4 action-value-container" style="display: none;">
                                        <label class="form-label">Value</label>
                                        <input type="text" class="form-control action-value" name="actions[0][value]" placeholder="e.g., 100 (for budget in $)">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label">&nbsp;</label>
