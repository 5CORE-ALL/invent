@extends('layouts.vertical', ['title' => 'Temu Organic Views', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Temu Organic Views Analysis', 'sub_title' => 'Temu Organic Views'])
                    ...
                    <table class="custom-resizable-table" id="amazon-table">
                        <thead>
                            <tr>
                                ...
                                <th data-field="moq" style="vertical-align: middle; white-space: nowrap;">
                                    <div class="d-flex flex-column align-items-center" style="gap: 4px">
                                        <div class="d-flex align-items-center">
                                            MOQ <span class="sort-arrow">↓</span>
                                        </div>
                                        {{-- <div style="width: 100%; height: 5px; background-color: #9ec7f4;"></div> --}}
                                        {{-- <div class="metric-total" id="moq-total">0</div> --}}
                                    </div>
                                </th>
                                <th data-field="sales" style="vertical-align: middle; white-space: nowrap;">
                                    <div class="d-flex flex-column align-items-center" style="gap: 4px">
                                        <div class="d-flex align-items-center">
                                            Required Sales Monthly <span class="sort-arrow">↓</span>
                                        </div>
                                        {{-- <div style="width: 100%; height: 5px; background-color: #9ec7f4;"></div> --}}
                                ...
                                <th data-field="l30_org_views" style="vertical-align: middle; white-space: nowrap;">
                                    <div class="d-flex flex-column align-items-center" style="gap: 4px">
                                        <div class="d-flex align-items-center">
                                            L30 Org Views <span class="sort-arrow">↓</span>
                                        </div>
                                        {{-- <div style="width: 100%; height: 5px; background-color: #9ec7f4;"></div> --}}
                                        {{-- <div class="metric-total" id="l30_org_views-total">0</div> --}}
                                    </div>
                                </th>
                                <th data-field="required_views" style="vertical-align: middle; white-space: nowrap;">
                                    <div class="d-flex flex-column align-items-center" style="gap: 4px">
                                        <div class="d-flex align-items-center">
                                            Required Views <span class="sort-arrow">↓</span>
                                        </div>
                                        {{-- <div style="width: 100%; height: 5px; background-color: #9ec7f4;"></div> --}}
                                        {{-- <div class="metric-total" id="required_views-total">0</div> --}}
                                    </div>
                                </th>
                                <th data-field="organic_views" style="vertical-align: middle; white-space: nowrap;">
                                    <div class="d-flex flex-column align-items-center" style="gap: 4px">
                                        <div class="d-flex align-items-center">
                                            Organic Views <span class="sort-arrow">↓</span>
                                        </div>
                                        {{-- <div style="width: 100%; height: 5px; background-color: #9ec7f4;"></div> --}}
                                        {{-- <div class="metric-total" id="organic_views-total">0</div> --}}
                                    </div>
                                </th>
                                <th data-field="org_sold" style="vertical-align: middle; white-space: nowrap;">
                                    <div class="d-flex flex-column align-items-center" style="gap: 4px">
                                        <div class="d-flex align-items-center">
                                            Organic Sold <span class="sort-arrow">↓</span>
                                        </div>
                                        {{-- <div style="width: 100%; height: 5px; background-color: #9ec7f4;"></div> --}}
                                        {{-- <div class="metric-total" id="organic_views-total">0</div> --}}
                                    </div>
                                ...
                                <th data-field="amazon_product_link" style="vertical-align: middle; white-space: nowrap;">
                                    <div class="d-flex flex-column align-items-center" style="gap: 4px">
                                        <div class="d-flex align-items-center">
                                            Amazon Product Link <span class="sort-arrow">↓</span>
                                        </div>
                                        {{-- <div style="width: 100%; height: 5px; background-color: #9ec7f4;"></div> --}}
                                        {{-- <div class="metric-total" id="amazon_product_link-total">0</div> --}}
                                    </div>
                                </th>
                                <th data-field="comp1" style="vertical-align: middle; white-space: nowrap;">
                                    <div class="d-flex flex-column align-items-center" style="gap: 4px">
                                        <div class="d-flex align-items-center">
                                            Comp 1 <span class="sort-arrow">↓</span>
                                        </div>
                                        {{-- <div style="width: 100%; height: 5px; background-color: #9ec7f4;"></div> --}}
                                        {{-- <div class="metric-total" id="comp1-total">0</div> --}}
                                    </div>
                                </th>
                                <th data-field="comp2" style="vertical-align: middle; white-space: nowrap;">
                                    <div class="d-flex flex-column align-items-center" style="gap: 4px">
                                        <div class="d-flex align-items-center">
                                            Comp 2 <span class="sort-arrow">↓</span>
                                        </div>
                                        {{-- <div style="width: 100%; height: 5px; background-color: #9ec7f4;"></div> --}}
                                        {{-- <div class="metric-total" id="comp2-total">0</div> --}}
                                    </div>
                                </th>
                                <th data-field="title" style="vertical-align: middle; white-space: nowrap;">
                                    <div class="d-flex flex-column align-items-center" style="gap: 4px">
                                        <div class="d-flex align-items-center">
        ...
        $(document).ready(function() {
                    ...
                    success: function(response) {
                        if (response && response.data) {
                            ...
                            tableData = response.data.map((item, index) => {
                                ...
                                const adSold = Number(item.ad_sold) || 0;
                                ...
                                const liveVal = valueJson.Live !== undefined ? parseInt(
                                    valueJson.Live) : 0;
                                const orgSold = Math.max(0, l30 - adSold);
            ...
            function renderTable() {
                ...
                filteredData.forEach(item => {
                    ...
                    $row.append($('<td>').text(item.INV));
                    $row.append($('<td>').text(item.INV));
                    $row.append($('<td>').text(item.org_views));
                    $row.append($('<td>').text(item.org_sold));
                    $row.append($('<td>').text(item.INV));
                    $row.append($('<td>').text(item.INV));
                    $row.append($('<td>').text(item.INV));
