@extends('layouts.vertical', ['title' => 'Cost Price Analysis', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('css')
    ...
    .cube-face {
        ...
        font-size: 20px;
        font-weight: bold;
        background: linear-gradient(135deg, rgba(13,110,253,0.8), rgba(0,123,255,0.9));
    ...
    @keyframes rotate {
        ...
        16%  { transform: rotateX(-90deg) rotateY(0) rotateZ(0); }
        33%  { transform: rotateX(-90deg) rotateY(90deg) rotateZ(0); }
        50%  { transform: rotateX(-180deg) rotateY(90deg) rotateZ(0); }
        66%  { transform: rotateX(-180deg) rotateY(90deg) rotateZ(90deg); }
        83%  { transform: rotateX(-180deg) rotateY(180deg) rotateZ(90deg); }
        100% { transform: rotateX(0) rotateY(360deg) rotateZ(360deg); }
    }
...
@section('content')
    @include('layouts.shared/page-title', [
        'page_title' => 'Cost Price Analysis',
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <!-- Rainbow Wave Loader -->
                    <div id="rainbow-loader" class="cube-loader">
                    <div class="cube-container">
                        <div class="cube">
                            <div class="cube-face cube-face--front">CPA</div>
                            <div class="cube-face cube-face--right">CPA</div>
                            <div class="cube-face cube-face--back">CPA</div>
                            <div class="cube-face cube-face--left">CPA</div>
                            <div class="cube-face cube-face--top">CPA</div>
                            <div class="cube-face cube-face--bottom">CPA</div>
                        </div>
                    </div>
                    <div class="loading-text">Crunching Cost Prise Data</div>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function initializeDataTable() {
                $('#row-callback-datatable').DataTable({
                    serverSide: true,
                    ajax: {
                        url: '/costprice-analysis-data-view',
                        type: 'GET',
                        beforeSend: function() {
