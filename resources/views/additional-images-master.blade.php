@extends('layouts.vertical', ['title' => 'Additional Image Masters', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared.page-title', [
        'page_title' => 'Additional Images Masters',
        'sub_title' => 'Additional Images Master Data',
    ])
    ...
    <div class="row">
        <div class="card shadow-sm">
            <div class="card-body py-3">
                <h4>Additional Images Master</h4>
            ...
            <div class="card-body" style="padding: 0;">
                <div id="aplus-table-wrapper" style="height: calc(100vh - 200px); display: flex; flex-direction: column;">
                    ...
                    <!-- Table -->
                    <div id="additional-table" style="flex: 1;"></div>
                </div>
            </div>
        </div>
    </div>
...
<script>
    const COLUMN_VIS_KEY = "additional_tabulator_column_visibility";
    let table = null;
    let tableData = [];
    ...
    $(document).ready(function() {
        ...
        table = new Tabulator("#additional-table", {
            ajaxURL: "/additional-images-master-data-view",
            ajaxSorting: false,
            layout: "fitData",
            pagination: true,
            paginationSize: 100,
