@extends('layouts.vertical', ['title' => 'Temu PMT Ads', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Temu PMT Ads', 'sub_title' => 'Temu PMT Ads'])
            ...
            <div class="card">
                <div class="card-body d-flex align-items-center" style="gap: 12px;">
                    <div id="percent-edit-div" class="d-flex align-items-center">
                        <div class="input-group" style="width: 150px;">
                            <input type="number" id="updateAllSkusPercent" class="form-control" min="0"
                                max="100" value="{{ $temuPercentage }}" step="0.01" title="Percent" disabled />
                    ...
                    <div id="adupdates-edit-div" class="d-flex align-items-center">
                        <div class="input-group" style="width: 150px;">
                            <input type="number" id="updateAdUpdatesPercent" class="form-control" min="0" value="{{ $temuAdPercentage }}"  step="any" placeholder="Ad Per" disabled />
                            <span class="input-group-text">%</span>
                        </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Temu PMT Ads</h4>
            ...
            $('#editAdUpdatesBtn').on('click', function() {
                ...
                if ($icon.hasClass('fa-pen')) {
                    ...
                    if (isNaN(percent) || percent < 0) {
                        showNotification('danger', 'Invalid ad updates value. Must be a positive number.');
                        $input.val(originalValue); // Restore original value
                        return;
                    }
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            showNotification('success', 'Ad updates percentage updated successfully!');
                            $input.prop('disabled', true);
                            $icon.removeClass('fa-check').addClass('fa-pen');
                            initTable();
                        },
                        error: function(xhr) {
                            showNotification('danger', 'Error updating ad updates percentage.');
                            $input.val(originalValue); // Restore original value
                            $input.prop('disabled', true);
                            $icon.removeClass('fa-check').addClass('fa-pen');
                        }
