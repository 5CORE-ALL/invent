            ...
            <div class="card">
                <div class="card-body p-2">
                    <div class="d-flex flex-wrap align-items-center gap-2 mb-2">
                        ...
                        <div class="gs-serp-missing-badge gs-serp-missing-badge--missing" id="gsSerpMissingWrap" title="Missing: in-stock parents (Inv &gt; 0) in the current view with no matched Google SERP campaign.">
...
@section('script')
    ...
    <script>
        (function () {
            ...
            var exportBtn = document.getElementById('gsSerpMissingExportBtn');
            if (exportBtn) {
                exportBtn.addEventListener('click', function () {
                    var stamp = new Date().toISOString().slice(0, 10);
                    table.download('csv', 'missing-google-serp-ads-' + stamp + '.csv');
                });
            }
            ...
            var tableEl = document.getElementById('gsSerpAdsMissingTable');
