@extends('layouts.vertical', ['title' => 'G-Shopping Missing Ads', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
@section('css')
...
@section('content')
    @include('layouts.shared.page-title', [
        'page_title' => 'G-Shopping Missing Ads',
        'sub_title' => 'G-Shopping Missing Ads',
    ])
    <div class="row">
        <div class="col-12">
                ...
                <div class="card-body py-3">
                    <div class="mb-4">
                        ...
                        <h4 class="fw-bold text-primary mb-3 d-flex align-items-center">
                            ...
                            G-Shopping Missing Ads - <span class="text-danger ms-1 fs-3" id="total-missing-ads"></span>
                        </h4>
                                ...
                                <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <select id="missingAds-filter" class="form-select form-select-md" style="width: 180px;">
                                            ...
                                            <option value="KW Running">Running</option>
                                            <option value="KW Missing">Shopping Missing</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="d-flex flex-wrap gap-3">
                                        ...
                                        <div class="stats-box">
                                            <div class="stats-label">G-Shopping Missing</div>
                                            <div id="kw-missing" class="stats-value danger">0</div>
                                        </div>

                                        <div class="stats-box">
                                            <div class="stats-label">G-Shopping Running</div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            var table = new Tabulator("#budget-under-table", {
                index: "sku",
                ajaxURL: "/google/shopping-missings/ads/data",
                layout: "fitData",
                movableColumns: true,
                    ...
                    },
                    {
                        ...
                        formatter: function(cell){
                            ...
                            if(campaign){
                                ...
                                return `
                                    <span style="color: red;">Shopping Ads Missing</span>
                                    <i class="fa fa-info-circle text-primary toggle-missingAds-btn" 
                                        style="cursor:pointer; margin-left:8px;">
                                    </i>
                                `;
