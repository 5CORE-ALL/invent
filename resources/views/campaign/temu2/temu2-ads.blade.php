                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="row g-2 align-items-end mb-3">
                                    ...
                                    <div class="col-md-5">
                                        <label class="form-label fw-semibold mb-1"
                                            style="color: #475569; font-size: 0.75rem;">
                                            <i class="fa-solid fa-upload me-1" style="color: #64748b;"></i>Upload Temu 2 Ads
                                            Reports
                                        </label>
                                        <div class="d-flex gap-1 align-items-stretch">
                                            <div style="flex: 1; min-width: 0;">
                                                <input type="file" id="l7-upload-file" accept=".xlsx,.xls,.csv,.txt,.tsv"
                                            ...
                                            <div style="flex: 1; min-width: 0;">
                                                <input type="file" id="l30-upload-file" accept=".xlsx,.xls,.csv,.txt,.tsv"
                                                    class="form-control form-control-sm"
                                                    style="font-size: 0.7rem; height: 31px;">
                                    </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById('export-data-btn').addEventListener('click', function() {
                if (typeof table !== 'undefined' && table) {
                    table.download("csv", "temu2-ads-data.csv");
                }
            });
            ...
            document.getElementById('l7-upload-btn').addEventListener('click', function() {
                ...
                $.ajax({
                    url: '/temu2/ads/upload-campaign-report',
                    method: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
