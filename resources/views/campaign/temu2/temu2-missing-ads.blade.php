@extends('layouts.vertical', ['title' => 'Temu 2 Missing Ads', 'sidenav' => 'condensed'])
...
@section('content')
    @include('layouts.shared.page-title', [
        'page_title' => 'Temu 2 Missing Ads',
        'sub_title' => 'Temu 2 goods with Status No ad and Inv > 0 — same Create queue as /temu2/ads.',
    ])
                ...
                <div class="card-body py-3">
                    <div class="d-flex flex-wrap gap-2 align-items-center justify-content-between mb-2">
                        <div class="d-flex flex-wrap gap-2 align-items-center">
                            ...
                            <a href="{{ route('temu2.ads') }}" class="btn btn-sm btn-outline-secondary"
                               title="Open Temu 2 Ads">Temu 2 Ads</a>
                        </div>
                        <div class="d-flex flex-wrap gap-2 align-items-center">
                    ...
                    <div class="mt-2 p-3 bg-light rounded">
                        <div class="temu-missing-badge-row" role="group" aria-label="Missing ads summary">
                            <span class="badge fs-6 p-2" id="missing-count"
                                  ...
                                  title="Unique Temu 2 goods with Status No ad and Inv > 0">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="text-muted small mb-3">Same as /temu2/ads — calls <code>temu.searchrec.ad.create</code>.</p>
                    <div class="mb-2">
...
@section('script')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const dataUrl = @json(route('temu2.ads.missing.data'));
            ...
            table = new Tabulator('#temu-missing-ads-table', {
                ...
                placeholder: 'No missing Temu 2 ads (Status No ad and Inv > 0)',
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        minWidth: 96,
                        headerSort: false,
                        headerTooltip: 'Create is shown only when Status is No ad and Inv > 0. Same as /temu2/ads.',
                        formatter: function (cell) {
            ...
            document.getElementById('export-btn').addEventListener('click', function () {
                table.download('csv', 'temu-2-missing-ads.csv');
            });
            ...
            async function runBulkCreateQueue(explicitIds) {
                ...
                if (!confirm(
                    ...
                    '(Same as Create ads Rule on /temu2/ads)'
                )) {
                    return;
                }
