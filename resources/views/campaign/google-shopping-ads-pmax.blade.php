@extends('layouts.vertical', ['title' => 'Google Shopping PMAX', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
@section('css')
...
@section('content')
    @include('layouts.shared.page-title', [
        'page_title' => 'Google Shopping PMAX',
        'sub_title' => 'Google Shopping PMAX',
    ])
    <div class="row">
        <div class="col-12">
...
@section('script')
    ...
    function fetchChartData(startDate, endDate) {
        $.ajax({
            url: "{{ route('google.shopping.pmax.chart.filter') }}",
            type: "GET",
