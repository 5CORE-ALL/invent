@extends('layouts.vertical', ['title' => 'Amazon FBA PT - Utilized', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
@section('css')
...
@section('content')
    @include('layouts.shared.page-title', [
        'page_title' => 'Amazon FBA PT - Utilized',
        'sub_title' => 'Amazon FBA PT - Utilized',
    ])
    <div class="row">
        <div class="col-12">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.querySelectorAll('.utilization-type-btn').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    if (typeof table !== 'undefined' && table) {
                        table.setData("/amazon/fba/utilized/pt/ads/data?type=" + currentUtilizationType);
            ...
            var table = new Tabulator("#budget-under-table", {
                index: "sku",
                ajaxURL: "/amazon/fba/utilized/pt/ads/data?type=over",
                layout: "fitData",
                movableColumns: true,
        ...
        function loadUtilizationCounts() {
            fetch('/amazon/fba/get-utilization-counts?type=PT')
                .then(res => res.json())
                .then(data => {
                    if (data.status === 200) {
        ...
        function showUtilizationChart(type) {
            ...
            fetch('/amazon/fba/get-utilization-chart-data?type=PT')
                .then(res => res.json())
                .then(data => {
