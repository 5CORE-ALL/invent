...
@section('script')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Function to update button counts from backend
            ...
            document.querySelectorAll('.utilization-type-btn').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    // Reload table data with new type
                    if (typeof table !== 'undefined' && table) {
                        table.setData("/amazon/fba/utilized/kw/ads/data?type=" + currentUtilizationType);
                        ...
                        // Update button counts after data loads
                        setTimeout(function() {
                            updateButtonCounts();
                        }, 500);
                    }
            ...
            var table = new Tabulator("#budget-under-table", {
                index: "sku",
                ajaxURL: "/amazon/fba/utilized/kw/ads/data?type=over",
                layout: "fitData",
                movableColumns: true,
            ...
            table.on("tableBuilt", function() {
                ...
                // Note: Counts are loaded from backend, not from table data
        ...
        function showUtilizationChart(type) {
            ...
            fetch('/amazon/fba/get-utilization-chart-data?type=KW')
                .then(res => res.json())
                .then(data => {
