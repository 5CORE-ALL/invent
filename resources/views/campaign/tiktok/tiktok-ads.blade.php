@extends('layouts.vertical', ['title' => 'Tiktok Ads', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Tiktok Ads', 'sub_title' => 'Tiktok Ads'])
            ...
            <div class="card">
                <div class="card-body d-flex align-items-center" style="gap: 12px;">
                    <div id="percent-edit-div" class="d-flex align-items-center">
                        <div class="input-group" style="width: 150px;">
                            <input type="number" id="updateAllSkusPercent" class="form-control" min="0"
                                max="100" value="{{ $tiktokPercentage }}" step="0.01" title="Percent" disabled />
                    ...
                    <div id="adupdates-edit-div" class="d-flex align-items-center">
                        <div class="input-group" style="width: 150px;">
                            <input type="number" id="updateAdUpdatesPercent" class="form-control" min="0" value="{{ $tiktokAdPercentage }}"  step="any" placeholder="Ad Per" disabled />
                            <span class="input-group-text">%</span>
                        </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Tiktok Ads</h4>
