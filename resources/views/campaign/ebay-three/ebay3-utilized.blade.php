                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex gap-2 align-items-center">
                                    ...
                                    <button class="utilization-type-btn active" data-type="over">Over Utilized</button>
                                    <button class="utilization-type-btn" data-type="under">Under Utilized</button>
                                    <button class="utilization-type-btn" data-type="correctly">Correctly Utilized</button>
                                </div>
                            </div>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.querySelectorAll('.utilization-type-btn').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    if (typeof table !== 'undefined' && table) {
                        ...
                        table.redraw(true);
                        // Stats will update automatically via table.on("dataFiltered") event
                    }
                });
            });
            ...
            table.on("tableBuilt", function() {
                ...
                function updateCampaignStats() {
                    // Function kept for potential future use, but no UI elements to update
                    // Stats are shown via count cards only
                }
