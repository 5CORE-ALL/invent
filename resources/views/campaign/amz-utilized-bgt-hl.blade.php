@extends('layouts.vertical', ['title' => 'Amz - UTILIZED BGT HL', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
@section('css')
...
@section('script')
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Add click handlers for utilization cards
        ...
        function loadUtilizationCounts() {
            fetch('/amazon-sp/get-utilization-counts?type=HL')
                .then(res => res.json())
                .then(data => {
                    if(data.status === 200) {
        ...
        function showUtilizationChart(type) {
            ...
            fetch('/amazon-sp/get-utilization-chart-data?type=HL')
                .then(res => res.json())
                .then(data => {
