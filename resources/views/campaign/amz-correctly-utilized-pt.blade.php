@extends('layouts.vertical', ['title' => 'Amz - CORRECTLY UTILIZED PT', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
@section('css')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            var table = new Tabulator("#budget-under-table", {
                index: "Sku",
                ajaxURL: "/get-amz-correctly-utilized-bgt-pt",
                layout: "fitDataFill",
                movableColumns: true,
        ...
        function showUtilizationChart(type) {
            ...
            fetch('/amazon-sp/get-utilization-chart-data?type=PT')
                .then(res => res.json())
                .then(data => {
