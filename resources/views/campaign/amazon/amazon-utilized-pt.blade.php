        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function updateButtonCounts() {
                ...
                allData.forEach(function(row) {
                    ...
                    // Range filters (1UB, 7UB, lbid, acos) - same as combinedFilter
            ...
            table.on("tableBuilt", function() {
                ...
                // INC/DEC SBID handlers (same as KW file but with campaign_type: 'PT')
                ...
                $("#apply-inc-dec-btn").on("click", function() {
                    ...
                    selectedRows.forEach(function(row) {
                        ...
                        rowsToUpdate.push({ row: row, campaignId: campaignId, newSbid: newSbid, campaignType: 'PT' });
                    });
                    ...
                    rowsToUpdate.forEach(function(rowInfo) {
                        var savePromise = $.ajax({
                            ...
                            data: { campaign_id: rowInfo.campaignId, sbid_m: rowInfo.newSbid, campaign_type: 'PT' }
                ...
                document.getElementById("apr-all-sbid-btn").addEventListener("click", function() {
                    ...
                    var approvePromises = rowBidMap.map(function(item) {
                        return $.ajax({
                            ...
                            method: 'POST',
                            headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                            data: { campaign_id: item.campaignId, sbid_m: item.bid, campaign_type: 'PT' }
                        }).then(function(response) {
                ...
                document.getElementById("save-all-sbid-m-btn").addEventListener("click", function() {
                    ...
                    var savePromises = selectedCampaignIds.map(function(campaignId) {
                        return $.ajax({
                            ...
                            method: 'POST',
                            headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                            data: { campaign_id: campaignId, sbid_m: cleanValue, campaign_type: 'PT' }
                        }).then(function(response) {
