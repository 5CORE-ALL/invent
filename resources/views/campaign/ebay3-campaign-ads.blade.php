        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="small text-muted mb-3">
                    ...
                    Bid comes from the shared eBay 1 <strong>Sbid Rule</strong> slabs (For L7 Views / CVR).
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-info small py-2 mb-0">
                    ...
                    Applied by <strong>ebay3:update-suggestedbid</strong>.
                </div>
            ...
            <div class="modal-footer py-2 d-flex justify-content-between">
                ...
                <div class="d-flex gap-2">
                    ...
                    <button type="button" class="btn btn-sm btn-success" id="sbid-slab-apply-btn"
                            title="Push each visible row's computed S Bid to its eBay 3 campaign">
