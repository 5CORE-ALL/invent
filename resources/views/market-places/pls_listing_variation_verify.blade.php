                ...
                <div class="card-body">
                    <div class="d-flex flex-wrap align-items-center gap-2 mb-2">
                        <div class="d-flex align-items-center flex-wrap gap-2 py-1">
                            ...
                            <span class="pls-stat-badge pls-stat-badge--mismatch" title="Parents with missing or excess SKUs">MISMATCH:<span id="pls-lvv-badge-mismatch">0</span></span>
                        </div>
        ...
        $(document).ready(function () {
            plsLvvTable = new Tabulator('#pls-listing-variation-verify-table', {
                ...
                rowFormatter: function (row) {
                    row.getElement().classList.add('pls-lvv-parent-row');
                },
                columns: [
                    {
                        title: 'Parent',
