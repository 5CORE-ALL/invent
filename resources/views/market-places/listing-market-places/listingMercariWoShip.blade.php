@extends('layouts.vertical', ['title' => 'Listing Mercari WoShip', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('css')
    ...
    <style>
        /* ========== TABLE SHELL ========== */
        #mercariwoship-listing-wrap {
            overflow-x: auto;
            overflow-y: visible;
            width: 100%;
        }

        #mercariwoship-listing-wrap .tabulator {
        ...
        .card-body:has(#mercariwoship-listing-toolbar) {
            width: 100%;
        }

        #mercariwoship-listing-wrap .tabulator .tabulator-tableholder {
            background: #fff;
        }

        /* ========== HEADER ========== */
        #mercariwoship-listing-wrap .tabulator .tabulator-header {
            background: #00d5d5;
            border-bottom: 1px solid #ffffff;
        }

        #mercariwoship-listing-wrap .tabulator-col .tabulator-col-sorter {
            display: none !important;
        }

        #mercariwoship-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-content-holder,
        #mercariwoship-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-title-holder {
        ...
        #mercariwoship-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-title {
            writing-mode: horizontal-tb !important;
            text-orientation: mixed !important;
            transform: none !important;
            white-space: normal !important;
        ...
        #mercariwoship-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content {
            height: auto !important;
            min-height: 34px;
            padding: 0;
        }

        #mercariwoship-listing-wrap .tabulator .tabulator-header .tabulator-col {
            height: auto !important;
            min-height: 34px;
        ...
        #mercariwoship-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content-holder {
            padding-left: 2px !important;
            padding-right: 2px !important;
        }

        /* Header filters */
        #mercariwoship-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input {
            width: 100%;
        ...
        #mercariwoship-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input:focus {
            outline: none;
            border-color: #4361ee;
        ...
        /* ========== ROWS / CELLS ========== */
        #mercariwoship-listing-wrap .tabulator .tabulator-row {
            min-height: 36px;
            border-bottom: 1px solid #f1f5f9;
        }

        #mercariwoship-listing-wrap .tabulator .tabulator-row .tabulator-cell {
        ...
        #mercariwoship-listing-wrap .tabulator-row.parent-row .tabulator-cell input[type="checkbox"] {
            display: none;
        }

        #mercariwoship-listing-wrap .tabulator .tabulator-row:hover {
            background-color: #f8fafc !important;
        }

        #mercariwoship-listing-wrap .tabulator .tabulator-row.tabulator-row-even {
            background-color: #fcfcfd;
        }

        #mercariwoship-listing-wrap .tabulator-row.parent-row,
        #mercariwoship-listing-wrap .tabulator-row.parent-row .tabulator-cell {
            background-color: #fffef2 !important;
            font-weight: 700 !important;
            color: #0f172a;
        }

        #mercariwoship-listing-wrap .tabulator-row.parent-row:hover,
        #mercariwoship-listing-wrap .tabulator-row.parent-row:hover .tabulator-cell {
            background-color: #fefce8 !important;
        }

        /* ========== FOOTER / PAGINATION ========== */
        #mercariwoship-listing-wrap .tabulator .tabulator-footer {
            background: #f8fafc !important;
            border-top: 1px solid #e2e8f0 !important;
            padding: 10px 16px !important;
        }

        #mercariwoship-listing-wrap .tabulator .tabulator-footer .tabulator-paginator {
            display: flex;
            align-items: center;
        ...
        #mercariwoship-listing-wrap .tabulator .tabulator-footer .tabulator-paginator label {
            margin-right: 6px;
            font-size: 12px;
            color: #475569;
            font-weight: 600;
        ...
        #mercariwoship-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page-size {
        ...
        #mercariwoship-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page {
        ...
        #mercariwoship-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page:hover {
            background: #f1f5f9 !important;
            border-color: #cbd5e1 !important;
            color: #1e293b !important;
        }

        #mercariwoship-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page.active {
        ...
        #mercariwoship-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page[disabled] {
            opacity: 0.4 !important;
            cursor: not-allowed !important;
        }

        #mercariwoship-listing-wrap .tabulator .tabulator-footer .tabulator-page-counter {
            margin: 0 0.5rem;
            font-size: 12px;
            color: #334155;
        }
        ...
        #mercariwoship-listing-toolbar .mercariwoship-listing-toolbar-row {
            display: flex;
            flex-wrap: nowrap;
            align-items: center;
        ...
        #mercariwoship-listing-toolbar .listing-stat-badges {
            display: inline-flex;
            flex: 0 0 auto;
            align-items: stretch;
            gap: 0;
        ...
        #mercariwoship-listing-toolbar .listing-stat-badge {
            flex: 0 0 auto;
            justify-content: center;
            margin: 0 !important;
            border-radius: 0;
        ...
        #mercariwoship-listing-toolbar .listing-stat-badges .listing-stat-badge:first-child {
            border-radius: 8px 0 0 8px;
        }

        #mercariwoship-listing-toolbar .listing-stat-badges .listing-stat-badge:last-child {
            border-radius: 0 8px 8px 0;
        }

        #mercariwoship-listing-toolbar .filter-select {
            flex: 0 0 auto;
            min-width: 0;
        ...
        #mercariwoship-listing-toolbar .filter-select:focus {
            outline: none;
            border-color: #4361ee;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.15);
        }

        #mercariwoship-listing-toolbar .toolbar-actions {
            display: flex;
            flex: 0 0 auto;
            align-items: center;
            margin-left: 0;
        ...
        #mercariwoship-listing-toolbar .listing-io-btn {
            border-radius: 5px;
            font-weight: 600;
            font-size: 14px;
            width: 32px;
        ...
        #mercariwoship-listing-toolbar .listing-io-btn::after {
            display: none;
        }

        #mercariwoship-listing-toolbar .listing-io-menu {
            min-width: 42px;
            padding: 4px;
        }

        #mercariwoship-listing-toolbar .listing-io-menu .dropdown-item {
            display: flex;
            align-items: center;
            justify-content: center;
            width: 34px;
        ...
        #mercariwoship-listing-toolbar .listing-io-menu .dropdown-item:hover {
            background: #f1f5f9;
        }
        ...
        /* ========== DROPDOWNS ========== */
        #mercariwoship-listing-wrap select.nr-req-dropdown,
        #mercariwoship-listing-wrap select.listed-dropdown {
        ...
        #mercariwoship-listing-wrap select.nr-req-dropdown:focus,
        #mercariwoship-listing-wrap select.listed-dropdown:focus {
            outline: none;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.25);
        }

        #mercariwoship-listing-wrap select.nr-req-dropdown[data-val="REQ"],
        #mercariwoship-listing-wrap select.nr-req-dropdown option.req-option {
            background-color: #28a745;
            color: #fff;
        }

        #mercariwoship-listing-wrap select.nr-req-dropdown[data-val="NR"],
        #mercariwoship-listing-wrap select.nr-req-dropdown option.nr-option {
            background-color: #dc3545;
            color: #fff;
        }

        #mercariwoship-listing-wrap select.listed-dropdown[data-val="Listed"],
        #mercariwoship-listing-wrap select.listed-dropdown option.listed-option {
            background-color: #28a745;
            color: #fff;
        }

        #mercariwoship-listing-wrap select.listed-dropdown[data-val="Pending"],
        #mercariwoship-listing-wrap select.listed-dropdown option.pending-option {
            background-color: #dc3545;
            color: #fff;
        }
        ...
        /* ========== LINK CELL ========== */
        #mercariwoship-listing-wrap a.listing-item-link {
            font-weight: 600;
            color: #0d6efd;
            text-decoration: none;
        }

        #mercariwoship-listing-wrap a.listing-item-link:hover {
        ...
        /* ========== PLACEHOLDER ========== */
        #mercariwoship-listing-wrap .tabulator-placeholder {
            color: #64748b;
            font-weight: 600;
            padding: 24px;
        }
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Listing Mercari WoShip', 'sub_title' => 'Mercari WoShip'])

    <div class="row">
        <div class="col-12">
            <div class="card position-relative">
                <div class="card-body">
                    <div id="mercariwoship-listing-toolbar" class="mb-3">
                        <div class="mercariwoship-listing-toolbar-row">
                            ...
                            <div class="toolbar-actions dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end listing-io-menu" aria-labelledby="listing-io-btn">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('listing_mercariwoship.export') }}" title="Export">
                    ...
                    <div id="mercariwoship-listing-wrap">
                        <div id="mercariwoshipListing-table"></div>
                    </div>
...
@section('script')
    ...
    <script>
        ...
        let mercariwoshipListingTable = null;
        let allListingData = [];
        ...
        function calculateTotals() {
            try {
                if (!mercariwoshipListingTable) {
                    resetMetricsToZero();
                    return;
                }

                const rows = mercariwoshipListingTable.getData('active') || [];
                const metrics = {
                    invTotal: 0,
                    reqTotal: 0,
                    nrlTotal: 0,
        ...
        function applyListingFilters() {
            if (!mercariwoshipListingTable) return;
            ...
            mercariwoshipListingTable.setFilter(function (data) {
        ...
        $(document).ready(function () {
            ...
            mercariwoshipListingTable = new Tabulator('#mercariwoshipListing-table', {
                ajaxURL: '/listing_mercariwoship/view-data',
            ...
            mercariwoshipListingTable.on('dataFiltered', function () {
                calculateTotals();
            });
            mercariwoshipListingTable.on('dataLoadError', function () {
                hideLoader();
            ...
            $(document).on('click', '#confirmImportBtn', function () {
                ...
                showLoader();
                $.ajax({
                    url: "{{ route('listing_mercariwoship.import') }}",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    ...
                    success: function (response) {
                        ...
                        mercariwoshipListingTable.setData('/listing_mercariwoship/view-data');
                    },
                    error: function (xhr) {
                        hideLoader();
