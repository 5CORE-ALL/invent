@extends('layouts.vertical', ['title' => 'Listing Auto DS', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="d-flex align-items-center mb-3 gap-2">
                            ...
                            <a href="{{ route('listing_autods.export') }}" class="btn btn-sm btn-success mr-3">Export</a>
                    ...
                    <div class="table-container">
                        <table class="custom-resizable-table" id="autoDSListing-table">
                            <thead>
                                <tr>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function renderTable() {
                const $tbody = $('#autoDSListing-table tbody');
                $tbody.empty();
            ...
            function initResizableColumns() {
                const $table = $('#autoDSListing-table');
            ...
            function saveStatusToDB(sku, data) {
                $.ajax({
                    url: '/listing_autods/save-status',
                    type: 'POST',
                    data: {
                        sku: sku,
                        ...data,
