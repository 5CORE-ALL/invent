@extends('layouts.vertical', ['title' => 'Listing SW Gear Exchange', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('css')
    ...
    <style>
        /* ========== TABLE SHELL ========== */
        #swgearexchange-listing-wrap {
            overflow-x: auto;
            overflow-y: visible;
            width: 100%;
        }

        #swgearexchange-listing-wrap .tabulator {
        ...
        .card-body:has(#swgearexchange-listing-toolbar) {
            width: 100%;
        }

        #swgearexchange-listing-wrap .tabulator .tabulator-tableholder {
            background: #fff;
        }

        /* ========== HEADER ========== */
        #swgearexchange-listing-wrap .tabulator .tabulator-header {
            background: #00d5d5;
            border-bottom: 1px solid #ffffff;
        }

        #swgearexchange-listing-wrap .tabulator-col .tabulator-col-sorter {
            display: none !important;
        }

        #swgearexchange-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-content-holder,
        #swgearexchange-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-title-holder {
        ...
        #swgearexchange-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-title {
            writing-mode: horizontal-tb !important;
            text-orientation: mixed !important;
            transform: none !important;
            white-space: normal !important;
        ...
        #swgearexchange-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content {
            height: auto !important;
            min-height: 34px;
            padding: 0;
        }

        #swgearexchange-listing-wrap .tabulator .tabulator-header .tabulator-col {
            height: auto !important;
            min-height: 34px;
        ...
        #swgearexchange-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content-holder {
            padding-left: 2px !important;
            padding-right: 2px !important;
        }

        /* Header filters */
        #swgearexchange-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input {
            width: 100%;
        ...
        #swgearexchange-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input:focus {
            outline: none;
            border-color: #4361ee;
        ...
        /* ========== ROWS / CELLS ========== */
        #swgearexchange-listing-wrap .tabulator .tabulator-row {
            min-height: 36px;
            border-bottom: 1px solid #f1f5f9;
        }

        #swgearexchange-listing-wrap .tabulator .tabulator-row .tabulator-cell {
            padding: 5px 6px !important;
            border-right: 1px solid #f1f5f9;
            vertical-align: middle;
        }

        #swgearexchange-listing-wrap .tabulator-row .tabulator-cell input[type="checkbox"],
        #swgearexchange-listing-wrap .tabulator-header .tabulator-col input[type="checkbox"] {
            width: 16px;
            height: 16px;
            cursor: pointer;
            accent-color: #4361ee;
        ...
        #swgearexchange-listing-wrap .tabulator-row.parent-row .tabulator-cell input[type="checkbox"] {
            display: none;
        }

        #swgearexchange-listing-wrap .tabulator .tabulator-row:hover {
            background-color: #f8fafc !important;
        }

        #swgearexchange-listing-wrap .tabulator .tabulator-row.tabulator-row-even {
            background-color: #fcfcfd;
        }

        #swgearexchange-listing-wrap .tabulator-row.parent-row,
        #swgearexchange-listing-wrap .tabulator-row.parent-row .tabulator-cell {
            background-color: rgba(69, 233, 255, 0.15) !important;
            font-weight: 700 !important;
            color: #0f172a;
        }

        #swgearexchange-listing-wrap .tabulator-row.parent-row:hover,
        #swgearexchange-listing-wrap .tabulator-row.parent-row:hover .tabulator-cell {
            background-color: rgba(69, 233, 255, 0.28) !important;
        }

        /* ========== FOOTER / PAGINATION ========== */
        #swgearexchange-listing-wrap .tabulator .tabulator-footer {
            background: #f8fafc !important;
            border-top: 1px solid #e2e8f0 !important;
            padding: 10px 16px !important;
        }

        #swgearexchange-listing-wrap .tabulator .tabulator-footer .tabulator-paginator {
            display: flex;
            align-items: center;
        ...
        #swgearexchange-listing-wrap .tabulator .tabulator-footer .tabulator-paginator label {
            margin-right: 6px;
            font-size: 12px;
            color: #475569;
            font-weight: 600;
        ...
        #swgearexchange-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page-size {
        ...
        #swgearexchange-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page {
        ...
        #swgearexchange-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page:hover {
            background: #f1f5f9 !important;
            border-color: #cbd5e1 !important;
            color: #1e293b !important;
        }

        #swgearexchange-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page.active {
        ...
        #swgearexchange-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page[disabled] {
            opacity: 0.4 !important;
            cursor: not-allowed !important;
        }

        #swgearexchange-listing-wrap .tabulator .tabulator-footer .tabulator-page-counter {
            margin: 0 0.5rem;
            font-size: 12px;
            color: #334155;
        }
        ...
        #swgearexchange-listing-toolbar {
        ...
        #swgearexchange-listing-toolbar .swgearexchange-listing-toolbar-row {
            display: flex;
            flex-wrap: nowrap;
            align-items: center;
        ...
        #swgearexchange-listing-toolbar .listing-stat-badges {
            display: inline-flex;
            flex: 0 0 auto;
            align-items: stretch;
            gap: 0;
        ...
        #swgearexchange-listing-toolbar .listing-stat-badge {
            flex: 0 0 auto;
            justify-content: center;
            margin: 0 !important;
            border-radius: 0;
        ...
        #swgearexchange-listing-toolbar .listing-stat-badges .listing-stat-badge:first-child {
            border-radius: 8px 0 0 8px;
        }

        #swgearexchange-listing-toolbar .listing-stat-badges .listing-stat-badge:last-child {
            border-radius: 0 8px 8px 0;
        }

        #swgearexchange-listing-toolbar .filter-select {
            flex: 0 0 auto;
            min-width: 0;
        ...
        #swgearexchange-listing-toolbar .filter-select:focus {
            outline: none;
            border-color: #4361ee;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.15);
        }

        #swgearexchange-listing-toolbar .toolbar-actions {
            display: flex;
            flex: 0 0 auto;
            align-items: center;
            margin-left: 0;
        ...
        #swgearexchange-listing-toolbar .listing-io-btn {
            border-radius: 5px;
            font-weight: 600;
            font-size: 14px;
            width: 32px;
        ...
        #swgearexchange-listing-toolbar .listing-io-btn::after {
            display: none;
        }

        #swgearexchange-listing-toolbar .listing-io-menu {
            min-width: 42px;
            padding: 4px;
        }

        #swgearexchange-listing-toolbar .listing-io-menu .dropdown-item {
            display: flex;
            align-items: center;
            justify-content: center;
            width: 34px;
        ...
        #swgearexchange-listing-toolbar .listing-io-menu .dropdown-item:hover {
            background: #f1f5f9;
        }
        ...
        /* ========== DROPDOWNS ========== */
        #swgearexchange-listing-wrap select.nr-req-dropdown,
        #swgearexchange-listing-wrap select.listed-dropdown {
        ...
        #swgearexchange-listing-wrap select.nr-req-dropdown:focus,
        #swgearexchange-listing-wrap select.listed-dropdown:focus {
            outline: none;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.25);
        }

        #swgearexchange-listing-wrap select.nr-req-dropdown[data-val="REQ"],
        #swgearexchange-listing-wrap select.nr-req-dropdown option.req-option {
            background-color: #28a745;
            color: #fff;
        }

        #swgearexchange-listing-wrap select.nr-req-dropdown[data-val="NR"],
        #swgearexchange-listing-wrap select.nr-req-dropdown option.nr-option {
            background-color: #dc3545;
            color: #fff;
        }

        #swgearexchange-listing-wrap select.listed-dropdown[data-val="Listed"],
        #swgearexchange-listing-wrap select.listed-dropdown option.listed-option {
            background-color: #28a745;
            color: #fff;
        }

        #swgearexchange-listing-wrap select.listed-dropdown[data-val="Pending"],
        #swgearexchange-listing-wrap select.listed-dropdown option.pending-option {
            background-color: #dc3545;
            color: #fff;
        }
        ...
        /* ========== LINK CELL ========== */
        #swgearexchange-listing-wrap a.listing-item-link {
            font-weight: 600;
            color: #0d6efd;
            text-decoration: none;
        }

        #swgearexchange-listing-wrap a.listing-item-link:hover {
        ...
        /* ========== PLACEHOLDER ========== */
        #swgearexchange-listing-wrap .tabulator-placeholder {
            color: #64748b;
            font-weight: 600;
            padding: 24px;
        }
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Listing SW Gear Exchange', 'sub_title' => 'SW Gear Exchange'])

    <div class="row">
        <div class="col-12">
            <div class="card position-relative">
                <div class="card-body">
                    <div id="swgearexchange-listing-toolbar" class="mb-3">
                        <div class="swgearexchange-listing-toolbar-row">
                            ...
                            <div class="toolbar-actions dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end listing-io-menu" aria-labelledby="listing-io-btn">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('listing_swgearexchange.export') }}" title="Export">
                    ...
                    <div id="swgearexchange-listing-wrap">
                        <div id="swgearexchangeListing-table"></div>
                    </div>
...
@section('script')
    ...
    <script>
        ...
        let swgearexchangeListingTable = null;
        let allListingData = [];
        ...
        function calculateTotals() {
            try {
                if (!swgearexchangeListingTable) {
                    resetMetricsToZero();
                    return;
                }

                const rows = swgearexchangeListingTable.getData('active') || [];
                const metrics = {
                    invTotal: 0,
                    reqTotal: 0,
                    nrlTotal: 0,
        ...
        function applyListingFilters() {
            if (!swgearexchangeListingTable) return;
            ...
            swgearexchangeListingTable.setFilter(function (data) {
        ...
        $(document).ready(function () {
            ...
            swgearexchangeListingTable = new Tabulator('#swgearexchangeListing-table', {
                ajaxURL: '/listing_swgearexchange/view-data',
            ...
            swgearexchangeListingTable.on('dataProcessed', function () {
                hideLoader();
                applyListingFilters();
            });
            swgearexchangeListingTable.on('dataFiltered', function () {
                calculateTotals();
            });
            swgearexchangeListingTable.on('dataLoadError', function () {
                hideLoader();
            ...
            $(document).on('click', '#confirmImportBtn', function () {
                ...
                showLoader();
                $.ajax({
                    url: "{{ route('listing_swgearexchange.import') }}",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    ...
                    success: function (response) {
                        ...
                        swgearexchangeListingTable.setData('/listing_swgearexchange/view-data');
                    },
                    error: function (xhr) {
                        hideLoader();
