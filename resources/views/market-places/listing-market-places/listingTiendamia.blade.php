...
@section('css')
    ...
    <style>
        /* ========== TABLE SHELL ========== */
        #tiendamia-listing-wrap {
            overflow-x: auto;
            overflow-y: visible;
            width: 100%;
        }

        #tiendamia-listing-wrap .tabulator {
        ...
        .card-body:has(#tiendamia-listing-toolbar) {
            width: 100%;
        }

        #tiendamia-listing-wrap .tabulator .tabulator-tableholder {
            background: #fff;
        }

        /* ========== HEADER ========== */
        #tiendamia-listing-wrap .tabulator .tabulator-header {
            background: #00d5d5;
            border-bottom: 1px solid #ffffff;
        }

        #tiendamia-listing-wrap .tabulator-col .tabulator-col-sorter {
            display: none !important;
        }

        #tiendamia-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-content-holder,
        #tiendamia-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-title-holder {
        ...
        #tiendamia-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-title {
            writing-mode: horizontal-tb !important;
            text-orientation: mixed !important;
            transform: none !important;
            white-space: normal !important;
        ...
        #tiendamia-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content {
            height: auto !important;
            min-height: 34px;
            padding: 0;
        }

        #tiendamia-listing-wrap .tabulator .tabulator-header .tabulator-col {
            height: auto !important;
            min-height: 34px;
        ...
        #tiendamia-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content-holder {
            padding-left: 2px !important;
            padding-right: 2px !important;
        }

        /* Header filters */
        #tiendamia-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input {
            width: 100%;
        ...
        #tiendamia-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input:focus {
            outline: none;
            border-color: #4361ee;
        ...
        /* ========== ROWS / CELLS ========== */
        #tiendamia-listing-wrap .tabulator .tabulator-row {
            min-height: 36px;
            border-bottom: 1px solid #f1f5f9;
        }

        #tiendamia-listing-wrap .tabulator .tabulator-row .tabulator-cell {
            padding: 5px 6px !important;
            border-right: 1px solid #f1f5f9;
            vertical-align: middle;
        }

        #tiendamia-listing-wrap .tabulator-row .tabulator-cell input[type="checkbox"],
        #tiendamia-listing-wrap .tabulator-header .tabulator-col input[type="checkbox"] {
            width: 16px;
            height: 16px;
            cursor: pointer;
            accent-color: #4361ee;
        ...
        #tiendamia-listing-wrap .tabulator-row.parent-row .tabulator-cell input[type="checkbox"] {
            display: none;
        }

        #tiendamia-listing-wrap .tabulator .tabulator-row:hover {
            background-color: #f8fafc !important;
        }

        #tiendamia-listing-wrap .tabulator .tabulator-row.tabulator-row-even {
            background-color: #fcfcfd;
        }

        #tiendamia-listing-wrap .tabulator-row.parent-row,
        #tiendamia-listing-wrap .tabulator-row.parent-row .tabulator-cell {
            background-color: rgba(69, 233, 255, 0.15) !important;
            font-weight: 700 !important;
            color: #0f172a;
        }

        #tiendamia-listing-wrap .tabulator-row.parent-row:hover,
        #tiendamia-listing-wrap .tabulator-row.parent-row:hover .tabulator-cell {
            background-color: rgba(69, 233, 255, 0.28) !important;
        }

        /* ========== FOOTER / PAGINATION ========== */
        #tiendamia-listing-wrap .tabulator .tabulator-footer {
            background: #f8fafc !important;
            border-top: 1px solid #e2e8f0 !important;
            padding: 10px 16px !important;
        }

        #tiendamia-listing-wrap .tabulator .tabulator-footer .tabulator-paginator {
            display: flex;
            align-items: center;
        ...
        #tiendamia-listing-wrap .tabulator .tabulator-footer .tabulator-paginator label {
            margin-right: 6px;
            font-size: 12px;
            color: #475569;
            font-weight: 600;
        ...
        #tiendamia-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page-size {
        ...
        #tiendamia-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page {
        ...
        #tiendamia-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page:hover {
            background: #f1f5f9 !important;
            border-color: #cbd5e1 !important;
            color: #1e293b !important;
        }

        #tiendamia-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page.active {
        ...
        #tiendamia-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page[disabled] {
            opacity: 0.4 !important;
            cursor: not-allowed !important;
        }

        #tiendamia-listing-wrap .tabulator .tabulator-footer .tabulator-page-counter {
            margin: 0 0.5rem;
            font-size: 12px;
            color: #334155;
        }
        ...
        #tiendamia-listing-toolbar .tiendamia-listing-toolbar-row {
            display: flex;
            flex-wrap: nowrap;
            align-items: center;
        ...
        #tiendamia-listing-toolbar .listing-stat-badges {
            display: inline-flex;
            flex: 0 0 auto;
            align-items: stretch;
            gap: 0;
        ...
        #tiendamia-listing-toolbar .listing-stat-badge {
            flex: 0 0 auto;
            justify-content: center;
            margin: 0 !important;
            border-radius: 0;
        ...
        #tiendamia-listing-toolbar .listing-stat-badges .listing-stat-badge:first-child {
            border-radius: 8px 0 0 8px;
        }

        #tiendamia-listing-toolbar .listing-stat-badges .listing-stat-badge:last-child {
            border-radius: 0 8px 8px 0;
        }

        #tiendamia-listing-toolbar .filter-select {
            flex: 0 0 auto;
            min-width: 0;
        ...
        #tiendamia-listing-toolbar .filter-select:focus {
            outline: none;
            border-color: #4361ee;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.15);
        }

        #tiendamia-listing-toolbar .toolbar-actions {
            display: flex;
            flex: 0 0 auto;
            align-items: center;
            margin-left: 0;
        ...
        #tiendamia-listing-toolbar .listing-io-btn {
            border-radius: 5px;
            font-weight: 600;
            font-size: 14px;
            width: 32px;
        ...
        #tiendamia-listing-toolbar .listing-io-btn::after {
            display: none;
        }

        #tiendamia-listing-toolbar .listing-io-menu {
            min-width: 42px;
            padding: 4px;
        }

        #tiendamia-listing-toolbar .listing-io-menu .dropdown-item {
            display: flex;
            align-items: center;
            justify-content: center;
            width: 34px;
        ...
        #tiendamia-listing-toolbar .listing-io-menu .dropdown-item:hover {
            background: #f1f5f9;
        }
        ...
        /* ========== DROPDOWNS ========== */
        #tiendamia-listing-wrap select.nr-req-dropdown,
        #tiendamia-listing-wrap select.listed-dropdown {
        ...
        #tiendamia-listing-wrap select.nr-req-dropdown:focus,
        #tiendamia-listing-wrap select.listed-dropdown:focus {
            outline: none;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.25);
        }

        #tiendamia-listing-wrap select.nr-req-dropdown[data-val="REQ"],
        #tiendamia-listing-wrap select.nr-req-dropdown option.req-option {
            background-color: #28a745;
            color: #fff;
        }

        #tiendamia-listing-wrap select.nr-req-dropdown[data-val="NR"],
        #tiendamia-listing-wrap select.nr-req-dropdown option.nr-option {
            background-color: #dc3545;
            color: #fff;
        }

        #tiendamia-listing-wrap select.listed-dropdown[data-val="Listed"],
        #tiendamia-listing-wrap select.listed-dropdown option.listed-option {
            background-color: #28a745;
            color: #fff;
        }

        #tiendamia-listing-wrap select.listed-dropdown[data-val="Pending"],
        #tiendamia-listing-wrap select.listed-dropdown option.pending-option {
            background-color: #dc3545;
            color: #fff;
        }
        ...
        /* ========== LINK CELL ========== */
        #tiendamia-listing-wrap a.listing-item-link {
            font-weight: 600;
            color: #0d6efd;
            text-decoration: none;
        }

        #tiendamia-listing-wrap a.listing-item-link:hover {
        ...
        /* ========== PLACEHOLDER ========== */
        #tiendamia-listing-wrap .tabulator-placeholder {
            color: #64748b;
            font-weight: 600;
            padding: 24px;
        }
    ...
    <div class="row">
        <div class="col-12">
            <div class="card position-relative">
                <div class="card-body">
                    <div id="tiendamia-listing-toolbar" class="mb-3">
                        <div class="tiendamia-listing-toolbar-row">
                            ...
                            <div class="toolbar-actions dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end listing-io-menu" aria-labelledby="listing-io-btn">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('listing_tiendamia.export') }}" title="Export">
                    ...
                    <div id="tiendamia-listing-wrap">
                        <div id="tiendamiaListing-table"></div>
                    </div>
...
@section('script')
    ...
    <script>
        ...
        let tiendamiaListingTable = null;
        let allListingData = [];
        ...
        function calculateTotals() {
            try {
                if (!tiendamiaListingTable) {
                    resetMetricsToZero();
                    return;
                }

                const rows = tiendamiaListingTable.getData('active') || [];
                const metrics = {
                    invTotal: 0,
                    reqTotal: 0,
                    nrlTotal: 0,
        ...
        function applyListingFilters() {
            if (!tiendamiaListingTable) return;
            ...
            tiendamiaListingTable.setFilter(function (data) {
        ...
        $(document).ready(function () {
            ...
            tiendamiaListingTable = new Tabulator('#tiendamiaListing-table', {
                ajaxURL: '/listing_tiendamia/view-data',
            ...
            tiendamiaListingTable.on('dataProcessed', function () {
                hideLoader();
                applyListingFilters();
            });
            tiendamiaListingTable.on('dataFiltered', function () {
                calculateTotals();
            });
            tiendamiaListingTable.on('dataLoadError', function () {
                hideLoader();
            ...
            $(document).on('click', '#confirmImportBtn', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        tiendamiaListingTable.setData('/listing_tiendamia/view-data');
                    },
                    error: function (xhr) {
                        hideLoader();
