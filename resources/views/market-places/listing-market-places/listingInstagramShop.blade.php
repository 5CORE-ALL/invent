@extends('layouts.vertical', ['title' => 'Listing Instagram Shop', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('css')
    ...
    <style>
        /* ========== TABLE SHELL ========== */
        #instagramshop-listing-wrap {
            overflow-x: auto;
            overflow-y: visible;
            width: 100%;
        }

        #instagramshop-listing-wrap .tabulator {
        ...
        .card-body:has(#instagramshop-listing-toolbar) {
            width: 100%;
        }

        #instagramshop-listing-wrap .tabulator .tabulator-tableholder {
            background: #fff;
        }

        /* ========== HEADER ========== */
        #instagramshop-listing-wrap .tabulator .tabulator-header {
            background: #00d5d5;
            border-bottom: 1px solid #ffffff;
        }

        #instagramshop-listing-wrap .tabulator-col .tabulator-col-sorter {
            display: none !important;
        }

        #instagramshop-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-content-holder,
        #instagramshop-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-title-holder {
        ...
        #instagramshop-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-title {
            writing-mode: horizontal-tb !important;
            text-orientation: mixed !important;
            transform: none !important;
            white-space: normal !important;
        ...
        #instagramshop-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content {
            height: auto !important;
            min-height: 34px;
            padding: 0;
        }

        #instagramshop-listing-wrap .tabulator .tabulator-header .tabulator-col {
            height: auto !important;
            min-height: 34px;
        ...
        #instagramshop-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content-holder {
            padding-left: 2px !important;
            padding-right: 2px !important;
        }

        /* Header filters */
        #instagramshop-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input {
            width: 100%;
        ...
        #instagramshop-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input:focus {
            outline: none;
            border-color: #4361ee;
        ...
        /* ========== ROWS / CELLS ========== */
        #instagramshop-listing-wrap .tabulator .tabulator-row {
            min-height: 36px;
            border-bottom: 1px solid #f1f5f9;
        }

        #instagramshop-listing-wrap .tabulator .tabulator-row .tabulator-cell {
            padding: 5px 6px !important;
            border-right: 1px solid #f1f5f9;
            vertical-align: middle;
        }

        #instagramshop-listing-wrap .tabulator-row .tabulator-cell input[type="checkbox"],
        #instagramshop-listing-wrap .tabulator-header .tabulator-col input[type="checkbox"] {
            width: 16px;
            height: 16px;
            cursor: pointer;
            accent-color: #4361ee;
        ...
        #instagramshop-listing-wrap .tabulator-row.parent-row .tabulator-cell input[type="checkbox"] {
            display: none;
        }

        #instagramshop-listing-wrap .tabulator .tabulator-row:hover {
            background-color: #f8fafc !important;
        }

        #instagramshop-listing-wrap .tabulator .tabulator-row.tabulator-row-even {
            background-color: #fcfcfd;
        }

        #instagramshop-listing-wrap .tabulator-row.parent-row,
        #instagramshop-listing-wrap .tabulator-row.parent-row .tabulator-cell {
            background-color: #fffef2 !important;
            font-weight: 700 !important;
            color: #0f172a;
        }

        #instagramshop-listing-wrap .tabulator-row.parent-row:hover,
        #instagramshop-listing-wrap .tabulator-row.parent-row:hover .tabulator-cell {
            background-color: #fefce8 !important;
        }

        /* ========== FOOTER / PAGINATION ========== */
        #instagramshop-listing-wrap .tabulator .tabulator-footer {
            background: #f8fafc !important;
            border-top: 1px solid #e2e8f0 !important;
            padding: 10px 16px !important;
        }

        #instagramshop-listing-wrap .tabulator .tabulator-footer .tabulator-paginator {
            display: flex;
            align-items: center;
        ...
        #instagramshop-listing-wrap .tabulator .tabulator-footer .tabulator-paginator label {
            margin-right: 6px;
            font-size: 12px;
            color: #475569;
            font-weight: 600;
        ...
        #instagramshop-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page-size {
        ...
        #instagramshop-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page {
        ...
        #instagramshop-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page:hover {
            background: #f1f5f9 !important;
            border-color: #cbd5e1 !important;
            color: #1e293b !important;
        }

        #instagramshop-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page.active {
        ...
        #instagramshop-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page[disabled] {
            opacity: 0.4 !important;
            cursor: not-allowed !important;
        }

        #instagramshop-listing-wrap .tabulator .tabulator-footer .tabulator-page-counter {
            margin: 0 0.5rem;
            font-size: 12px;
            color: #334155;
        }
        ...
        #instagramshop-listing-toolbar .instagramshop-listing-toolbar-row {
            display: flex;
            flex-wrap: nowrap;
            align-items: center;
        ...
        #instagramshop-listing-toolbar .listing-stat-badges {
            display: inline-flex;
            flex: 0 0 auto;
            align-items: stretch;
            gap: 0;
        ...
        #instagramshop-listing-toolbar .listing-stat-badge {
            flex: 0 0 auto;
            justify-content: center;
            margin: 0 !important;
            border-radius: 0;
        ...
        #instagramshop-listing-toolbar .listing-stat-badges .listing-stat-badge:first-child {
            border-radius: 8px 0 0 8px;
        }

        #instagramshop-listing-toolbar .listing-stat-badges .listing-stat-badge:last-child {
            border-radius: 0 8px 8px 0;
        }

        #instagramshop-listing-toolbar .filter-select {
            flex: 0 0 auto;
            min-width: 0;
        ...
        #instagramshop-listing-toolbar .filter-select:focus {
            outline: none;
            border-color: #4361ee;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.15);
        }

        #instagramshop-listing-toolbar .toolbar-actions {
            display: flex;
            flex: 0 0 auto;
            align-items: center;
            margin-left: 0;
        ...
        #instagramshop-listing-toolbar .listing-io-btn {
            border-radius: 5px;
            font-weight: 600;
            font-size: 14px;
            width: 32px;
        ...
        #instagramshop-listing-toolbar .listing-io-btn::after {
            display: none;
        }

        #instagramshop-listing-toolbar .listing-io-menu {
            min-width: 42px;
            padding: 4px;
        }

        #instagramshop-listing-toolbar .listing-io-menu .dropdown-item {
            display: flex;
            align-items: center;
            justify-content: center;
            width: 34px;
        ...
        #instagramshop-listing-toolbar .listing-io-menu .dropdown-item:hover {
            background: #f1f5f9;
        }
        ...
        /* ========== DROPDOWNS ========== */
        #instagramshop-listing-wrap select.nr-req-dropdown,
        #instagramshop-listing-wrap select.listed-dropdown {
        ...
        #instagramshop-listing-wrap select.nr-req-dropdown:focus,
        #instagramshop-listing-wrap select.listed-dropdown:focus {
            outline: none;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.25);
        }

        #instagramshop-listing-wrap select.nr-req-dropdown[data-val="REQ"],
        #instagramshop-listing-wrap select.nr-req-dropdown option.req-option {
            background-color: #28a745;
            color: #fff;
        }

        #instagramshop-listing-wrap select.nr-req-dropdown[data-val="NR"],
        #instagramshop-listing-wrap select.nr-req-dropdown option.nr-option {
            background-color: #dc3545;
            color: #fff;
        }

        #instagramshop-listing-wrap select.listed-dropdown[data-val="Listed"],
        #instagramshop-listing-wrap select.listed-dropdown option.listed-option {
            background-color: #28a745;
            color: #fff;
        }

        #instagramshop-listing-wrap select.listed-dropdown[data-val="Pending"],
        #instagramshop-listing-wrap select.listed-dropdown option.pending-option {
            background-color: #dc3545;
            color: #fff;
        }
        ...
        /* ========== LINK CELL ========== */
        #instagramshop-listing-wrap a.listing-item-link {
            font-weight: 600;
            color: #0d6efd;
            text-decoration: none;
        }

        #instagramshop-listing-wrap a.listing-item-link:hover {
        ...
        /* ========== PLACEHOLDER ========== */
        #instagramshop-listing-wrap .tabulator-placeholder {
            color: #64748b;
            font-weight: 600;
            padding: 24px;
        }
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Listing Instagram Shop', 'sub_title' => 'Instagram Shop'])

    <div class="row">
        <div class="col-12">
            <div class="card position-relative">
                <div class="card-body">
                    <div id="instagramshop-listing-toolbar" class="mb-3">
                        <div class="instagramshop-listing-toolbar-row">
                    ...
                    <div id="instagramshop-listing-wrap">
                        <div id="instagramshopListing-table"></div>
                    </div>
...
@section('script')
    ...
    <script>
        ...
        let instagramshopListingTable = null;
        let allListingData = [];
        ...
        function calculateTotals() {
            try {
                if (!instagramshopListingTable) {
                    resetMetricsToZero();
                    return;
                }

                const rows = instagramshopListingTable.getData('active') || [];
                const metrics = {
                    invTotal: 0,
                    reqTotal: 0,
                    nrlTotal: 0,
        ...
        function applyListingFilters() {
            if (!instagramshopListingTable) return;
            ...
            instagramshopListingTable.setFilter(function (data) {
        ...
        $(document).ready(function () {
            ...
            instagramshopListingTable = new Tabulator('#instagramshopListing-table', {
                ajaxURL: '/listing_instagramshop/view-data',
            ...
            instagramshopListingTable.on('dataProcessed', function () {
                hideLoader();
                applyListingFilters();
            });
            instagramshopListingTable.on('dataFiltered', function () {
                calculateTotals();
            });
            instagramshopListingTable.on('dataLoadError', function () {
                hideLoader();
            ...
            $(document).on('click', '#confirmImportBtn', function () {
                ...
                showLoader();
                $.ajax({
                    url: "{{ route('listing_instagramshop.import') }}",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    ...
                    success: function (response) {
                        ...
                        instagramshopListingTable.setData('/listing_instagramshop/view-data');
                    },
                    error: function (xhr) {
                        hideLoader();
    ...
    <script>
        window.listingPageConfig = {
            wrap: '#instagramshop-listing-wrap',
            tableId: 'instagramshopListing-table',
            exportName: 'instagramshop_listing',
            channel: 'instagramshop',
            channelLabel: "Instagram Shop",
            previewUrl: '/listing_instagramshop/save-status',
            publishUrl: '/listing_instagramshop/save-status'
        };
    </script>
