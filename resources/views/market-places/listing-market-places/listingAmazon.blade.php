...
@section('script')
    ...
    <script>
        window.listingPageConfig = {
            wrap: '#amazon-listing-wrap',
            tableId: 'amazonListing-table',
            exportName: 'amazon_listing',
            channel: 'amazon',
            channelLabel: "Amazon",
            previewUrl: '/listing_amazon/save-status',
            publishUrl: '/listing_amazon/save-status'
        };
    </script>
