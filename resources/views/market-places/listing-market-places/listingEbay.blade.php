        ...
        <div class="col-12">
            <div class="card position-relative">
                <div class="card-body">
                    ...
                    @include('market-places.listing-market-places._listing_publish_modal', ['publishChannel' => 'ebay'])
...
@section('script')
    ...
    <script>
        window.listingPageConfig = {
            wrap: '#ebay-listing-wrap',
            tableId: 'ebayListing-table',
            exportName: 'ebay_listing',
            channel: 'ebay',
            channelLabel: "eBay",
            previewUrl: '/listing_ebay/save-status',
            publishUrl: '/listing_ebay/save-status'
        };
    </script>
