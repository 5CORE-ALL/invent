@extends('layouts.vertical', ['title' => 'Listing Newegg B2C', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('css')
    ...
    <style>
        /* ========== TABLE SHELL ========== */
        #neweggb2c-listing-wrap {
            overflow-x: auto;
            overflow-y: visible;
            width: 100%;
        }

        #neweggb2c-listing-wrap .tabulator {
        ...
        .card-body:has(#neweggb2c-listing-toolbar) {
            width: 100%;
        }

        #neweggb2c-listing-wrap .tabulator .tabulator-tableholder {
            background: #fff;
        }

        /* ========== HEADER ========== */
        #neweggb2c-listing-wrap .tabulator .tabulator-header {
            background: #00d5d5;
            border-bottom: 1px solid #ffffff;
        }

        #neweggb2c-listing-wrap .tabulator-col .tabulator-col-sorter {
            display: none !important;
        }

        #neweggb2c-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-content-holder,
        #neweggb2c-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-title-holder {
        ...
        #neweggb2c-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-title {
            writing-mode: horizontal-tb !important;
            text-orientation: mixed !important;
            transform: none !important;
            white-space: normal !important;
        ...
        #neweggb2c-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content {
            height: auto !important;
            min-height: 34px;
            padding: 0;
        }

        #neweggb2c-listing-wrap .tabulator .tabulator-header .tabulator-col {
            height: auto !important;
            min-height: 34px;
        ...
        #neweggb2c-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content-holder {
            padding-left: 2px !important;
            padding-right: 2px !important;
        }

        /* Header filters */
        #neweggb2c-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input {
            width: 100%;
        ...
        #neweggb2c-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input:focus {
            outline: none;
            border-color: #4361ee;
        ...
        /* ========== ROWS / CELLS ========== */
        #neweggb2c-listing-wrap .tabulator .tabulator-row {
            min-height: 36px;
            border-bottom: 1px solid #f1f5f9;
        }

        #neweggb2c-listing-wrap .tabulator .tabulator-row .tabulator-cell {
            padding: 5px 6px !important;
            border-right: 1px solid #f1f5f9;
            vertical-align: middle;
        }

        #neweggb2c-listing-wrap .tabulator-row .tabulator-cell input[type="checkbox"],
        #neweggb2c-listing-wrap .tabulator-header .tabulator-col input[type="checkbox"] {
            width: 16px;
            height: 16px;
            cursor: pointer;
            accent-color: #4361ee;
        ...
        #neweggb2c-listing-wrap .tabulator-row.parent-row .tabulator-cell input[type="checkbox"] {
            display: none;
        }

        #neweggb2c-listing-wrap .tabulator .tabulator-row:hover {
            background-color: #f8fafc !important;
        }

        #neweggb2c-listing-wrap .tabulator .tabulator-row.tabulator-row-even {
            background-color: #fcfcfd;
        }

        #neweggb2c-listing-wrap .tabulator-row.parent-row,
        #neweggb2c-listing-wrap .tabulator-row.parent-row .tabulator-cell {
            background-color: #fffef2 !important;
            font-weight: 700 !important;
            color: #0f172a;
        }

        #neweggb2c-listing-wrap .tabulator-row.parent-row:hover,
        #neweggb2c-listing-wrap .tabulator-row.parent-row:hover .tabulator-cell {
            background-color: #fefce8 !important;
        }

        /* ========== FOOTER / PAGINATION ========== */
        #neweggb2c-listing-wrap .tabulator .tabulator-footer {
            background: #f8fafc !important;
            border-top: 1px solid #e2e8f0 !important;
            padding: 10px 16px !important;
        }

        #neweggb2c-listing-wrap .tabulator .tabulator-footer .tabulator-paginator {
            display: flex;
            align-items: center;
        ...
        #neweggb2c-listing-wrap .tabulator .tabulator-footer .tabulator-paginator label {
            margin-right: 6px;
            font-size: 12px;
            color: #475569;
            font-weight: 600;
        ...
        #neweggb2c-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page-size {
        ...
        #neweggb2c-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page {
        ...
        #neweggb2c-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page:hover {
            background: #f1f5f9 !important;
            border-color: #cbd5e1 !important;
            color: #1e293b !important;
        }

        #neweggb2c-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page.active {
        ...
        #neweggb2c-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page[disabled] {
            opacity: 0.4 !important;
            cursor: not-allowed !important;
        }

        #neweggb2c-listing-wrap .tabulator .tabulator-footer .tabulator-page-counter {
            margin: 0 0.5rem;
            font-size: 12px;
            color: #334155;
        }
        ...
        #neweggb2c-listing-toolbar .neweggb2c-listing-toolbar-row {
            display: flex;
            flex-wrap: nowrap;
            align-items: center;
        ...
        #neweggb2c-listing-toolbar .listing-stat-badges {
            display: inline-flex;
            flex: 0 0 auto;
            align-items: stretch;
            gap: 0;
        ...
        #neweggb2c-listing-toolbar .listing-stat-badge {
            flex: 0 0 auto;
            justify-content: center;
            margin: 0 !important;
            border-radius: 0;
        ...
        #neweggb2c-listing-toolbar .listing-stat-badges .listing-stat-badge:first-child {
            border-radius: 8px 0 0 8px;
        }

        #neweggb2c-listing-toolbar .listing-stat-badges .listing-stat-badge:last-child {
            border-radius: 0 8px 8px 0;
        }

        #neweggb2c-listing-toolbar .filter-select {
            flex: 0 0 auto;
            min-width: 0;
        ...
        #neweggb2c-listing-toolbar .filter-select:focus {
            outline: none;
            border-color: #4361ee;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.15);
        }

        #neweggb2c-listing-toolbar .toolbar-actions {
            display: flex;
            flex: 0 0 auto;
            align-items: center;
            margin-left: 0;
        ...
        #neweggb2c-listing-toolbar .listing-io-btn {
            border-radius: 5px;
            font-weight: 600;
            font-size: 14px;
            width: 32px;
        ...
        #neweggb2c-listing-toolbar .listing-io-btn::after {
            display: none;
        }

        #neweggb2c-listing-toolbar .listing-io-menu {
            min-width: 42px;
            padding: 4px;
        }

        #neweggb2c-listing-toolbar .listing-io-menu .dropdown-item {
            display: flex;
            align-items: center;
            justify-content: center;
            width: 34px;
        ...
        #neweggb2c-listing-toolbar .listing-io-menu .dropdown-item:hover {
            background: #f1f5f9;
        }
        ...
        /* ========== DROPDOWNS ========== */
        #neweggb2c-listing-wrap select.nr-req-dropdown,
        #neweggb2c-listing-wrap select.listed-dropdown {
        ...
        #neweggb2c-listing-wrap select.nr-req-dropdown:focus,
        #neweggb2c-listing-wrap select.listed-dropdown:focus {
            outline: none;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.25);
        }

        #neweggb2c-listing-wrap select.nr-req-dropdown[data-val="REQ"],
        #neweggb2c-listing-wrap select.nr-req-dropdown option.req-option {
            background-color: #28a745;
            color: #fff;
        }

        #neweggb2c-listing-wrap select.nr-req-dropdown[data-val="NR"],
        #neweggb2c-listing-wrap select.nr-req-dropdown option.nr-option {
            background-color: #dc3545;
            color: #fff;
        }

        #neweggb2c-listing-wrap select.listed-dropdown[data-val="Listed"],
        #neweggb2c-listing-wrap select.listed-dropdown option.listed-option {
            background-color: #28a745;
            color: #fff;
        }

        #neweggb2c-listing-wrap select.listed-dropdown[data-val="Pending"],
        #neweggb2c-listing-wrap select.listed-dropdown option.pending-option {
            background-color: #dc3545;
            color: #fff;
        }
        ...
        /* ========== LINK CELL ========== */
        #neweggb2c-listing-wrap a.listing-item-link {
            font-weight: 600;
            color: #0d6efd;
            text-decoration: none;
        }

        #neweggb2c-listing-wrap a.listing-item-link:hover {
        ...
        /* ========== PLACEHOLDER ========== */
        #neweggb2c-listing-wrap .tabulator-placeholder {
            color: #64748b;
            font-weight: 600;
            padding: 24px;
        }
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Listing Newegg B2C', 'sub_title' => 'Newegg B2C'])

    <div class="row">
        <div class="col-12">
            <div class="card position-relative">
                <div class="card-body">
                    <div id="neweggb2c-listing-toolbar" class="mb-3">
                        <div class="neweggb2c-listing-toolbar-row">
                            ...
                            <div class="toolbar-actions dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end listing-io-menu" aria-labelledby="listing-io-btn">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('listing_neweggb2c.export') }}" title="Export">
                    ...
                    <div id="neweggb2c-listing-wrap">
                        <div id="neweggb2cListing-table"></div>
                    </div>
...
@section('script')
    ...
    <script>
        ...
        let neweggb2cListingTable = null;
        let allListingData = [];
        ...
        function applyListingFilters() {
            if (!neweggb2cListingTable) return;
            ...
            neweggb2cListingTable.setFilter(function (data) {
        ...
        $(document).ready(function () {
            ...
            neweggb2cListingTable.on('dataLoadError', function () {
                hideLoader();
            ...
            $(document).on('click', '#confirmImportBtn', function () {
                ...
                showLoader();
                $.ajax({
                    url: "{{ route('listing_neweggb2c.import') }}",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    ...
                    success: function (response) {
                        ...
                        neweggb2cListingTable.setData('/listing_neweggb2c/view-data');
                    },
                    error: function (xhr) {
                        hideLoader();
