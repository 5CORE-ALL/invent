@extends('layouts.vertical', ['title' => 'Listing FB Marketplace', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('css')
    ...
    <style>
        /* ========== TABLE SHELL ========== */
        #fbmarketplace-listing-wrap {
            overflow-x: auto;
            overflow-y: visible;
            width: 100%;
        }

        #fbmarketplace-listing-wrap .tabulator {
        ...
        .card-body:has(#fbmarketplace-listing-toolbar) {
            width: 100%;
        }

        #fbmarketplace-listing-wrap .tabulator .tabulator-tableholder {
            background: #fff;
        }

        /* ========== HEADER ========== */
        #fbmarketplace-listing-wrap .tabulator .tabulator-header {
            background: #00d5d5;
            border-bottom: 1px solid #ffffff;
        }

        #fbmarketplace-listing-wrap .tabulator-col .tabulator-col-sorter {
            display: none !important;
        }

        #fbmarketplace-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-content-holder,
        #fbmarketplace-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-title-holder {
        ...
        #fbmarketplace-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-title {
            writing-mode: horizontal-tb !important;
            text-orientation: mixed !important;
            transform: none !important;
            white-space: normal !important;
        ...
        #fbmarketplace-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content {
            height: auto !important;
            min-height: 34px;
            padding: 0;
        }

        #fbmarketplace-listing-wrap .tabulator .tabulator-header .tabulator-col {
            height: auto !important;
            min-height: 34px;
        ...
        #fbmarketplace-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content-holder {
            padding-left: 2px !important;
            padding-right: 2px !important;
        }

        /* Header filters */
        #fbmarketplace-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input {
            width: 100%;
        ...
        #fbmarketplace-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input:focus {
            outline: none;
            border-color: #4361ee;
        ...
        /* ========== ROWS / CELLS ========== */
        #fbmarketplace-listing-wrap .tabulator .tabulator-row {
            min-height: 36px;
            border-bottom: 1px solid #f1f5f9;
        }

        #fbmarketplace-listing-wrap .tabulator .tabulator-row .tabulator-cell {
            padding: 5px 6px !important;
            border-right: 1px solid #f1f5f9;
            vertical-align: middle;
        }

        #fbmarketplace-listing-wrap .tabulator-row .tabulator-cell input[type="checkbox"],
        #fbmarketplace-listing-wrap .tabulator-header .tabulator-col input[type="checkbox"] {
            width: 16px;
            height: 16px;
            cursor: pointer;
            accent-color: #4361ee;
        ...
        #fbmarketplace-listing-wrap .tabulator-row.parent-row .tabulator-cell input[type="checkbox"] {
            display: none;
        }

        #fbmarketplace-listing-wrap .tabulator .tabulator-row:hover {
            background-color: #f8fafc !important;
        }

        #fbmarketplace-listing-wrap .tabulator .tabulator-row.tabulator-row-even {
            background-color: #fcfcfd;
        }

        #fbmarketplace-listing-wrap .tabulator-row.parent-row,
        #fbmarketplace-listing-wrap .tabulator-row.parent-row .tabulator-cell {
            background-color: #fffef2 !important;
            font-weight: 700 !important;
            color: #0f172a;
        }

        #fbmarketplace-listing-wrap .tabulator-row.parent-row:hover,
        #fbmarketplace-listing-wrap .tabulator-row.parent-row:hover .tabulator-cell {
            background-color: #fefce8 !important;
        }

        /* ========== FOOTER / PAGINATION ========== */
        #fbmarketplace-listing-wrap .tabulator .tabulator-footer {
            background: #f8fafc !important;
            border-top: 1px solid #e2e8f0 !important;
            padding: 10px 16px !important;
        }

        #fbmarketplace-listing-wrap .tabulator .tabulator-footer .tabulator-paginator {
            display: flex;
            align-items: center;
        ...
        #fbmarketplace-listing-wrap .tabulator .tabulator-footer .tabulator-paginator label {
            margin-right: 6px;
            font-size: 12px;
            color: #475569;
            font-weight: 600;
        ...
        #fbmarketplace-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page-size {
        ...
        #fbmarketplace-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page {
        ...
        #fbmarketplace-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page:hover {
            background: #f1f5f9 !important;
            border-color: #cbd5e1 !important;
            color: #1e293b !important;
        }

        #fbmarketplace-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page.active {
        ...
        #fbmarketplace-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page[disabled] {
            opacity: 0.4 !important;
            cursor: not-allowed !important;
        }

        #fbmarketplace-listing-wrap .tabulator .tabulator-footer .tabulator-page-counter {
            margin: 0 0.5rem;
            font-size: 12px;
            color: #334155;
        }
        ...
        #fbmarketplace-listing-toolbar .fbmarketplace-listing-toolbar-row {
            display: flex;
            flex-wrap: nowrap;
            align-items: center;
        ...
        #fbmarketplace-listing-toolbar .listing-stat-badges {
            display: inline-flex;
            flex: 0 0 auto;
            align-items: stretch;
            gap: 0;
        ...
        #fbmarketplace-listing-toolbar .listing-stat-badge {
            flex: 0 0 auto;
            justify-content: center;
            margin: 0 !important;
            border-radius: 0;
        ...
        #fbmarketplace-listing-toolbar .listing-stat-badges .listing-stat-badge:first-child {
            border-radius: 8px 0 0 8px;
        }

        #fbmarketplace-listing-toolbar .listing-stat-badges .listing-stat-badge:last-child {
            border-radius: 0 8px 8px 0;
        }

        #fbmarketplace-listing-toolbar .filter-select {
            flex: 0 0 auto;
            min-width: 0;
        ...
        #fbmarketplace-listing-toolbar .filter-select:focus {
            outline: none;
            border-color: #4361ee;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.15);
        }

        #fbmarketplace-listing-toolbar .toolbar-actions {
            display: flex;
            flex: 0 0 auto;
            align-items: center;
            margin-left: 0;
        ...
        #fbmarketplace-listing-toolbar .listing-io-btn {
            border-radius: 5px;
            font-weight: 600;
            font-size: 14px;
            width: 32px;
        ...
        #fbmarketplace-listing-toolbar .listing-io-btn::after {
            display: none;
        }

        #fbmarketplace-listing-toolbar .listing-io-menu {
            min-width: 42px;
            padding: 4px;
        }

        #fbmarketplace-listing-toolbar .listing-io-menu .dropdown-item {
            display: flex;
            align-items: center;
            justify-content: center;
            width: 34px;
        ...
        #fbmarketplace-listing-toolbar .listing-io-menu .dropdown-item:hover {
            background: #f1f5f9;
        }
        ...
        /* ========== DROPDOWNS ========== */
        #fbmarketplace-listing-wrap select.nr-req-dropdown,
        #fbmarketplace-listing-wrap select.listed-dropdown {
        ...
        #fbmarketplace-listing-wrap select.nr-req-dropdown:focus,
        #fbmarketplace-listing-wrap select.listed-dropdown:focus {
            outline: none;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.25);
        }

        #fbmarketplace-listing-wrap select.nr-req-dropdown[data-val="REQ"],
        #fbmarketplace-listing-wrap select.nr-req-dropdown option.req-option {
            background-color: #28a745;
            color: #fff;
        }

        #fbmarketplace-listing-wrap select.nr-req-dropdown[data-val="NR"],
        #fbmarketplace-listing-wrap select.nr-req-dropdown option.nr-option {
            background-color: #dc3545;
            color: #fff;
        }

        #fbmarketplace-listing-wrap select.listed-dropdown[data-val="Listed"],
        #fbmarketplace-listing-wrap select.listed-dropdown option.listed-option {
            background-color: #28a745;
            color: #fff;
        }

        #fbmarketplace-listing-wrap select.listed-dropdown[data-val="Pending"],
        #fbmarketplace-listing-wrap select.listed-dropdown option.pending-option {
            background-color: #dc3545;
            color: #fff;
        }
        ...
        /* ========== LINK CELL ========== */
        #fbmarketplace-listing-wrap a.listing-item-link {
            font-weight: 600;
            color: #0d6efd;
            text-decoration: none;
        }

        #fbmarketplace-listing-wrap a.listing-item-link:hover {
        ...
        /* ========== PLACEHOLDER ========== */
        #fbmarketplace-listing-wrap .tabulator-placeholder {
            color: #64748b;
            font-weight: 600;
            padding: 24px;
        }
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Listing FB Marketplace', 'sub_title' => 'FB Marketplace'])

    <div class="row">
        <div class="col-12">
            <div class="card position-relative">
                <div class="card-body">
                    <div id="fbmarketplace-listing-toolbar" class="mb-3">
                        <div class="fbmarketplace-listing-toolbar-row">
                    ...
                    <div id="fbmarketplace-listing-wrap">
                        <div id="fbmarketplaceListing-table"></div>
                    </div>
...
@section('script')
    ...
    <script>
        ...
        let fbmarketplaceListingTable = null;
        let allListingData = [];
        ...
        function calculateTotals() {
            try {
                if (!fbmarketplaceListingTable) {
                    resetMetricsToZero();
                    return;
                }

                const rows = fbmarketplaceListingTable.getData('active') || [];
                const metrics = {
                    invTotal: 0,
                    reqTotal: 0,
                    nrlTotal: 0,
        ...
        function applyListingFilters() {
            if (!fbmarketplaceListingTable) return;
            ...
            fbmarketplaceListingTable.setFilter(function (data) {
        ...
        $(document).ready(function () {
            ...
            fbmarketplaceListingTable = new Tabulator('#fbmarketplaceListing-table', {
                ajaxURL: '/listing_fbmarketplace/view-data',
            ...
            fbmarketplaceListingTable.on('dataProcessed', function () {
                hideLoader();
                applyListingFilters();
            });
            fbmarketplaceListingTable.on('dataFiltered', function () {
                calculateTotals();
            });
            fbmarketplaceListingTable.on('dataLoadError', function () {
                hideLoader();
            ...
            $(document).on('click', '#confirmImportBtn', function () {
                ...
                showLoader();
                $.ajax({
                    url: "{{ route('listing_fbmarketplace.import') }}",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    ...
                    success: function (response) {
                        ...
                        fbmarketplaceListingTable.setData('/listing_fbmarketplace/view-data');
                    },
                    error: function (xhr) {
                        hideLoader();
    ...
    <script>
        window.listingPageConfig = {
            wrap: '#fbmarketplace-listing-wrap',
            tableId: 'fbmarketplaceListing-table',
            exportName: 'fbmarketplace_listing',
            channel: 'fbmarketplace',
            channelLabel: "FB Marketplace",
            previewUrl: '/listing_fbmarketplace/save-status',
            publishUrl: '/listing_fbmarketplace/save-status'
        };
    </script>
