@extends('layouts.vertical', ['title' => 'Listing Syncee', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('css')
    ...
    <style>
        ...
        .card-body:has(#syncee-listing-toolbar) {
            width: 100%;
        }

        #syncee-listing-wrap .tabulator .tabulator-tableholder {
            background: #fff;
        }

        /* ========== HEADER ========== */
        #syncee-listing-wrap .tabulator .tabulator-header {
            background: #00d5d5;
            border-bottom: 1px solid #ffffff;
        }

        #syncee-listing-wrap .tabulator-col .tabulator-col-sorter {
            display: none !important;
        }

        #syncee-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-content-holder,
        #syncee-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-title-holder {
        ...
        #syncee-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-title {
            writing-mode: horizontal-tb !important;
            text-orientation: mixed !important;
            transform: none !important;
            white-space: normal !important;
        ...
        #syncee-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content {
            height: auto !important;
            min-height: 34px;
            padding: 0;
        }

        #syncee-listing-wrap .tabulator .tabulator-header .tabulator-col {
            height: auto !important;
            min-height: 34px;
        ...
        #syncee-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content-holder {
            padding-left: 2px !important;
            padding-right: 2px !important;
        }

        /* Header filters */
        #syncee-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input {
            width: 100%;
        ...
        #syncee-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input:focus {
            outline: none;
            border-color: #4361ee;
        ...
        /* ========== ROWS / CELLS ========== */
        #syncee-listing-wrap .tabulator .tabulator-row {
            min-height: 36px;
            border-bottom: 1px solid #f1f5f9;
        }

        #syncee-listing-wrap .tabulator .tabulator-row .tabulator-cell {
            padding: 5px 6px !important;
            border-right: 1px solid #f1f5f9;
            vertical-align: middle;
        }

        #syncee-listing-wrap .tabulator-row .tabulator-cell input[type="checkbox"],
        #syncee-listing-wrap .tabulator-header .tabulator-col input[type="checkbox"] {
            width: 16px;
            height: 16px;
            cursor: pointer;
            accent-color: #4361ee;
        ...
        #syncee-listing-wrap .tabulator-row.parent-row .tabulator-cell input[type="checkbox"] {
            display: none;
        }

        #syncee-listing-wrap .tabulator .tabulator-row:hover {
            background-color: #f8fafc !important;
        }

        #syncee-listing-wrap .tabulator .tabulator-row.tabulator-row-even {
            background-color: #fcfcfd;
        }

        #syncee-listing-wrap .tabulator-row.parent-row,
        #syncee-listing-wrap .tabulator-row.parent-row .tabulator-cell {
            background-color: #fffef2 !important;
            font-weight: 700 !important;
            color: #0f172a;
        }

        #syncee-listing-wrap .tabulator-row.parent-row:hover,
        #syncee-listing-wrap .tabulator-row.parent-row:hover .tabulator-cell {
            background-color: #fefce8 !important;
        }

        /* ========== FOOTER / PAGINATION ========== */
        #syncee-listing-wrap .tabulator .tabulator-footer {
            background: #f8fafc !important;
            border-top: 1px solid #e2e8f0 !important;
            padding: 10px 16px !important;
        }

        #syncee-listing-wrap .tabulator .tabulator-footer .tabulator-paginator {
            display: flex;
            align-items: center;
        ...
        #syncee-listing-wrap .tabulator .tabulator-footer .tabulator-paginator label {
            margin-right: 6px;
            font-size: 12px;
            color: #475569;
            font-weight: 600;
        ...
        #syncee-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page-size {
        ...
        #syncee-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page {
        ...
        #syncee-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page:hover {
            background: #f1f5f9 !important;
            border-color: #cbd5e1 !important;
            color: #1e293b !important;
        }

        #syncee-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page.active {
        ...
        #syncee-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page[disabled] {
            opacity: 0.4 !important;
            cursor: not-allowed !important;
        }

        #syncee-listing-wrap .tabulator .tabulator-footer .tabulator-page-counter {
            margin: 0 0.5rem;
            font-size: 12px;
            color: #334155;
        }
        ...
        #syncee-listing-toolbar .syncee-listing-toolbar-row {
            display: flex;
            flex-wrap: nowrap;
            align-items: center;
        ...
        #syncee-listing-toolbar .listing-stat-badges {
            display: inline-flex;
            flex: 0 0 auto;
            align-items: stretch;
            gap: 0;
        ...
        #syncee-listing-toolbar .listing-stat-badge {
            flex: 0 0 auto;
            justify-content: center;
            margin: 0 !important;
            border-radius: 0;
        ...
        #syncee-listing-toolbar .listing-stat-badges .listing-stat-badge:first-child {
            border-radius: 8px 0 0 8px;
        }

        #syncee-listing-toolbar .listing-stat-badges .listing-stat-badge:last-child {
            border-radius: 0 8px 8px 0;
        }

        #syncee-listing-toolbar .filter-select {
            flex: 0 0 auto;
            min-width: 0;
        ...
        #syncee-listing-toolbar .filter-select:focus {
            outline: none;
            border-color: #4361ee;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.15);
        }

        #syncee-listing-toolbar .toolbar-actions {
            display: flex;
            flex: 0 0 auto;
            align-items: center;
            margin-left: 0;
        ...
        #syncee-listing-toolbar .listing-io-btn {
            border-radius: 5px;
            font-weight: 600;
            font-size: 14px;
            width: 32px;
        ...
        #syncee-listing-toolbar .listing-io-btn::after {
            display: none;
        }

        #syncee-listing-toolbar .listing-io-menu {
            min-width: 42px;
            padding: 4px;
        }

        #syncee-listing-toolbar .listing-io-menu .dropdown-item {
            display: flex;
            align-items: center;
            justify-content: center;
            width: 34px;
        ...
        #syncee-listing-toolbar .listing-io-menu .dropdown-item:hover {
            background: #f1f5f9;
        }
        ...
        /* ========== DROPDOWNS ========== */
        #syncee-listing-wrap select.nr-req-dropdown,
        #syncee-listing-wrap select.listed-dropdown {
        ...
        #syncee-listing-wrap select.nr-req-dropdown:focus,
        #syncee-listing-wrap select.listed-dropdown:focus {
            outline: none;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.25);
        }

        #syncee-listing-wrap select.nr-req-dropdown[data-val="REQ"],
        #syncee-listing-wrap select.nr-req-dropdown option.req-option {
            background-color: #28a745;
            color: #fff;
        }

        #syncee-listing-wrap select.nr-req-dropdown[data-val="NR"],
        #syncee-listing-wrap select.nr-req-dropdown option.nr-option {
            background-color: #dc3545;
            color: #fff;
        }

        #syncee-listing-wrap select.listed-dropdown[data-val="Listed"],
        #syncee-listing-wrap select.listed-dropdown option.listed-option {
            background-color: #28a745;
            color: #fff;
        }

        #syncee-listing-wrap select.listed-dropdown[data-val="Pending"],
        #syncee-listing-wrap select.listed-dropdown option.pending-option {
            background-color: #dc3545;
            color: #fff;
        }
        ...
        /* ========== LINK CELL ========== */
        #syncee-listing-wrap a.listing-item-link {
            font-weight: 600;
            color: #0d6efd;
            text-decoration: none;
        }

        #syncee-listing-wrap a.listing-item-link:hover {
        ...
        /* ========== PLACEHOLDER ========== */
        #syncee-listing-wrap .tabulator-placeholder {
            color: #64748b;
            font-weight: 600;
            padding: 24px;
        }
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Listing Syncee', 'sub_title' => 'Syncee'])

    <div class="row">
        <div class="col-12">
            <div class="card position-relative">
                <div class="card-body">
                    <div id="syncee-listing-toolbar" class="mb-3">
                        <div class="syncee-listing-toolbar-row">
                    ...
                    <div id="syncee-listing-wrap">
                        <div id="synceeListing-table"></div>
                    </div>
...
@section('script')
    ...
    <script>
        ...
        function calculateTotals() {
            try {
                if (!synceeListingTable) {
                    resetMetricsToZero();
                    return;
                }

                const rows = synceeListingTable.getData('active') || [];
                const metrics = {
                    invTotal: 0,
                    reqTotal: 0,
                    nrlTotal: 0,
        ...
        function applyListingFilters() {
            ...
            synceeListingTable.setFilter(function (data) {
        ...
        $(document).ready(function () {
            ...
            synceeListingTable = new Tabulator('#synceeListing-table', {
                ajaxURL: '/listing_syncee/view-data',
            ...
            synceeListingTable.on('dataProcessed', function () {
                hideLoader();
                applyListingFilters();
            });
            synceeListingTable.on('dataFiltered', function () {
                calculateTotals();
            });
            synceeListingTable.on('dataLoadError', function () {
                hideLoader();
            ...
            $(document).on('click', '#confirmImportBtn', function () {
                ...
                showLoader();
                $.ajax({
                    url: "{{ route('listing_syncee.import') }}",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    ...
                    success: function (response) {
                        ...
                        synceeListingTable.setData('/listing_syncee/view-data');
                    },
                    error: function (xhr) {
                        hideLoader();
    ...
    <script>
        window.listingPageConfig = {
            wrap: '#syncee-listing-wrap',
            tableId: 'synceeListing-table',
            exportName: 'syncee_listing',
            channel: 'syncee',
            channelLabel: "Syncee",
            previewUrl: '/listing_syncee/save-status',
            publishUrl: '/listing_syncee/save-status'
        };
    </script>
