...
@section('css')
    ...
    <style>
        /* ========== TABLE SHELL ========== */
        #ebayvariation-listing-wrap {
            overflow-x: auto;
            overflow-y: visible;
            width: 100%;
        }

        #ebayvariation-listing-wrap .tabulator {
        ...
        .card-body:has(#ebayvariation-listing-toolbar) {
            width: 100%;
        }

        #ebayvariation-listing-wrap .tabulator .tabulator-tableholder {
            background: #fff;
        }

        /* ========== HEADER ========== */
        #ebayvariation-listing-wrap .tabulator .tabulator-header {
            background: #00d5d5;
            border-bottom: 1px solid #ffffff;
        }

        #ebayvariation-listing-wrap .tabulator-col .tabulator-col-sorter {
            display: none !important;
        }

        #ebayvariation-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-content-holder,
        #ebayvariation-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-title-holder {
        ...
        #ebayvariation-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-title {
            writing-mode: horizontal-tb !important;
            text-orientation: mixed !important;
            transform: none !important;
            white-space: normal !important;
        ...
        #ebayvariation-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content {
            height: auto !important;
            min-height: 34px;
            padding: 0;
        }

        #ebayvariation-listing-wrap .tabulator .tabulator-header .tabulator-col {
            height: auto !important;
            min-height: 34px;
        ...
        #ebayvariation-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content-holder {
            padding-left: 2px !important;
            padding-right: 2px !important;
        }

        /* Header filters */
        #ebayvariation-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input {
            width: 100%;
        ...
        #ebayvariation-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input:focus {
            outline: none;
            border-color: #4361ee;
        ...
        /* ========== ROWS / CELLS ========== */
        #ebayvariation-listing-wrap .tabulator .tabulator-row {
            min-height: 36px;
            border-bottom: 1px solid #f1f5f9;
        }

        #ebayvariation-listing-wrap .tabulator .tabulator-row .tabulator-cell {
            padding: 5px 6px !important;
            border-right: 1px solid #f1f5f9;
            vertical-align: middle;
        }

        #ebayvariation-listing-wrap .tabulator-row .tabulator-cell input[type="checkbox"],
        #ebayvariation-listing-wrap .tabulator-header .tabulator-col input[type="checkbox"] {
            width: 16px;
            height: 16px;
            cursor: pointer;
            accent-color: #4361ee;
        ...
        #ebayvariation-listing-wrap .tabulator-row.parent-row .tabulator-cell input[type="checkbox"] {
            display: none;
        }

        #ebayvariation-listing-wrap .tabulator .tabulator-row:hover {
            background-color: #f8fafc !important;
        }

        #ebayvariation-listing-wrap .tabulator .tabulator-row.tabulator-row-even {
            background-color: #fcfcfd;
        }

        #ebayvariation-listing-wrap .tabulator-row.parent-row,
        #ebayvariation-listing-wrap .tabulator-row.parent-row .tabulator-cell {
            background-color: #fffef2 !important;
            font-weight: 700 !important;
            color: #0f172a;
        }

        #ebayvariation-listing-wrap .tabulator-row.parent-row:hover,
        #ebayvariation-listing-wrap .tabulator-row.parent-row:hover .tabulator-cell {
            background-color: #fefce8 !important;
        }

        /* ========== FOOTER / PAGINATION ========== */
        #ebayvariation-listing-wrap .tabulator .tabulator-footer {
            background: #f8fafc !important;
            border-top: 1px solid #e2e8f0 !important;
            padding: 10px 16px !important;
        }

        #ebayvariation-listing-wrap .tabulator .tabulator-footer .tabulator-paginator {
            display: flex;
            align-items: center;
        ...
        #ebayvariation-listing-wrap .tabulator .tabulator-footer .tabulator-paginator label {
            margin-right: 6px;
            font-size: 12px;
            color: #475569;
            font-weight: 600;
        ...
        #ebayvariation-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page-size {
        ...
        #ebayvariation-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page {
        ...
        #ebayvariation-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page:hover {
            background: #f1f5f9 !important;
            border-color: #cbd5e1 !important;
            color: #1e293b !important;
        }

        #ebayvariation-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page.active {
        ...
        #ebayvariation-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page[disabled] {
            opacity: 0.4 !important;
            cursor: not-allowed !important;
        }

        #ebayvariation-listing-wrap .tabulator .tabulator-footer .tabulator-page-counter {
            margin: 0 0.5rem;
            font-size: 12px;
            color: #334155;
        }
        ...
        #ebayvariation-listing-toolbar .ebayvariation-listing-toolbar-row {
            display: flex;
            flex-wrap: nowrap;
            align-items: center;
        ...
        #ebayvariation-listing-toolbar .listing-stat-badges {
            display: inline-flex;
            flex: 0 0 auto;
            align-items: stretch;
            gap: 0;
        ...
        #ebayvariation-listing-toolbar .listing-stat-badge {
            flex: 0 0 auto;
            justify-content: center;
            margin: 0 !important;
            border-radius: 0;
        ...
        #ebayvariation-listing-toolbar .listing-stat-badges .listing-stat-badge:first-child {
            border-radius: 8px 0 0 8px;
        }

        #ebayvariation-listing-toolbar .listing-stat-badges .listing-stat-badge:last-child {
            border-radius: 0 8px 8px 0;
        }

        #ebayvariation-listing-toolbar .filter-select {
            flex: 0 0 auto;
            min-width: 0;
        ...
        #ebayvariation-listing-toolbar .filter-select:focus {
            outline: none;
            border-color: #4361ee;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.15);
        }

        #ebayvariation-listing-toolbar .toolbar-actions {
            display: flex;
            flex: 0 0 auto;
            align-items: center;
            margin-left: 0;
        ...
        #ebayvariation-listing-toolbar .listing-io-btn {
            border-radius: 5px;
            font-weight: 600;
            font-size: 14px;
            width: 32px;
        ...
        #ebayvariation-listing-toolbar .listing-io-btn::after {
            display: none;
        }

        #ebayvariation-listing-toolbar .listing-io-menu {
            min-width: 42px;
            padding: 4px;
        }

        #ebayvariation-listing-toolbar .listing-io-menu .dropdown-item {
            display: flex;
            align-items: center;
            justify-content: center;
            width: 34px;
        ...
        #ebayvariation-listing-toolbar .listing-io-menu .dropdown-item:hover {
            background: #f1f5f9;
        }
        ...
        /* ========== DROPDOWNS ========== */
        #ebayvariation-listing-wrap select.nr-req-dropdown,
        #ebayvariation-listing-wrap select.listed-dropdown {
        ...
        #ebayvariation-listing-wrap select.nr-req-dropdown:focus,
        #ebayvariation-listing-wrap select.listed-dropdown:focus {
            outline: none;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.25);
        }

        #ebayvariation-listing-wrap select.nr-req-dropdown[data-val="REQ"],
        #ebayvariation-listing-wrap select.nr-req-dropdown option.req-option {
            background-color: #28a745;
            color: #fff;
        }

        #ebayvariation-listing-wrap select.nr-req-dropdown[data-val="NR"],
        #ebayvariation-listing-wrap select.nr-req-dropdown option.nr-option {
            background-color: #dc3545;
            color: #fff;
        }

        #ebayvariation-listing-wrap select.listed-dropdown[data-val="Listed"],
        #ebayvariation-listing-wrap select.listed-dropdown option.listed-option {
            background-color: #28a745;
            color: #fff;
        }

        #ebayvariation-listing-wrap select.listed-dropdown[data-val="Pending"],
        #ebayvariation-listing-wrap select.listed-dropdown option.pending-option {
            background-color: #dc3545;
            color: #fff;
        }
        ...
        /* ========== LINK CELL ========== */
        #ebayvariation-listing-wrap a.listing-item-link {
            font-weight: 600;
            color: #0d6efd;
            text-decoration: none;
        }

        #ebayvariation-listing-wrap a.listing-item-link:hover {
        ...
        /* ========== PLACEHOLDER ========== */
        #ebayvariation-listing-wrap .tabulator-placeholder {
            color: #64748b;
            font-weight: 600;
            padding: 24px;
        }
    ...
    <div class="row">
        <div class="col-12">
            <div class="card position-relative">
                <div class="card-body">
                    <div id="ebayvariation-listing-toolbar" class="mb-3">
                        <div class="ebayvariation-listing-toolbar-row">
                            ...
                            <div class="toolbar-actions dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end listing-io-menu" aria-labelledby="listing-io-btn">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('listing_ebayvariation.export') }}" title="Export">
                    ...
                    <div id="ebayvariation-listing-wrap">
                        <div id="ebayvariationListing-table"></div>
                    </div>
...
@section('script')
    ...
    <script>
        ...
        let ebayvariationListingTable = null;
        let allListingData = [];
        ...
        function calculateTotals() {
            try {
                if (!ebayvariationListingTable) {
                    resetMetricsToZero();
                    return;
                }

                const rows = ebayvariationListingTable.getData('active') || [];
                const metrics = {
                    invTotal: 0,
                    reqTotal: 0,
                    nrlTotal: 0,
        ...
        function applyListingFilters() {
            if (!ebayvariationListingTable) return;
            ...
            ebayvariationListingTable.setFilter(function (data) {
        ...
        $(document).ready(function () {
            ...
            ebayvariationListingTable = new Tabulator('#ebayvariationListing-table', {
                ajaxURL: '/listing_ebayvariation/view-data',
            ...
            ebayvariationListingTable.on('dataProcessed', function () {
                hideLoader();
                applyListingFilters();
            });
            ebayvariationListingTable.on('dataFiltered', function () {
                calculateTotals();
            });
            ebayvariationListingTable.on('dataLoadError', function () {
                hideLoader();
            ...
            $(document).on('click', '#confirmImportBtn', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        ebayvariationListingTable.setData('/listing_ebayvariation/view-data');
                    },
                    error: function (xhr) {
                        hideLoader();
