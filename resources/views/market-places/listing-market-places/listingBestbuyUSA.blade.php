            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-container">
                        <table class="custom-resizable-table" id="bestBuyUSAListing-table">
                            <thead>
                                <tr>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            // Cache system
            const bestBuyUSAListingDataCache = {
                cache: {},
            ...
            window.addEventListener('load', function() {
                bestBuyUSAListingDataCache.clear();
            });
            ...
            function loadData() {
                showLoader();
                return $.ajax({
                    url: '/listing_bestbuyusa/view-data',
                    type: 'GET',
                    dataType: 'json',
            ...
            function renderTable() {
                const $tbody = $('#bestBuyUSAListing-table tbody');
                $tbody.empty();
            ...
            function initResizableColumns() {
                const $table = $('#bestBuyUSAListing-table');
            ...
            function saveStatusToDB(sku, data) {
                ...
                $.ajax({
                    url: '/listing_bestbuyusa/save-status',
                    type: 'POST',
                    data: {
                        sku: sku,
                        ...data,
