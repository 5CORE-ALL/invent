@extends('layouts.vertical', ['title' => 'Listing BestBuy USA', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('css')
    ...
    <style>
        /* ========== TABLE SHELL ========== */
        #bestbuyusa-listing-wrap {
            overflow-x: auto;
            overflow-y: visible;
            width: 100%;
        }

        #bestbuyusa-listing-wrap .tabulator {
        ...
        .card-body:has(#bestbuyusa-listing-toolbar) {
            width: 100%;
        }

        #bestbuyusa-listing-wrap .tabulator .tabulator-tableholder {
            background: #fff;
        }

        /* ========== HEADER ========== */
        #bestbuyusa-listing-wrap .tabulator .tabulator-header {
            background: #00d5d5;
            border-bottom: 1px solid #ffffff;
        }

        #bestbuyusa-listing-wrap .tabulator-col .tabulator-col-sorter {
            display: none !important;
        }

        #bestbuyusa-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-content-holder,
        #bestbuyusa-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-title-holder {
        ...
        #bestbuyusa-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-title {
            writing-mode: horizontal-tb !important;
            text-orientation: mixed !important;
            transform: none !important;
            white-space: normal !important;
        ...
        #bestbuyusa-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content {
            height: auto !important;
            min-height: 34px;
            padding: 0;
        }

        #bestbuyusa-listing-wrap .tabulator .tabulator-header .tabulator-col {
            height: auto !important;
            min-height: 34px;
        ...
        #bestbuyusa-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content-holder {
            padding-left: 2px !important;
            padding-right: 2px !important;
        }

        /* Header filters */
        #bestbuyusa-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input {
            width: 100%;
        ...
        #bestbuyusa-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input:focus {
            outline: none;
            border-color: #4361ee;
        ...
        /* ========== ROWS / CELLS ========== */
        #bestbuyusa-listing-wrap .tabulator .tabulator-row {
            min-height: 36px;
            border-bottom: 1px solid #f1f5f9;
        }

        #bestbuyusa-listing-wrap .tabulator .tabulator-row .tabulator-cell {
            padding: 5px 6px !important;
            border-right: 1px solid #f1f5f9;
            vertical-align: middle;
        }

        #bestbuyusa-listing-wrap .tabulator-row .tabulator-cell input[type="checkbox"],
        #bestbuyusa-listing-wrap .tabulator-header .tabulator-col input[type="checkbox"] {
            width: 16px;
            height: 16px;
            cursor: pointer;
            accent-color: #4361ee;
        ...
        #bestbuyusa-listing-wrap .tabulator-row.parent-row .tabulator-cell input[type="checkbox"] {
            display: none;
        }

        #bestbuyusa-listing-wrap .tabulator .tabulator-row:hover {
            background-color: #f8fafc !important;
        }

        #bestbuyusa-listing-wrap .tabulator .tabulator-row.tabulator-row-even {
            background-color: #fcfcfd;
        }

        #bestbuyusa-listing-wrap .tabulator-row.parent-row,
        #bestbuyusa-listing-wrap .tabulator-row.parent-row .tabulator-cell {
            background-color: #fffef2 !important;
            font-weight: 700 !important;
            color: #0f172a;
        }

        #bestbuyusa-listing-wrap .tabulator-row.parent-row:hover,
        #bestbuyusa-listing-wrap .tabulator-row.parent-row:hover .tabulator-cell {
            background-color: #fefce8 !important;
        }

        /* ========== FOOTER / PAGINATION ========== */
        #bestbuyusa-listing-wrap .tabulator .tabulator-footer {
            background: #f8fafc !important;
            border-top: 1px solid #e2e8f0 !important;
            padding: 10px 16px !important;
        }

        #bestbuyusa-listing-wrap .tabulator .tabulator-footer .tabulator-paginator {
            display: flex;
            align-items: center;
        ...
        #bestbuyusa-listing-wrap .tabulator .tabulator-footer .tabulator-paginator label {
            margin-right: 6px;
            font-size: 12px;
            color: #475569;
            font-weight: 600;
        ...
        #bestbuyusa-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page-size {
        ...
        #bestbuyusa-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page {
        ...
        #bestbuyusa-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page:hover {
            background: #f1f5f9 !important;
            border-color: #cbd5e1 !important;
            color: #1e293b !important;
        }

        #bestbuyusa-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page.active {
        ...
        #bestbuyusa-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page[disabled] {
            opacity: 0.4 !important;
            cursor: not-allowed !important;
        }

        #bestbuyusa-listing-wrap .tabulator .tabulator-footer .tabulator-page-counter {
            margin: 0 0.5rem;
            font-size: 12px;
            color: #334155;
        }
        ...
        #bestbuyusa-listing-toolbar .bestbuyusa-listing-toolbar-row {
            display: flex;
            flex-wrap: nowrap;
            align-items: center;
        ...
        #bestbuyusa-listing-toolbar .listing-stat-badges {
            display: inline-flex;
            flex: 0 0 auto;
            align-items: stretch;
            gap: 0;
        ...
        #bestbuyusa-listing-toolbar .listing-stat-badge {
            flex: 0 0 auto;
            justify-content: center;
            margin: 0 !important;
            border-radius: 0;
        ...
        #bestbuyusa-listing-toolbar .listing-stat-badges .listing-stat-badge:first-child {
            border-radius: 8px 0 0 8px;
        }

        #bestbuyusa-listing-toolbar .listing-stat-badges .listing-stat-badge:last-child {
            border-radius: 0 8px 8px 0;
        }

        #bestbuyusa-listing-toolbar .filter-select {
            flex: 0 0 auto;
            min-width: 0;
        ...
        #bestbuyusa-listing-toolbar .filter-select:focus {
            outline: none;
            border-color: #4361ee;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.15);
        }

        #bestbuyusa-listing-toolbar .toolbar-actions {
            display: flex;
            flex: 0 0 auto;
            align-items: center;
            margin-left: 0;
        ...
        #bestbuyusa-listing-toolbar .listing-io-btn {
            border-radius: 5px;
            font-weight: 600;
            font-size: 14px;
            width: 32px;
        ...
        #bestbuyusa-listing-toolbar .listing-io-btn::after {
            display: none;
        }

        #bestbuyusa-listing-toolbar .listing-io-menu {
            min-width: 42px;
            padding: 4px;
        }

        #bestbuyusa-listing-toolbar .listing-io-menu .dropdown-item {
            display: flex;
            align-items: center;
            justify-content: center;
            width: 34px;
        ...
        #bestbuyusa-listing-toolbar .listing-io-menu .dropdown-item:hover {
            background: #f1f5f9;
        }
        ...
        /* ========== DROPDOWNS ========== */
        #bestbuyusa-listing-wrap select.nr-req-dropdown,
        #bestbuyusa-listing-wrap select.listed-dropdown {
        ...
        #bestbuyusa-listing-wrap select.nr-req-dropdown:focus,
        #bestbuyusa-listing-wrap select.listed-dropdown:focus {
            outline: none;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.25);
        }

        #bestbuyusa-listing-wrap select.nr-req-dropdown[data-val="REQ"],
        #bestbuyusa-listing-wrap select.nr-req-dropdown option.req-option {
            background-color: #28a745;
            color: #fff;
        }

        #bestbuyusa-listing-wrap select.nr-req-dropdown[data-val="NR"],
        #bestbuyusa-listing-wrap select.nr-req-dropdown option.nr-option {
            background-color: #dc3545;
            color: #fff;
        }

        #bestbuyusa-listing-wrap select.listed-dropdown[data-val="Listed"],
        #bestbuyusa-listing-wrap select.listed-dropdown option.listed-option {
            background-color: #28a745;
            color: #fff;
        }

        #bestbuyusa-listing-wrap select.listed-dropdown[data-val="Pending"],
        #bestbuyusa-listing-wrap select.listed-dropdown option.pending-option {
            background-color: #dc3545;
            color: #fff;
        }
        ...
        /* ========== LINK CELL ========== */
        #bestbuyusa-listing-wrap a.listing-item-link {
            font-weight: 600;
            color: #0d6efd;
            text-decoration: none;
        }

        #bestbuyusa-listing-wrap a.listing-item-link:hover {
        ...
        /* ========== PLACEHOLDER ========== */
        #bestbuyusa-listing-wrap .tabulator-placeholder {
            color: #64748b;
            font-weight: 600;
            padding: 24px;
        }
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Listing BestBuy USA', 'sub_title' => 'BestBuy USA'])

    <div class="row">
        <div class="col-12">
            <div class="card position-relative">
                <div class="card-body">
                    <div id="bestbuyusa-listing-toolbar" class="mb-3">
                        <div class="bestbuyusa-listing-toolbar-row">
                            ...
                            <div class="toolbar-actions dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end listing-io-menu" aria-labelledby="listing-io-btn">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('listing_bestbuyusa.export') }}" title="Export">
                    ...
                    <div id="bestbuyusa-listing-wrap">
                        <div id="bestbuyusaListing-table"></div>
                    </div>
...
@section('script')
    ...
    <script>
        ...
        let bestbuyusaListingTable = null;
        let allListingData = [];
        ...
        function calculateTotals() {
            try {
                if (!bestbuyusaListingTable) {
                    resetMetricsToZero();
                    return;
                }

                const rows = bestbuyusaListingTable.getData('active') || [];
                const metrics = {
                    invTotal: 0,
                    reqTotal: 0,
                    nrlTotal: 0,
        ...
        function applyListingFilters() {
            if (!bestbuyusaListingTable) return;
            ...
            bestbuyusaListingTable.setFilter(function (data) {
        ...
        $(document).ready(function () {
            ...
            bestbuyusaListingTable = new Tabulator('#bestbuyusaListing-table', {
                ajaxURL: '/listing_bestbuyusa/view-data',
            ...
            bestbuyusaListingTable.on('dataProcessed', function () {
                hideLoader();
                applyListingFilters();
            });
            bestbuyusaListingTable.on('dataFiltered', function () {
                calculateTotals();
            });
            bestbuyusaListingTable.on('dataLoadError', function () {
                hideLoader();
            ...
            $(document).on('click', '#confirmImportBtn', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        bestbuyusaListingTable.setData('/listing_bestbuyusa/view-data');
                    },
                    error: function (xhr) {
                        hideLoader();
