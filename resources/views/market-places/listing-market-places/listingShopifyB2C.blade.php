                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="d-flex align-items-center mb-3 gap-2">
                            ...
                            <a href="{{ route('listing_shopifyb2c.export') }}" class="btn btn-sm btn-success mr-3">Export</a>
                    ...
                    <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            ...
                            <div class="modal-body">
                                ...
                                <a href="{{ route('listing_shopifyb2c.sample') }}" class="btn btn-outline-secondary mb-3">📄 Download Sample File</a>
                    ...
                    <div class="table-container">
                        <table class="custom-resizable-table" id="shopifyB2CListing-table">
                            <thead>
                                <tr>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            // Cache system
            const shopifyB2CListingDataCache = {
                cache: {},
            ...
            window.addEventListener('load', function() {
                shopifyB2CListingDataCache.clear();
            });
            ...
            function loadData() {
                showLoader();
                return $.ajax({
                    url: '/listing_shopifyb2c/view-data',
                    type: 'GET',
                    dataType: 'json',
            ...
            function renderTable() {
                const $tbody = $('#shopifyB2CListing-table tbody');
                $tbody.empty();
            ...
            function initResizableColumns() {
                const $table = $('#shopifyB2CListing-table');
            ...
            function saveStatusToDB(sku, data, callback) {
                $.ajax({
                    url: '/listing_shopifyb2c/save-status',
                    type: 'POST',
                    data: {
                        sku: sku,
                        ...data,
