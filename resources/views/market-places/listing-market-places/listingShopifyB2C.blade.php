@extends('layouts.vertical', ['title' => 'Listing Shopify B2C', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('css')
    ...
    <style>
        /* ========== TABLE SHELL ========== */
        #shopifyb2c-listing-wrap {
            overflow-x: auto;
            overflow-y: visible;
            width: 100%;
        }

        #shopifyb2c-listing-wrap .tabulator {
        ...
        .card-body:has(#shopifyb2c-listing-toolbar) {
            width: 100%;
        }

        #shopifyb2c-listing-wrap .tabulator .tabulator-tableholder {
            background: #fff;
        }

        /* ========== HEADER ========== */
        #shopifyb2c-listing-wrap .tabulator .tabulator-header {
            background: #00d5d5;
            border-bottom: 1px solid #ffffff;
        }

        #shopifyb2c-listing-wrap .tabulator-col .tabulator-col-sorter {
            display: none !important;
        }

        #shopifyb2c-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-content-holder,
        #shopifyb2c-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-title-holder {
        ...
        #shopifyb2c-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-title {
            writing-mode: horizontal-tb !important;
            text-orientation: mixed !important;
            transform: none !important;
            white-space: normal !important;
        ...
        #shopifyb2c-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content {
            height: auto !important;
            min-height: 34px;
            padding: 0;
        }

        #shopifyb2c-listing-wrap .tabulator .tabulator-header .tabulator-col {
            height: auto !important;
            min-height: 34px;
        ...
        #shopifyb2c-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content-holder {
            padding-left: 2px !important;
            padding-right: 2px !important;
        }

        /* Header filters */
        #shopifyb2c-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input {
            width: 100%;
        ...
        #shopifyb2c-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input:focus {
            outline: none;
            border-color: #4361ee;
        ...
        /* ========== ROWS / CELLS ========== */
        #shopifyb2c-listing-wrap .tabulator .tabulator-row {
            min-height: 36px;
            border-bottom: 1px solid #f1f5f9;
        }

        #shopifyb2c-listing-wrap .tabulator .tabulator-row .tabulator-cell {
            padding: 5px 6px !important;
            border-right: 1px solid #f1f5f9;
            vertical-align: middle;
        }

        #shopifyb2c-listing-wrap .tabulator-row .tabulator-cell input[type="checkbox"],
        #shopifyb2c-listing-wrap .tabulator-header .tabulator-col input[type="checkbox"] {
            width: 16px;
            height: 16px;
            cursor: pointer;
            accent-color: #4361ee;
        ...
        #shopifyb2c-listing-wrap .tabulator-row.parent-row .tabulator-cell input[type="checkbox"] {
            display: none;
        }

        #shopifyb2c-listing-wrap .tabulator .tabulator-row:hover {
            background-color: #f8fafc !important;
        }

        #shopifyb2c-listing-wrap .tabulator .tabulator-row.tabulator-row-even {
            background-color: #fcfcfd;
        }

        #shopifyb2c-listing-wrap .tabulator-row.parent-row,
        #shopifyb2c-listing-wrap .tabulator-row.parent-row .tabulator-cell {
            background-color: #fffef2 !important;
            font-weight: 700 !important;
            color: #0f172a;
        }

        #shopifyb2c-listing-wrap .tabulator-row.parent-row:hover,
        #shopifyb2c-listing-wrap .tabulator-row.parent-row:hover .tabulator-cell {
            background-color: #fefce8 !important;
        }

        /* ========== FOOTER / PAGINATION ========== */
        #shopifyb2c-listing-wrap .tabulator .tabulator-footer {
            background: #f8fafc !important;
            border-top: 1px solid #e2e8f0 !important;
            padding: 10px 16px !important;
        }

        #shopifyb2c-listing-wrap .tabulator .tabulator-footer .tabulator-paginator {
            display: flex;
            align-items: center;
        ...
        #shopifyb2c-listing-wrap .tabulator .tabulator-footer .tabulator-paginator label {
            margin-right: 6px;
            font-size: 12px;
            color: #475569;
            font-weight: 600;
        ...
        #shopifyb2c-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page-size {
        ...
        #shopifyb2c-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page {
        ...
        #shopifyb2c-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page:hover {
            background: #f1f5f9 !important;
            border-color: #cbd5e1 !important;
            color: #1e293b !important;
        }

        #shopifyb2c-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page.active {
        ...
        #shopifyb2c-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page[disabled] {
            opacity: 0.4 !important;
            cursor: not-allowed !important;
        }

        #shopifyb2c-listing-wrap .tabulator .tabulator-footer .tabulator-page-counter {
            margin: 0 0.5rem;
            font-size: 12px;
            color: #334155;
        }
        ...
        #shopifyb2c-listing-toolbar .shopifyb2c-listing-toolbar-row {
            display: flex;
            flex-wrap: nowrap;
            align-items: center;
        ...
        #shopifyb2c-listing-toolbar .listing-stat-badges {
            display: inline-flex;
            flex: 0 0 auto;
            align-items: stretch;
            gap: 0;
        ...
        #shopifyb2c-listing-toolbar .listing-stat-badge {
            flex: 0 0 auto;
            justify-content: center;
            margin: 0 !important;
            border-radius: 0;
        ...
        #shopifyb2c-listing-toolbar .listing-stat-badges .listing-stat-badge:first-child {
            border-radius: 8px 0 0 8px;
        }

        #shopifyb2c-listing-toolbar .listing-stat-badges .listing-stat-badge:last-child {
            border-radius: 0 8px 8px 0;
        }

        #shopifyb2c-listing-toolbar .filter-select {
            flex: 0 0 auto;
            min-width: 0;
        ...
        #shopifyb2c-listing-toolbar .filter-select:focus {
            outline: none;
            border-color: #4361ee;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.15);
        }

        #shopifyb2c-listing-toolbar .toolbar-actions {
            display: flex;
            flex: 0 0 auto;
            align-items: center;
            margin-left: 0;
        ...
        #shopifyb2c-listing-toolbar .listing-io-btn {
            border-radius: 5px;
            font-weight: 600;
            font-size: 14px;
            width: 32px;
        ...
        #shopifyb2c-listing-toolbar .listing-io-btn::after {
            display: none;
        }

        #shopifyb2c-listing-toolbar .listing-io-menu {
            min-width: 42px;
            padding: 4px;
        }

        #shopifyb2c-listing-toolbar .listing-io-menu .dropdown-item {
            display: flex;
            align-items: center;
            justify-content: center;
            width: 34px;
        ...
        #shopifyb2c-listing-toolbar .listing-io-menu .dropdown-item:hover {
            background: #f1f5f9;
        }
        ...
        /* ========== DROPDOWNS ========== */
        #shopifyb2c-listing-wrap select.nr-req-dropdown,
        #shopifyb2c-listing-wrap select.listed-dropdown {
        ...
        #shopifyb2c-listing-wrap select.nr-req-dropdown:focus,
        #shopifyb2c-listing-wrap select.listed-dropdown:focus {
            outline: none;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.25);
        }

        #shopifyb2c-listing-wrap select.nr-req-dropdown[data-val="REQ"],
        #shopifyb2c-listing-wrap select.nr-req-dropdown option.req-option {
            background-color: #28a745;
            color: #fff;
        }

        #shopifyb2c-listing-wrap select.nr-req-dropdown[data-val="NR"],
        #shopifyb2c-listing-wrap select.nr-req-dropdown option.nr-option {
            background-color: #dc3545;
            color: #fff;
        }

        #shopifyb2c-listing-wrap select.listed-dropdown[data-val="Listed"],
        #shopifyb2c-listing-wrap select.listed-dropdown option.listed-option {
            background-color: #28a745;
            color: #fff;
        }

        #shopifyb2c-listing-wrap select.listed-dropdown[data-val="Pending"],
        #shopifyb2c-listing-wrap select.listed-dropdown option.pending-option {
            background-color: #dc3545;
            color: #fff;
        }
        ...
        /* ========== LINK CELL ========== */
        #shopifyb2c-listing-wrap a.listing-item-link {
            font-weight: 600;
            color: #0d6efd;
            text-decoration: none;
        }

        #shopifyb2c-listing-wrap a.listing-item-link:hover {
        ...
        /* ========== PLACEHOLDER ========== */
        #shopifyb2c-listing-wrap .tabulator-placeholder {
            color: #64748b;
            font-weight: 600;
            padding: 24px;
        }
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Listing Shopify B2C', 'sub_title' => 'Shopify B2C'])

    <div class="row">
        <div class="col-12">
            <div class="card position-relative">
                <div class="card-body">
                    <div id="shopifyb2c-listing-toolbar" class="mb-3">
                        <div class="shopifyb2c-listing-toolbar-row">
                    ...
                    <div id="shopifyb2c-listing-wrap">
                        <div id="shopifyb2cListing-table"></div>
                    </div>
...
@section('script')
    ...
    <script>
        ...
        let shopifyb2cListingTable = null;
        let allListingData = [];
        ...
        function calculateTotals() {
            try {
                if (!shopifyb2cListingTable) {
                    resetMetricsToZero();
                    return;
                }

                const rows = shopifyb2cListingTable.getData('active') || [];
                const metrics = {
                    invTotal: 0,
                    reqTotal: 0,
                    nrlTotal: 0,
        ...
        function applyListingFilters() {
            if (!shopifyb2cListingTable) return;
            ...
            shopifyb2cListingTable.setFilter(function (data) {
        ...
        $(document).ready(function () {
            ...
            shopifyb2cListingTable.on('dataLoadError', function () {
                hideLoader();
            ...
            $(document).on('click', '#confirmImportBtn', function () {
                ...
                showLoader();
                $.ajax({
                    url: "{{ route('listing_shopifyb2c.import') }}",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    ...
                    success: function (response) {
                        ...
                        shopifyb2cListingTable.setData('/listing_shopifyb2c/view-data');
                    },
                    error: function (xhr) {
                        hideLoader();
    ...
    <script>
        window.listingPageConfig = {
            wrap: '#shopifyb2c-listing-wrap',
            tableId: 'shopifyb2cListing-table',
            exportName: 'shopifyb2c_listing',
            channel: 'shopifyb2c',
            channelLabel: "Shopify B2C",
            previewUrl: '/listing_shopifyb2c/save-status',
            publishUrl: '/listing_shopifyb2c/save-status'
        };
    </script>
