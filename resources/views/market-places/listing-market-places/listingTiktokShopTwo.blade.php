        ...
        <div class="col-12">
            <div class="card position-relative">
                <div class="card-body">
                    ...
                    @include('market-places.listing-market-places._listing_publish_modal', ['publishChannel' => 'tiktokshop2'])
...
@section('script')
    ...
    <script>
        window.listingPageConfig = {
            wrap: '#tiktokshop2-listing-wrap',
            tableId: 'tiktokshop2Listing-table',
