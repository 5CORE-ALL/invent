@extends('layouts.vertical', ['title' => 'Listing FB Shop', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('css')
    ...
    <style>
        ...
        .card-body:has(#fbshop-listing-toolbar) {
            width: 100%;
        }

        #fbshop-listing-wrap .tabulator .tabulator-tableholder {
            background: #fff;
        }

        /* ========== HEADER ========== */
        #fbshop-listing-wrap .tabulator .tabulator-header {
            background: #00d5d5;
            border-bottom: 1px solid #ffffff;
        }

        #fbshop-listing-wrap .tabulator-col .tabulator-col-sorter {
            display: none !important;
        }

        #fbshop-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-content-holder,
        #fbshop-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-title-holder {
        ...
        #fbshop-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-title {
            writing-mode: horizontal-tb !important;
            text-orientation: mixed !important;
            transform: none !important;
            white-space: normal !important;
        ...
        #fbshop-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content {
            height: auto !important;
            min-height: 34px;
            padding: 0;
        }

        #fbshop-listing-wrap .tabulator .tabulator-header .tabulator-col {
            height: auto !important;
            min-height: 34px;
        ...
        #fbshop-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content-holder {
            padding-left: 2px !important;
            padding-right: 2px !important;
        }

        /* Header filters */
        #fbshop-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input {
            width: 100%;
        ...
        #fbshop-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input:focus {
            outline: none;
            border-color: #4361ee;
        ...
        /* ========== ROWS / CELLS ========== */
        #fbshop-listing-wrap .tabulator .tabulator-row {
            min-height: 36px;
            border-bottom: 1px solid #f1f5f9;
        }

        #fbshop-listing-wrap .tabulator .tabulator-row .tabulator-cell {
            padding: 5px 6px !important;
            border-right: 1px solid #f1f5f9;
            vertical-align: middle;
        }

        #fbshop-listing-wrap .tabulator-row .tabulator-cell input[type="checkbox"],
        #fbshop-listing-wrap .tabulator-header .tabulator-col input[type="checkbox"] {
            width: 16px;
            height: 16px;
            cursor: pointer;
            accent-color: #4361ee;
        ...
        #fbshop-listing-wrap .tabulator-row.parent-row .tabulator-cell input[type="checkbox"] {
            display: none;
        }

        #fbshop-listing-wrap .tabulator .tabulator-row:hover {
            background-color: #f8fafc !important;
        }

        #fbshop-listing-wrap .tabulator .tabulator-row.tabulator-row-even {
            background-color: #fcfcfd;
        }

        #fbshop-listing-wrap .tabulator-row.parent-row,
        #fbshop-listing-wrap .tabulator-row.parent-row .tabulator-cell {
            background-color: #fffef2 !important;
            font-weight: 700 !important;
            color: #0f172a;
        }

        #fbshop-listing-wrap .tabulator-row.parent-row:hover,
        #fbshop-listing-wrap .tabulator-row.parent-row:hover .tabulator-cell {
            background-color: #fefce8 !important;
        }

        /* ========== FOOTER / PAGINATION ========== */
        #fbshop-listing-wrap .tabulator .tabulator-footer {
            background: #f8fafc !important;
            border-top: 1px solid #e2e8f0 !important;
            padding: 10px 16px !important;
        }

        #fbshop-listing-wrap .tabulator .tabulator-footer .tabulator-paginator {
            display: flex;
            align-items: center;
        ...
        #fbshop-listing-wrap .tabulator .tabulator-footer .tabulator-paginator label {
            margin-right: 6px;
            font-size: 12px;
            color: #475569;
            font-weight: 600;
        ...
        #fbshop-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page-size {
        ...
        #fbshop-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page {
        ...
        #fbshop-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page:hover {
            background: #f1f5f9 !important;
            border-color: #cbd5e1 !important;
            color: #1e293b !important;
        }

        #fbshop-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page.active {
        ...
        #fbshop-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page[disabled] {
            opacity: 0.4 !important;
            cursor: not-allowed !important;
        }

        #fbshop-listing-wrap .tabulator .tabulator-footer .tabulator-page-counter {
            margin: 0 0.5rem;
            font-size: 12px;
            color: #334155;
        }
        ...
        #fbshop-listing-toolbar .fbshop-listing-toolbar-row {
            display: flex;
            flex-wrap: nowrap;
            align-items: center;
        ...
        #fbshop-listing-toolbar .listing-stat-badges {
            display: inline-flex;
            flex: 0 0 auto;
            align-items: stretch;
            gap: 0;
        ...
        #fbshop-listing-toolbar .listing-stat-badge {
            flex: 0 0 auto;
            justify-content: center;
            margin: 0 !important;
            border-radius: 0;
        ...
        #fbshop-listing-toolbar .listing-stat-badges .listing-stat-badge:first-child {
            border-radius: 8px 0 0 8px;
        }

        #fbshop-listing-toolbar .listing-stat-badges .listing-stat-badge:last-child {
            border-radius: 0 8px 8px 0;
        }

        #fbshop-listing-toolbar .filter-select {
            flex: 0 0 auto;
            min-width: 0;
        ...
        #fbshop-listing-toolbar .filter-select:focus {
            outline: none;
            border-color: #4361ee;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.15);
        }

        #fbshop-listing-toolbar .toolbar-actions {
            display: flex;
            flex: 0 0 auto;
            align-items: center;
            margin-left: 0;
        ...
        #fbshop-listing-toolbar .listing-io-btn {
            border-radius: 5px;
            font-weight: 600;
            font-size: 14px;
            width: 32px;
        ...
        #fbshop-listing-toolbar .listing-io-btn::after {
            display: none;
        }

        #fbshop-listing-toolbar .listing-io-menu {
            min-width: 42px;
            padding: 4px;
        }

        #fbshop-listing-toolbar .listing-io-menu .dropdown-item {
            display: flex;
            align-items: center;
            justify-content: center;
            width: 34px;
        ...
        #fbshop-listing-toolbar .listing-io-menu .dropdown-item:hover {
            background: #f1f5f9;
        }
        ...
        /* ========== DROPDOWNS ========== */
        #fbshop-listing-wrap select.nr-req-dropdown,
        #fbshop-listing-wrap select.listed-dropdown {
        ...
        #fbshop-listing-wrap select.nr-req-dropdown:focus,
        #fbshop-listing-wrap select.listed-dropdown:focus {
            outline: none;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.25);
        }

        #fbshop-listing-wrap select.nr-req-dropdown[data-val="REQ"],
        #fbshop-listing-wrap select.nr-req-dropdown option.req-option {
            background-color: #28a745;
            color: #fff;
        }

        #fbshop-listing-wrap select.nr-req-dropdown[data-val="NR"],
        #fbshop-listing-wrap select.nr-req-dropdown option.nr-option {
            background-color: #dc3545;
            color: #fff;
        }

        #fbshop-listing-wrap select.listed-dropdown[data-val="Listed"],
        #fbshop-listing-wrap select.listed-dropdown option.listed-option {
            background-color: #28a745;
            color: #fff;
        }

        #fbshop-listing-wrap select.listed-dropdown[data-val="Pending"],
        #fbshop-listing-wrap select.listed-dropdown option.pending-option {
            background-color: #dc3545;
            color: #fff;
        }
        ...
        /* ========== LINK CELL ========== */
        #fbshop-listing-wrap a.listing-item-link {
            font-weight: 600;
            color: #0d6efd;
            text-decoration: none;
        }

        #fbshop-listing-wrap a.listing-item-link:hover {
        ...
        /* ========== PLACEHOLDER ========== */
        #fbshop-listing-wrap .tabulator-placeholder {
            color: #64748b;
            font-weight: 600;
            padding: 24px;
        }
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Listing FB Shop', 'sub_title' => 'FB Shop'])

    <div class="row">
        <div class="col-12">
            <div class="card position-relative">
                <div class="card-body">
                    <div id="fbshop-listing-toolbar" class="mb-3">
                        <div class="fbshop-listing-toolbar-row">
                    ...
                    <div id="fbshop-listing-wrap">
                        <div id="fbshopListing-table"></div>
                    </div>
...
@section('script')
    ...
    <script>
        ...
        function calculateTotals() {
            try {
                if (!fbshopListingTable) {
                    resetMetricsToZero();
                    return;
                }

                const rows = fbshopListingTable.getData('active') || [];
                const metrics = {
                    invTotal: 0,
                    reqTotal: 0,
                    nrlTotal: 0,
        ...
        function applyListingFilters() {
            ...
            fbshopListingTable.setFilter(function (data) {
        ...
        $(document).ready(function () {
            ...
            fbshopListingTable = new Tabulator('#fbshopListing-table', {
                ajaxURL: '/listing_fbshop/view-data',
            ...
            fbshopListingTable.on('dataProcessed', function () {
                hideLoader();
                applyListingFilters();
            });
            fbshopListingTable.on('dataFiltered', function () {
                calculateTotals();
            });
            fbshopListingTable.on('dataLoadError', function () {
                hideLoader();
            ...
            $(document).on('click', '#confirmImportBtn', function () {
                ...
                showLoader();
                $.ajax({
                    url: "{{ route('listing_fbshop.import') }}",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    ...
                    success: function (response) {
                        ...
                        fbshopListingTable.setData('/listing_fbshop/view-data');
                    },
                    error: function (xhr) {
                        hideLoader();
    ...
    <script>
        window.listingPageConfig = {
            wrap: '#fbshop-listing-wrap',
            tableId: 'fbshopListing-table',
            exportName: 'fbshop_listing',
            channel: 'fbshop',
            channelLabel: "FB Shop",
            previewUrl: '/listing_fbshop/save-status',
            publishUrl: '/listing_fbshop/save-status'
        };
    </script>
