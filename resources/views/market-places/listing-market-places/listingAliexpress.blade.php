...
@section('content')
    @include('layouts.shared/page-title', [
        'page_title' => 'Listing Aliexpress',
        'sub_title' => 'Aliexpress',
    ])
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="d-flex align-items-center mb-3 gap-2">
                            ...
                            <a href="{{ route('listing_aliexpress.export') }}" class="btn btn-sm btn-success mr-3">Export</a>
                    ...
                    <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            ...
                            <div class="modal-body">
                                ...
                                <a href="{{ route('listing_aliexpress.sample') }}" class="btn btn-outline-secondary mb-3">📄 Download Sample File</a>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
                    // Cache system
                    const aliexpressListingDataCache = {
                        cache: {},
                    ...
                    window.addEventListener('load', function() {
                        aliexpressListingDataCache.clear();
                    });
                    ...
                    function applyAllFilters() {
                        filteredData = tableData.filter(item => {
                            ...
                            if (filterStates.inv === 'inv-only' && !item.sku.includes('PARENT') && parseFloat(item
                                    .INV) <= 0) return false;
                            // RL/NRL filter (support both old and new field names)
                            if (filterStates.nr_req !== 'all') {
                                const rlNrl = item.rl_nrl || (item.nr_req === 'REQ' ? 'RL' : (item.nr_req === 'NR' ? 'NRL' : null));
                                if (rlNrl !== filterStates.nr_req) return false;
                            }
                            // LINK filter
                    ...
                    function loadData() {
                        showLoader();
                        return $.ajax({
                            url: '/listing_aliexpress/view-data',
                            type: 'GET',
                            dataType: 'json',
                ...
                `);
                        ...
                        function saveStatusToDB(sku, data, callback) {
                            ...
                            $.ajax({
                                url: '/listing_aliexpress/save-status',
                                type: 'POST',
                                data: {
                                    sku: sku,
                                    ...data,
