@extends('layouts.vertical', ['title' => 'Listing Aliexpress', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])

<meta name="csrf-token" content="{{ csrf_token() }}">

@section('css')
    <link rel="stylesheet" href="{{ asset('css/listing-page-tools.css') }}?v=6">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    ...
    <style>
        /* ========== TABLE SHELL ========== */
        #aliexpress-listing-wrap {
            overflow-x: auto;
            overflow-y: visible;
            width: 100%;
        }

        #aliexpress-listing-wrap .tabulator {
        ...
        .card-body:has(#aliexpress-listing-toolbar) {
            width: 100%;
        }

        #aliexpress-listing-wrap .tabulator .tabulator-tableholder {
            background: #fff;
        }

        /* ========== HEADER ========== */
        #aliexpress-listing-wrap .tabulator .tabulator-header {
            background: #00d5d5;
            border-bottom: 1px solid #ffffff;
        }

        #aliexpress-listing-wrap .tabulator-col .tabulator-col-sorter {
            display: none !important;
        }

        #aliexpress-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-content-holder,
        #aliexpress-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-title-holder {
        ...
        #aliexpress-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-title {
            writing-mode: horizontal-tb !important;
            text-orientation: mixed !important;
            transform: none !important;
            white-space: normal !important;
        ...
        #aliexpress-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content {
            height: auto !important;
            min-height: 34px;
            padding: 0;
        }

        #aliexpress-listing-wrap .tabulator .tabulator-header .tabulator-col {
            height: auto !important;
            min-height: 34px;
        ...
        #aliexpress-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content-holder {
            padding-left: 2px !important;
            padding-right: 2px !important;
        }

        /* Header filters */
        #aliexpress-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input {
            width: 100%;
        ...
        #aliexpress-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input:focus {
            outline: none;
            border-color: #4361ee;
        ...
        /* ========== ROWS / CELLS ========== */
        #aliexpress-listing-wrap .tabulator .tabulator-row {
            min-height: 36px;
            border-bottom: 1px solid #f1f5f9;
        }

        #aliexpress-listing-wrap .tabulator .tabulator-row .tabulator-cell {
            padding: 5px 6px !important;
            border-right: 1px solid #f1f5f9;
            vertical-align: middle;
        }

        #aliexpress-listing-wrap .tabulator-row .tabulator-cell input[type="checkbox"],
        #aliexpress-listing-wrap .tabulator-header .tabulator-col input[type="checkbox"] {
            width: 16px;
            height: 16px;
            cursor: pointer;
            accent-color: #4361ee;
        ...
        #aliexpress-listing-wrap .tabulator-row.parent-row .tabulator-cell input[type="checkbox"] {
            display: none;
        }

        #aliexpress-listing-wrap .tabulator .tabulator-row:hover {
            background-color: #f8fafc !important;
        }

        #aliexpress-listing-wrap .tabulator .tabulator-row.tabulator-row-even {
            background-color: #fcfcfd;
        }

        #aliexpress-listing-wrap .tabulator-row.parent-row,
        #aliexpress-listing-wrap .tabulator-row.parent-row .tabulator-cell {
            background-color: #fffef2 !important;
            font-weight: 700 !important;
            color: #0f172a;
        }

        #aliexpress-listing-wrap .tabulator-row.parent-row:hover,
        #aliexpress-listing-wrap .tabulator-row.parent-row:hover .tabulator-cell {
            background-color: #fefce8 !important;
        }

        /* ========== FOOTER / PAGINATION ========== */
        #aliexpress-listing-wrap .tabulator .tabulator-footer {
            background: #f8fafc !important;
            border-top: 1px solid #e2e8f0 !important;
            padding: 10px 16px !important;
        }

        #aliexpress-listing-wrap .tabulator .tabulator-footer .tabulator-paginator {
            display: flex;
            align-items: center;
        ...
        #aliexpress-listing-wrap .tabulator .tabulator-footer .tabulator-paginator label {
            margin-right: 6px;
            font-size: 12px;
            color: #475569;
            font-weight: 600;
        ...
        #aliexpress-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page-size {
        ...
        #aliexpress-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page {
        ...
        #aliexpress-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page:hover {
            background: #f1f5f9 !important;
            border-color: #cbd5e1 !important;
            color: #1e293b !important;
        }

        #aliexpress-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page.active {
        ...
        #aliexpress-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page[disabled] {
            opacity: 0.4 !important;
            cursor: not-allowed !important;
        }

        #aliexpress-listing-wrap .tabulator .tabulator-footer .tabulator-page-counter {
            margin: 0 0.5rem;
            font-size: 12px;
            color: #334155;
        }
        ...
        #aliexpress-listing-toolbar .aliexpress-listing-toolbar-row {
            display: flex;
            flex-wrap: nowrap;
            align-items: center;
        ...
        #aliexpress-listing-toolbar .listing-stat-badges {
            display: inline-flex;
            flex: 0 0 auto;
            align-items: stretch;
            gap: 0;
        ...
        #aliexpress-listing-toolbar .listing-stat-badge {
            flex: 0 0 auto;
            justify-content: center;
            margin: 0 !important;
            border-radius: 0;
        ...
        #aliexpress-listing-toolbar .listing-stat-badges .listing-stat-badge:first-child {
            border-radius: 8px 0 0 8px;
        }

        #aliexpress-listing-toolbar .listing-stat-badges .listing-stat-badge:last-child {
            border-radius: 0 8px 8px 0;
        }

        #aliexpress-listing-toolbar .filter-select {
            flex: 0 0 auto;
            min-width: 0;
        ...
        #aliexpress-listing-toolbar .filter-select:focus {
            outline: none;
            border-color: #4361ee;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.15);
        }

        #aliexpress-listing-toolbar .toolbar-actions {
            display: flex;
            flex: 0 0 auto;
            align-items: center;
            margin-left: 0;
        ...
        #aliexpress-listing-toolbar .listing-io-btn {
            border-radius: 5px;
            font-weight: 600;
            font-size: 14px;
            width: 32px;
        ...
        #aliexpress-listing-toolbar .listing-io-btn::after {
            display: none;
        }

        #aliexpress-listing-toolbar .listing-io-menu {
            min-width: 42px;
            padding: 4px;
        }

        #aliexpress-listing-toolbar .listing-io-menu .dropdown-item {
            display: flex;
            align-items: center;
            justify-content: center;
            width: 34px;
        ...
        #aliexpress-listing-toolbar .listing-io-menu .dropdown-item:hover {
            background: #f1f5f9;
        }
        ...
        /* ========== DROPDOWNS ========== */
        #aliexpress-listing-wrap select.nr-req-dropdown,
        #aliexpress-listing-wrap select.listed-dropdown {
        ...
        #aliexpress-listing-wrap select.nr-req-dropdown:focus,
        #aliexpress-listing-wrap select.listed-dropdown:focus {
            outline: none;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.25);
        }

        #aliexpress-listing-wrap select.nr-req-dropdown[data-val="REQ"],
        #aliexpress-listing-wrap select.nr-req-dropdown option.req-option {
            background-color: #28a745;
            color: #fff;
        }

        #aliexpress-listing-wrap select.nr-req-dropdown[data-val="NR"],
        #aliexpress-listing-wrap select.nr-req-dropdown option.nr-option {
            background-color: #dc3545;
            color: #fff;
        }

        #aliexpress-listing-wrap select.listed-dropdown[data-val="Listed"],
        #aliexpress-listing-wrap select.listed-dropdown option.listed-option {
            background-color: #28a745;
            color: #fff;
        }

        #aliexpress-listing-wrap select.listed-dropdown[data-val="Pending"],
        #aliexpress-listing-wrap select.listed-dropdown option.pending-option {
            background-color: #dc3545;
            color: #fff;
        }
        ...
        /* ========== LINK CELL ========== */
        #aliexpress-listing-wrap a.listing-item-link {
            font-weight: 600;
            color: #0d6efd;
            text-decoration: none;
        }

        #aliexpress-listing-wrap a.listing-item-link:hover {
        ...
        /* ========== PLACEHOLDER ========== */
        #aliexpress-listing-wrap .tabulator-placeholder {
            color: #64748b;
            font-weight: 600;
            padding: 24px;
        }
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Listing Aliexpress', 'sub_title' => 'Aliexpress'])

    <div class="row">
        <div class="col-12">
            <div class="card position-relative">
                <div class="card-body">
                    <div id="aliexpress-listing-toolbar" class="mb-3">
                        <div class="aliexpress-listing-toolbar-row">
                    ...
                    <div id="aliexpress-listing-wrap">
                        <div id="aliexpressListing-table"></div>
                    </div>
...
@section('script')
    ...
    <script>
        ...
        let aliexpressListingTable = null;
        let allListingData = [];
        ...
        function applyListingFilters() {
            if (!aliexpressListingTable) return;
            ...
            aliexpressListingTable.setFilter(function (data) {
                ...
                const hasItemLink = !!String(data.ae_product_id || '').trim();
        ...
        function formatNrReq(cell) {
            ...
            if (value === 'NR') {
                return `<span class="listing-auto-badge listing-auto-badge--nrl" title="From aliexpress NRL (AliexpressDataView)">NRL</span>`;
            }
            return `<span class="listing-auto-badge listing-auto-badge--req" title="From aliexpress NRL (AliexpressDataView)">REQ</span>`;
        }
        ...
        function formatAliexpressItemLink(cell, type) {
            const data = cell.getRow().getData();
            if (data.is_parent) return '';

            const itemId = String(data.ae_product_id || '').trim();
            if (!itemId) {
                return `<span class="text-muted" title="No aliexpress product id">—</span>`;
            }

            const isBuyer = type === 'buyer';
            const href = isBuyer
                ? ('https://www.aliexpress.com/item/' + encodeURIComponent(itemId) + '.html')
                : ('https://gsp.aliexpress.com/m_apps/product-publish/publish?productId=' + encodeURIComponent(itemId));
            const label = isBuyer ? 'Buyer' : 'Seller';
            const title = isBuyer
                ? ('Buyer link — AliExpress Product ' + itemId)
                : ('Seller / GSP publish — AliExpress Product ' + itemId);
        ...
        function formatBuyerLink(cell) {
            return formatAliexpressItemLink(cell, 'buyer');
        }

        function formatSellerLink(cell) {
            return formatAliexpressItemLink(cell, 'seller');
        }
        ...
        $(document).ready(function () {
            ...
            aliexpressListingTable = new Tabulator('#aliexpressListing-table', {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        headerSort: false,
                        width: 110,
                        headerTooltip: 'Automatic from AliexpressDataView NRL (same source as /aliexpress-pricing NRL column)',
                    ...
                    },
                    {
                        ...
                        minWidth: 100,
                        widthGrow: 1,
                        headerTooltip: 'Dynamic buyer link: https://www.aliexpress.com/item/{product_id}.html',
                        formatter: formatBuyerLink
                    },
                    {
                        title: 'Seller Link',
                        field: 'seller_product_link',
                        hozAlign: 'center',
                        headerHozAlign: 'center',
                        headerSort: false,
                        minWidth: 100,
                        widthGrow: 1,
                        headerTooltip: 'Dynamic seller link: https://gsp.aliexpress.com/m_apps/product-publish/publish?productId={product_id}',
                    ...
                    },
                    {
                        ...
                        headerSort: false,
                        width: 130,
                        headerTooltip: 'Automatic from aliexpress_metric.product_id (same Missing Listing logic as /listing-ebaytwo item_id)',
            ...
            aliexpressListingTable.on('dataLoadError', function () {
                hideLoader();
            ...
            $(document).on('click', '#confirmImportBtn', function () {
                ...
                showLoader();
                $.ajax({
                    url: "{{ route('listing_aliexpress.import') }}",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    ...
                    success: function (response) {
                        ...
                        aliexpressListingTable.setData('/listing_aliexpress/view-data');
                    },
                    error: function (xhr) {
                        hideLoader();
    ...
    <script>
        window.listingPageConfig = {
            wrap: '#aliexpress-listing-wrap',
            tableId: 'aliexpressListing-table',
    ...
    <script src="{{ asset('js/listing-page-tools.js') }}?v=16"></script>
@endsection
