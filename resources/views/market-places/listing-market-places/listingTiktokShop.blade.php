...
@section('css')
    ...
    <style>
        /* ========== TABLE SHELL ========== */
        #tiktokshop-listing-wrap {
            overflow-x: auto;
            overflow-y: visible;
            width: 100%;
        }

        #tiktokshop-listing-wrap .tabulator {
        ...
        .card-body:has(#tiktokshop-listing-toolbar) {
            width: 100%;
        }

        #tiktokshop-listing-wrap .tabulator .tabulator-tableholder {
            background: #fff;
        }

        /* ========== HEADER ========== */
        #tiktokshop-listing-wrap .tabulator .tabulator-header {
            background: #00d5d5;
            border-bottom: 1px solid #ffffff;
        }

        #tiktokshop-listing-wrap .tabulator-col .tabulator-col-sorter {
            display: none !important;
        }

        #tiktokshop-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-content-holder,
        #tiktokshop-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-title-holder {
        ...
        #tiktokshop-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-title {
            writing-mode: horizontal-tb !important;
            text-orientation: mixed !important;
            transform: none !important;
            white-space: normal !important;
        ...
        #tiktokshop-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content {
            height: auto !important;
            min-height: 34px;
            padding: 0;
        }

        #tiktokshop-listing-wrap .tabulator .tabulator-header .tabulator-col {
            height: auto !important;
            min-height: 34px;
        ...
        #tiktokshop-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content-holder {
            padding-left: 2px !important;
            padding-right: 2px !important;
        }

        /* Header filters */
        #tiktokshop-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input {
            width: 100%;
        ...
        #tiktokshop-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input:focus {
            outline: none;
            border-color: #4361ee;
        ...
        /* ========== ROWS / CELLS ========== */
        #tiktokshop-listing-wrap .tabulator .tabulator-row {
            min-height: 36px;
            border-bottom: 1px solid #f1f5f9;
        }

        #tiktokshop-listing-wrap .tabulator .tabulator-row .tabulator-cell {
            padding: 5px 6px !important;
            border-right: 1px solid #f1f5f9;
            vertical-align: middle;
        }

        #tiktokshop-listing-wrap .tabulator-row .tabulator-cell input[type="checkbox"],
        #tiktokshop-listing-wrap .tabulator-header .tabulator-col input[type="checkbox"] {
            width: 16px;
            height: 16px;
            cursor: pointer;
            accent-color: #4361ee;
        ...
        #tiktokshop-listing-wrap .tabulator-row.parent-row .tabulator-cell input[type="checkbox"] {
            display: none;
        }

        #tiktokshop-listing-wrap .tabulator .tabulator-row:hover {
            background-color: #f8fafc !important;
        }

        #tiktokshop-listing-wrap .tabulator .tabulator-row.tabulator-row-even {
            background-color: #fcfcfd;
        }

        #tiktokshop-listing-wrap .tabulator-row.parent-row,
        #tiktokshop-listing-wrap .tabulator-row.parent-row .tabulator-cell {
            background-color: #fffef2 !important;
            font-weight: 700 !important;
            color: #0f172a;
        }

        #tiktokshop-listing-wrap .tabulator-row.parent-row:hover,
        #tiktokshop-listing-wrap .tabulator-row.parent-row:hover .tabulator-cell {
            background-color: #fefce8 !important;
        }

        /* ========== FOOTER / PAGINATION ========== */
        #tiktokshop-listing-wrap .tabulator .tabulator-footer {
            background: #f8fafc !important;
            border-top: 1px solid #e2e8f0 !important;
            padding: 10px 16px !important;
        }

        #tiktokshop-listing-wrap .tabulator .tabulator-footer .tabulator-paginator {
            display: flex;
            align-items: center;
        ...
        #tiktokshop-listing-wrap .tabulator .tabulator-footer .tabulator-paginator label {
            margin-right: 6px;
            font-size: 12px;
            color: #475569;
            font-weight: 600;
        ...
        #tiktokshop-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page-size {
        ...
        #tiktokshop-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page {
        ...
        #tiktokshop-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page:hover {
            background: #f1f5f9 !important;
            border-color: #cbd5e1 !important;
            color: #1e293b !important;
        }

        #tiktokshop-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page.active {
        ...
        #tiktokshop-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page[disabled] {
            opacity: 0.4 !important;
            cursor: not-allowed !important;
        }

        #tiktokshop-listing-wrap .tabulator .tabulator-footer .tabulator-page-counter {
            margin: 0 0.5rem;
            font-size: 12px;
            color: #334155;
        }
        ...
        #tiktokshop-listing-toolbar .tiktokshop-listing-toolbar-row {
            display: flex;
            flex-wrap: nowrap;
            align-items: center;
        ...
        #tiktokshop-listing-toolbar .listing-stat-badges {
            display: inline-flex;
            flex: 0 0 auto;
            align-items: stretch;
            gap: 0;
        ...
        #tiktokshop-listing-toolbar .listing-stat-badge {
            flex: 0 0 auto;
            justify-content: center;
            margin: 0 !important;
            border-radius: 0;
        ...
        #tiktokshop-listing-toolbar .listing-stat-badges .listing-stat-badge:first-child {
            border-radius: 8px 0 0 8px;
        }

        #tiktokshop-listing-toolbar .listing-stat-badges .listing-stat-badge:last-child {
            border-radius: 0 8px 8px 0;
        }

        #tiktokshop-listing-toolbar .filter-select {
            flex: 0 0 auto;
            min-width: 0;
        ...
        #tiktokshop-listing-toolbar .filter-select:focus {
            outline: none;
            border-color: #4361ee;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.15);
        }

        #tiktokshop-listing-toolbar .toolbar-actions {
            display: flex;
            flex: 0 0 auto;
            align-items: center;
            margin-left: 0;
        ...
        #tiktokshop-listing-toolbar .listing-io-btn {
            border-radius: 5px;
            font-weight: 600;
            font-size: 14px;
            width: 32px;
        ...
        #tiktokshop-listing-toolbar .listing-io-btn::after {
            display: none;
        }

        #tiktokshop-listing-toolbar .listing-io-menu {
            min-width: 42px;
            padding: 4px;
        }

        #tiktokshop-listing-toolbar .listing-io-menu .dropdown-item {
            display: flex;
            align-items: center;
            justify-content: center;
            width: 34px;
        ...
        #tiktokshop-listing-toolbar .listing-io-menu .dropdown-item:hover {
            background: #f1f5f9;
        }
        ...
        /* ========== DROPDOWNS ========== */
        #tiktokshop-listing-wrap select.nr-req-dropdown,
        #tiktokshop-listing-wrap select.listed-dropdown {
        ...
        #tiktokshop-listing-wrap select.nr-req-dropdown:focus,
        #tiktokshop-listing-wrap select.listed-dropdown:focus {
            outline: none;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.25);
        }

        #tiktokshop-listing-wrap select.nr-req-dropdown[data-val="REQ"],
        #tiktokshop-listing-wrap select.nr-req-dropdown option.req-option {
            background-color: #28a745;
            color: #fff;
        }

        #tiktokshop-listing-wrap select.nr-req-dropdown[data-val="NR"],
        #tiktokshop-listing-wrap select.nr-req-dropdown option.nr-option {
            background-color: #dc3545;
            color: #fff;
        }

        #tiktokshop-listing-wrap select.listed-dropdown[data-val="Listed"],
        #tiktokshop-listing-wrap select.listed-dropdown option.listed-option {
            background-color: #28a745;
            color: #fff;
        }

        #tiktokshop-listing-wrap select.listed-dropdown[data-val="Pending"],
        #tiktokshop-listing-wrap select.listed-dropdown option.pending-option {
            background-color: #dc3545;
            color: #fff;
        }
        ...
        /* ========== LINK CELL ========== */
        #tiktokshop-listing-wrap a.listing-item-link {
            font-weight: 600;
            color: #0d6efd;
            text-decoration: none;
        }

        #tiktokshop-listing-wrap a.listing-item-link:hover {
        ...
        /* ========== PLACEHOLDER ========== */
        #tiktokshop-listing-wrap .tabulator-placeholder {
            color: #64748b;
            font-weight: 600;
            padding: 24px;
        }
    ...
    <div class="row">
        <div class="col-12">
            <div class="card position-relative">
                <div class="card-body">
                    <div id="tiktokshop-listing-toolbar" class="mb-3">
                        <div class="tiktokshop-listing-toolbar-row">
                    ...
                    <div id="tiktokshop-listing-wrap">
                        <div id="tiktokshopListing-table"></div>
                    </div>
...
@section('script')
    ...
    <script>
        ...
        let tiktokshopListingTable = null;
        let allListingData = [];
        ...
        function calculateTotals() {
            try {
                if (!tiktokshopListingTable) {
                    resetMetricsToZero();
                    return;
                }

                const rows = tiktokshopListingTable.getData('active') || [];
                const metrics = {
                    invTotal: 0,
                    reqTotal: 0,
                    nrlTotal: 0,
        ...
        function applyListingFilters() {
            if (!tiktokshopListingTable) return;
            ...
            tiktokshopListingTable.setFilter(function (data) {
        ...
        $(document).ready(function () {
            ...
            tiktokshopListingTable = new Tabulator('#tiktokshopListing-table', {
                ajaxURL: '/listing_tiktokshop/view-data',
            ...
            tiktokshopListingTable.on('dataProcessed', function () {
                hideLoader();
                applyListingFilters();
            });
            tiktokshopListingTable.on('dataFiltered', function () {
                calculateTotals();
            });
            tiktokshopListingTable.on('dataLoadError', function () {
                hideLoader();
            ...
            $(document).on('click', '#confirmImportBtn', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        tiktokshopListingTable.setData('/listing_tiktokshop/view-data');
                    },
                    error: function (xhr) {
                        hideLoader();
    ...
    <script>
        window.listingPageConfig = {
            wrap: '#tiktokshop-listing-wrap',
            tableId: 'tiktokshopListing-table',
            exportName: 'tiktokshop_listing',
            channel: 'tiktokshop',
            channelLabel: "TikTok Shop",
            previewUrl: '/listing_tiktokshop/save-status',
