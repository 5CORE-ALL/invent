...
@section('css')
    ...
    <style>
        ...
        .card-body:has(#ebay2-listing-toolbar) {
            width: 100%;
        }

        #ebay2-listing-wrap .tabulator .tabulator-tableholder {
            background: #fff;
        }

        /* ========== HEADER ========== */
        #ebay2-listing-wrap .tabulator .tabulator-header {
            background: #00d5d5;
            border-bottom: 1px solid #ffffff;
        }

        #ebay2-listing-wrap .tabulator-col .tabulator-col-sorter {
            display: none !important;
        }

        #ebay2-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-content-holder,
        #ebay2-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-title-holder {
        ...
        #ebay2-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-title {
            writing-mode: horizontal-tb !important;
            text-orientation: mixed !important;
            transform: none !important;
            white-space: normal !important;
        ...
        #ebay2-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content {
            height: auto !important;
            min-height: 34px;
            padding: 0;
        }

        #ebay2-listing-wrap .tabulator .tabulator-header .tabulator-col {
            height: auto !important;
            min-height: 34px;
        ...
        #ebay2-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content-holder {
            padding-left: 2px !important;
            padding-right: 2px !important;
        }

        /* Header filters */
        #ebay2-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input {
            width: 100%;
        ...
        #ebay2-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input:focus {
            outline: none;
            border-color: #4361ee;
        ...
        /* ========== ROWS / CELLS ========== */
        #ebay2-listing-wrap .tabulator .tabulator-row {
            min-height: 36px;
            border-bottom: 1px solid #f1f5f9;
        }

        #ebay2-listing-wrap .tabulator .tabulator-row .tabulator-cell {
            padding: 5px 6px !important;
            border-right: 1px solid #f1f5f9;
            vertical-align: middle;
        }

        #ebay2-listing-wrap .tabulator-row .tabulator-cell input[type="checkbox"],
        #ebay2-listing-wrap .tabulator-header .tabulator-col input[type="checkbox"] {
            width: 16px;
            height: 16px;
            cursor: pointer;
            accent-color: #4361ee;
        ...
        #ebay2-listing-wrap .tabulator-row.parent-row .tabulator-cell input[type="checkbox"] {
            display: none;
        }

        #ebay2-listing-wrap .tabulator .tabulator-row:hover {
            background-color: #f8fafc !important;
        }

        #ebay2-listing-wrap .tabulator .tabulator-row.tabulator-row-even {
            background-color: #fcfcfd;
        }

        #ebay2-listing-wrap .tabulator-row.parent-row,
        #ebay2-listing-wrap .tabulator-row.parent-row .tabulator-cell {
            background-color: #fffef2 !important;
            font-weight: 700 !important;
            color: #0f172a;
        }

        #ebay2-listing-wrap .tabulator-row.parent-row:hover,
        #ebay2-listing-wrap .tabulator-row.parent-row:hover .tabulator-cell {
            background-color: #fefce8 !important;
        }

        /* ========== FOOTER / PAGINATION ========== */
        #ebay2-listing-wrap .tabulator .tabulator-footer {
            background: #f8fafc !important;
            border-top: 1px solid #e2e8f0 !important;
            padding: 10px 16px !important;
        }

        #ebay2-listing-wrap .tabulator .tabulator-footer .tabulator-paginator {
            display: flex;
            align-items: center;
        ...
        #ebay2-listing-wrap .tabulator .tabulator-footer .tabulator-paginator label {
            margin-right: 6px;
            font-size: 12px;
            color: #475569;
            font-weight: 600;
        ...
        #ebay2-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page-size {
        ...
        #ebay2-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page {
        ...
        #ebay2-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page:hover {
            background: #f1f5f9 !important;
            border-color: #cbd5e1 !important;
            color: #1e293b !important;
        }

        #ebay2-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page.active {
        ...
        #ebay2-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page[disabled] {
            opacity: 0.4 !important;
            cursor: not-allowed !important;
        }

        #ebay2-listing-wrap .tabulator .tabulator-footer .tabulator-page-counter {
            margin: 0 0.5rem;
            font-size: 12px;
            color: #334155;
        }
        ...
        #ebay2-listing-toolbar .ebay2-listing-toolbar-row {
            display: flex;
            flex-wrap: nowrap;
            align-items: center;
        ...
        #ebay2-listing-toolbar .listing-stat-badges {
            display: inline-flex;
            flex: 0 0 auto;
            align-items: stretch;
            gap: 0;
        ...
        #ebay2-listing-toolbar .listing-stat-badge {
            flex: 0 0 auto;
            justify-content: center;
            margin: 0 !important;
            border-radius: 0;
        ...
        #ebay2-listing-toolbar .listing-stat-badges .listing-stat-badge:first-child {
            border-radius: 8px 0 0 8px;
        }

        #ebay2-listing-toolbar .listing-stat-badges .listing-stat-badge:last-child {
            border-radius: 0 8px 8px 0;
        }

        #ebay2-listing-toolbar .filter-select {
            flex: 0 0 auto;
            min-width: 0;
        ...
        #ebay2-listing-toolbar .filter-select:focus {
            outline: none;
            border-color: #4361ee;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.15);
        }

        #ebay2-listing-toolbar .toolbar-actions {
            display: flex;
            flex: 0 0 auto;
            align-items: center;
            margin-left: 0;
        ...
        #ebay2-listing-toolbar .listing-io-btn {
            border-radius: 5px;
            font-weight: 600;
            font-size: 14px;
            width: 32px;
        ...
        #ebay2-listing-toolbar .listing-io-btn::after {
            display: none;
        }

        #ebay2-listing-toolbar .listing-io-menu {
            min-width: 42px;
            padding: 4px;
        }

        #ebay2-listing-toolbar .listing-io-menu .dropdown-item {
            display: flex;
            align-items: center;
            justify-content: center;
            width: 34px;
        ...
        #ebay2-listing-toolbar .listing-io-menu .dropdown-item:hover {
            background: #f1f5f9;
        }
        ...
        /* ========== DROPDOWNS ========== */
        #ebay2-listing-wrap select.nr-req-dropdown,
        #ebay2-listing-wrap select.listed-dropdown {
        ...
        #ebay2-listing-wrap select.nr-req-dropdown:focus,
        #ebay2-listing-wrap select.listed-dropdown:focus {
            outline: none;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.25);
        }

        #ebay2-listing-wrap select.nr-req-dropdown[data-val="REQ"],
        #ebay2-listing-wrap select.nr-req-dropdown option.req-option {
            background-color: #28a745;
            color: #fff;
        }

        #ebay2-listing-wrap select.nr-req-dropdown[data-val="NR"],
        #ebay2-listing-wrap select.nr-req-dropdown option.nr-option {
            background-color: #dc3545;
            color: #fff;
        }

        #ebay2-listing-wrap select.listed-dropdown[data-val="Listed"],
        #ebay2-listing-wrap select.listed-dropdown option.listed-option {
            background-color: #28a745;
            color: #fff;
        }

        #ebay2-listing-wrap select.listed-dropdown[data-val="Pending"],
        #ebay2-listing-wrap select.listed-dropdown option.pending-option {
            background-color: #dc3545;
            color: #fff;
        }
        ...
        /* ========== LINK CELL ========== */
        #ebay2-listing-wrap a.listing-item-link {
            font-weight: 600;
            color: #0d6efd;
            text-decoration: none;
        }

        #ebay2-listing-wrap a.listing-item-link:hover {
        ...
        /* ========== PLACEHOLDER ========== */
        #ebay2-listing-wrap .tabulator-placeholder {
            color: #64748b;
            font-weight: 600;
            padding: 24px;
        }
            ...
            <div class="card position-relative">
                <div class="card-body">
                    <div id="ebay2-listing-toolbar" class="mb-3">
                        <div class="ebay2-listing-toolbar-row">
                    ...
                    @include('market-places.listing-market-places._listing_publish_modal', ['publishChannel' => 'ebaytwo'])


                    <div id="ebay2-listing-wrap">
                        <div id="eBayTwoListing-table"></div>
                    </div>
...
@section('script')
    ...
    <script>
        ...
        function calculateTotals() {
            try {
                if (!ebay2ListingTable) {
                    resetMetricsToZero();
                    return;
                }

                const rows = ebay2ListingTable.getData('active') || [];
                const metrics = {
                    invTotal: 0,
                    reqTotal: 0,
                    nrlTotal: 0,
        ...
        function applyListingFilters() {
            ...
            ebay2ListingTable.setFilter(function (data) {
        ...
        $(document).ready(function () {
            ...
            ebay2ListingTable = new Tabulator('#eBayTwoListing-table', {
                ajaxURL: '/listing_ebaytwo/view-data',
            ...
            ebay2ListingTable.on('dataProcessed', function () {
                hideLoader();
                applyListingFilters();
            });
            ebay2ListingTable.on('dataFiltered', function () {
                calculateTotals();
            });
            ebay2ListingTable.on('dataLoadError', function () {
                hideLoader();
            ...
            $(document).on('click', '#confirmImportBtn', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        ebay2ListingTable.setData('/listing_ebaytwo/view-data');
                    },
                    error: function (xhr) {
                        hideLoader();
    ...
    <script>
        window.listingPageConfig = {
            wrap: '#ebay2-listing-wrap',
            tableId: 'eBayTwoListing-table',
