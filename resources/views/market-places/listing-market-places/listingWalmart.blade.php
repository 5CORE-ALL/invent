...
@section('css')
    ...
    <style>
        /* ========== TABLE SHELL ========== */
        #walmart-listing-wrap {
            overflow-x: auto;
            overflow-y: visible;
            width: 100%;
        }

        #walmart-listing-wrap .tabulator {
        ...
        .card-body:has(#walmart-listing-toolbar) {
            width: 100%;
        }

        #walmart-listing-wrap .tabulator .tabulator-tableholder {
            background: #fff;
        }

        /* ========== HEADER ========== */
        #walmart-listing-wrap .tabulator .tabulator-header {
            background: #00d5d5;
            border-bottom: 1px solid #ffffff;
        }

        #walmart-listing-wrap .tabulator-col .tabulator-col-sorter {
            display: none !important;
        }

        #walmart-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-content-holder,
        #walmart-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-title-holder {
        ...
        #walmart-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-title {
            writing-mode: horizontal-tb !important;
            text-orientation: mixed !important;
            transform: none !important;
            white-space: normal !important;
        ...
        #walmart-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content {
            height: auto !important;
            min-height: 34px;
            padding: 0;
        }

        #walmart-listing-wrap .tabulator .tabulator-header .tabulator-col {
            height: auto !important;
            min-height: 34px;
        ...
        #walmart-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-col-content-holder {
            padding-left: 2px !important;
            padding-right: 2px !important;
        }

        /* Header filters */
        #walmart-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input {
            width: 100%;
        ...
        #walmart-listing-wrap .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input:focus {
            outline: none;
            border-color: #4361ee;
        ...
        /* ========== ROWS / CELLS ========== */
        #walmart-listing-wrap .tabulator .tabulator-row {
            min-height: 36px;
            border-bottom: 1px solid #f1f5f9;
        }

        #walmart-listing-wrap .tabulator .tabulator-row .tabulator-cell {
            padding: 5px 6px !important;
            border-right: 1px solid #f1f5f9;
            vertical-align: middle;
        }

        #walmart-listing-wrap .tabulator-row .tabulator-cell input[type="checkbox"],
        #walmart-listing-wrap .tabulator-header .tabulator-col input[type="checkbox"] {
            width: 16px;
            height: 16px;
            cursor: pointer;
            accent-color: #4361ee;
        ...
        #walmart-listing-wrap .tabulator-row.parent-row .tabulator-cell input[type="checkbox"] {
            display: none;
        }

        #walmart-listing-wrap .tabulator .tabulator-row:hover {
            background-color: #f8fafc !important;
        }

        #walmart-listing-wrap .tabulator .tabulator-row.tabulator-row-even {
            background-color: #fcfcfd;
        }

        #walmart-listing-wrap .tabulator-row.parent-row,
        #walmart-listing-wrap .tabulator-row.parent-row .tabulator-cell {
            background-color: #fffef2 !important;
            font-weight: 700 !important;
            color: #0f172a;
        }

        #walmart-listing-wrap .tabulator-row.parent-row:hover,
        #walmart-listing-wrap .tabulator-row.parent-row:hover .tabulator-cell {
            background-color: #fefce8 !important;
        }

        /* ========== FOOTER / PAGINATION ========== */
        #walmart-listing-wrap .tabulator .tabulator-footer {
            background: #f8fafc !important;
            border-top: 1px solid #e2e8f0 !important;
            padding: 10px 16px !important;
        }

        #walmart-listing-wrap .tabulator .tabulator-footer .tabulator-paginator {
            display: flex;
            align-items: center;
        ...
        #walmart-listing-wrap .tabulator .tabulator-footer .tabulator-paginator label {
            margin-right: 6px;
            font-size: 12px;
            color: #475569;
            font-weight: 600;
        ...
        #walmart-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page-size {
        ...
        #walmart-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page {
        ...
        #walmart-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page:hover {
            background: #f1f5f9 !important;
            border-color: #cbd5e1 !important;
            color: #1e293b !important;
        }

        #walmart-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page.active {
        ...
        #walmart-listing-wrap .tabulator .tabulator-footer .tabulator-paginator .tabulator-page[disabled] {
            opacity: 0.4 !important;
            cursor: not-allowed !important;
        }

        #walmart-listing-wrap .tabulator .tabulator-footer .tabulator-page-counter {
            margin: 0 0.5rem;
            font-size: 12px;
            color: #334155;
        }
        ...
        #walmart-listing-toolbar .walmart-listing-toolbar-row {
            display: flex;
            flex-wrap: nowrap;
            align-items: center;
        ...
        #walmart-listing-toolbar .listing-stat-badges {
            display: inline-flex;
            flex: 0 0 auto;
            align-items: stretch;
            gap: 0;
        ...
        #walmart-listing-toolbar .listing-stat-badge {
            flex: 0 0 auto;
            justify-content: center;
            margin: 0 !important;
            border-radius: 0;
        ...
        #walmart-listing-toolbar .listing-stat-badges .listing-stat-badge:first-child {
            border-radius: 8px 0 0 8px;
        }

        #walmart-listing-toolbar .listing-stat-badges .listing-stat-badge:last-child {
            border-radius: 0 8px 8px 0;
        }

        #walmart-listing-toolbar .filter-select {
            flex: 0 0 auto;
            min-width: 0;
        ...
        #walmart-listing-toolbar .filter-select:focus {
            outline: none;
            border-color: #4361ee;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.15);
        }

        #walmart-listing-toolbar .toolbar-actions {
            display: flex;
            flex: 0 0 auto;
            align-items: center;
            margin-left: 0;
        ...
        #walmart-listing-toolbar .listing-io-btn {
            border-radius: 5px;
            font-weight: 600;
            font-size: 14px;
            width: 32px;
        ...
        #walmart-listing-toolbar .listing-io-btn::after {
            display: none;
        }

        #walmart-listing-toolbar .listing-io-menu {
            min-width: 42px;
            padding: 4px;
        }

        #walmart-listing-toolbar .listing-io-menu .dropdown-item {
            display: flex;
            align-items: center;
            justify-content: center;
            width: 34px;
        ...
        #walmart-listing-toolbar .listing-io-menu .dropdown-item:hover {
            background: #f1f5f9;
        }
        ...
        /* ========== DROPDOWNS ========== */
        #walmart-listing-wrap select.nr-req-dropdown,
        #walmart-listing-wrap select.listed-dropdown {
        ...
        #walmart-listing-wrap select.nr-req-dropdown:focus,
        #walmart-listing-wrap select.listed-dropdown:focus {
            outline: none;
            box-shadow: 0 0 0 2px rgba(67, 97, 238, 0.25);
        }

        #walmart-listing-wrap select.nr-req-dropdown[data-val="REQ"],
        #walmart-listing-wrap select.nr-req-dropdown option.req-option {
            background-color: #28a745;
            color: #fff;
        }

        #walmart-listing-wrap select.nr-req-dropdown[data-val="NR"],
        #walmart-listing-wrap select.nr-req-dropdown option.nr-option {
            background-color: #dc3545;
            color: #fff;
        }

        #walmart-listing-wrap select.listed-dropdown[data-val="Listed"],
        #walmart-listing-wrap select.listed-dropdown option.listed-option {
            background-color: #28a745;
            color: #fff;
        }

        #walmart-listing-wrap select.listed-dropdown[data-val="Pending"],
        #walmart-listing-wrap select.listed-dropdown option.pending-option {
            background-color: #dc3545;
            color: #fff;
        }
        ...
        /* ========== LINK CELL ========== */
        #walmart-listing-wrap a.listing-item-link {
            font-weight: 600;
            color: #0d6efd;
            text-decoration: none;
        }

        #walmart-listing-wrap a.listing-item-link:hover {
        ...
        /* ========== PLACEHOLDER ========== */
        #walmart-listing-wrap .tabulator-placeholder {
            color: #64748b;
            font-weight: 600;
            padding: 24px;
        }
    ...
    <div class="row">
        <div class="col-12">
            <div class="card position-relative">
                <div class="card-body">
                    <div id="walmart-listing-toolbar" class="mb-3">
                        <div class="walmart-listing-toolbar-row">
                    ...
                    <div id="walmart-listing-wrap">
                        <div id="walmartListing-table"></div>
                    </div>
...
@section('script')
    ...
    <script>
        ...
        function calculateTotals() {
            try {
                if (!walmartListingTable) {
                    resetMetricsToZero();
                    return;
                }

                const rows = walmartListingTable.getData('active') || [];
                const metrics = {
                    invTotal: 0,
                    reqTotal: 0,
                    nrlTotal: 0,
        ...
        function applyListingFilters() {
            ...
            walmartListingTable.setFilter(function (data) {
        ...
        $(document).ready(function () {
            ...
            walmartListingTable = new Tabulator('#walmartListing-table', {
                ajaxURL: '/listing_walmart/view-data',
            ...
            walmartListingTable.on('dataProcessed', function () {
                hideLoader();
                applyListingFilters();
            });
            walmartListingTable.on('dataFiltered', function () {
                calculateTotals();
            });
            walmartListingTable.on('dataLoadError', function () {
                hideLoader();
            ...
            $(document).on('click', '#confirmImportBtn', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        walmartListingTable.setData('/listing_walmart/view-data');
                    },
                    error: function (xhr) {
                        hideLoader();
    ...
    <script>
        window.listingPageConfig = {
            wrap: '#walmart-listing-wrap',
            tableId: 'walmartListing-table',
            exportName: 'walmart_listing',
            channel: 'walmart',
            channelLabel: "Walmart",
            previewUrl: '/listing_walmart/save-status',
            publishUrl: '/listing_walmart/save-status'
        };
    </script>
