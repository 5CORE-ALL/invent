                ...
                <div class="card-body">
                    <div class="d-flex flex-wrap align-items-center gap-2 mb-2">
                        <div class="d-flex align-items-center flex-wrap gap-2 py-1">
                            ...
                            <span class="shein-stat-badge shein-stat-badge--mismatch" title="Parents with missing or excess SKUs">MISMATCH:<span id="shein-lvv-badge-mismatch">0</span></span>
                        </div>
        ...
        $(document).ready(function () {
            sheinLvvTable = new Tabulator('#shein-listing-variation-verify-table', {
                ...
                rowFormatter: function (row) {
                    row.getElement().classList.add('shein-lvv-parent-row');
                },
                columns: [
                    {
                        title: 'Parent',
