            ...
            <div class="card">
                <div class="card-body d-flex align-items-center" style="gap: 12px;">
                    ...
                    <div class="d-inline-flex align-items-center ms-auto">
                        <button id="uploadDailyDataBtn" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#uploadDailyDataModal">
                            <i class="fa fa-upload me-1"></i> Upload Daily Data
                        </button>
                    </div>
                </div>
            </div>
    ...
    `);
            ...
            $('#startUploadBtn').on('click', function() {
                ...
                if (!validTypes.includes(file.type)) {
                    showNotification('danger', 'Please select a valid Excel or CSV file');
                    return;
                }
                ...
                // Chunk settings
                const totalChunks = 5; // Divide file processing into 5 chunks
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                if (currentChunk < totalChunks - 1) {
                                    currentChunk++;
                                    setTimeout(uploadChunk, 500); // Small delay between chunks
                                } else {
                                    // Upload complete
                                    $('#uploadProgressBar')
