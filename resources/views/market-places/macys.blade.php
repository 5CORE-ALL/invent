@extends('layouts.vertical', ['title' => 'Macy', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Macy', 'sub_title' => 'Marketplace'])
    <div class="row">
        <div class="col-12">
            <div class="card">
                    ...
                    <div id="percent-edit-div" class="d-flex align-items-center">
                        <div class="input-group" style="width: 150px;">
                            <input type="number" id="updateAllSkusPercent" class="form-control" min="0"
                                max="100" value="{{ $macysPercentage }}" step="0.01" title="Percent" disabled />
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Macy Product Analysis</h4>
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-3 align-items-center justify-content-between">
                        <div class="d-flex flex-wrap gap-2 align-items-center">
                            ...
                            <!-- A Dil% Filter -->
                            <div class="dropdown manual-dropdown-container ">
                                <button class="btn btn-light dropdown-toggle" type="button" id="mDilFilterDropdown">
                                    <span class="status-circle default"></span> M DIL%
                                </button>
                                <ul class="dropdown-menu" aria-labelledby="mDilFilterDropdown">
                        ...
                        <div class="d-flex flex-wrap gap-2 align-items-center">
                            <!-- Export Button -->
                            <a href="{{ route('macys.analytics.export') }}" class="btn btn-success">
                                <i class="fas fa-file-export me-1"></i> Export Live/Listings
                            </a>

                            <!-- Import Button -->
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#macysImportModal">
                    ...
                    <div class="modal fade" id="macysImportModal" tabindex="-1" aria-labelledby="macysImportModalLabel"
                        ...
                        <div class="modal-dialog">
                            <form action="{{ route('macys.analytics.import') }}" method="POST"
                                ...
                                @csrf
                                <div class="modal-header">
                                    <h5 class="modal-title" id="macysImportModalLabel">Import Macy's Data</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    ...
                                    <div class="alert alert-info">
                                        <small>
                                            ...
                                            Download the <a href="{{ route('macys.analytics.sample') }}"
                    ...
                    <div class="table-container">
                        <table class="custom-resizable-table" id="macy-table">
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="ml_30" style="vertical-align: middle; white-space: nowrap;">
                                        <div class="d-flex flex-column align-items-center" style="gap: 4px">
                                            <div class="d-flex align-items-center">
                                                ML 30 <span class="sort-arrow">↓</span>
                                            </div>
                                            <div style="width: 100%; height: 5px; background-color: #9ec7f4;"></div>
                                            <div class="metric-total" id="ml30-total">0</div>
                                        </div>
                                    </th>
                                    <th data-field="m_dil" style="vertical-align: middle; white-space: nowrap;">
                                        <div class="d-flex flex-column align-items-center" style="gap: 4px">
                                            <div class="d-flex align-items-center">
                                                M DIL <span class="sort-arrow">↓</span>
                                            </div>
                                            <div style="width: 100%; height: 5px; background-color: #9ec7f4;"></div>
                                            <div class="metric-total" id="mDil-total">0%</div>
                                        </div>
                                    </th>
                                    <th>NRL</th>
                                    ...
                                    <th data-field="lmp1" style="vertical-align: middle; white-space: nowrap;">
                                        <div class="d-flex flex-column align-items-center">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <th data-field="scvr" style="vertical-align: middle; white-space: nowrap;">
                                        <div class="d-flex flex-column align-items-center" style="gap: 4px">
                                            <div class="d-flex align-items-center">
                    ...
                    <div id="data-loader" class="card-loader-overlay" style="display: none;">
                        <div class="loader-content">
                            ...
                            <div class="loader-text">Loading Macy's data...</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            const statusIndicatorFields = {
                ...
                'advertisement view': ['CtrY', 'ACOS', 'TACOS'],
                'conversion view': ['CvrY'],
                'view': ['CtrY']
            };
                        ...
                        if (response && response.product_master_data) {
                            tableData = response.product_master_data.map((item, index) => {
                                ...
                                return {
                                    sl_no: index + 1,
                                    'Sr no': index + 1,
                                    Parent: item.parent || item.Parent || sheet.Parent || sheet[
                                        'Parent_ASIN'] || '(No Parent)',
                                    sku: item.sku || sheet['(Child) sku'] || '',
                                    'R&A': sheet['R&A'] || '',
                                    INV: item.INV || 0,
                                    L30: item.L30 || 0,
                                    'Dil%': sheet['DIL%'] || 0,
            ...
            function renderTable() {
                ...
                filteredData.forEach(item => {
                    ...
                    const getDilColor = (value) => {
                        ...
                        if (percent >= 10 && percent < 13.33) return 'yellow';
                        if (percent >= 13.33 && percent < 20) return 'blue';
                    ...
                    const getTacosColor = (value) => {
                        ...
                        if (percent > 5 && percent <= 12) return 'green';
                        if (percent > 12 && percent <= 20) return 'yellow';
                        return 'red';
                    };
                    ...
                    $row.append($('<td>').html(
                        `<span class="dil-percent-value ${getDilColor(item['Dil%'] || 0)}">
                            ${Math.round((item['Dil%'] || 0) * 100)}%
                        </span>
                    ...
                    // $row.append($('<td>').text(item.m_l30));
                    $row.append($('<td>').html(`
                        <div class="sku-tooltip-container">
                            <span class="sku-text">${item.m_l30}</span>
                            <div class="sku-tooltip">
                                <div class="sku-link"><strong>L60:</strong> ${item.m_l60}</div>
                            </div>
                        </div>
                    `));

                    // M DIL with color coding
                    $row.append($('<td>').html(
                        `<span class="dil-percent-value ${getDilColor(item['M DIL%'] || 0)}">
                            ${Math.round((item['M DIL%'] || 0) * 100)}%
                        </span>`
                    ));
                    ...
                    // lmp 1
                    $row.append($('<td>').text(item['LMP 1']));

                    // TACOS with color coding and tooltip
                    $row.append($('<td>').html(
                        `<span class="dil-percent-value ${getTacosColor(item.Tacos30)}">${Math.round(item.Tacos30 * 100)}%</span>
            ...
            function initRAEditHandlers() {
                $(document).on('click', '.edit-icon', function(e) {
                    ...
                    const rowData = filteredData.find(item => item['Sr no'] == $row.find('td:eq(0)')
                        .text());
                    ...
                    switch (type.toLowerCase()) {
                        case 'conversion view':
                            fieldsToDisplay = [{
                                ...
                                {
                                    title: 'AD CLICKS',
                                    content: selectedItem['AD CLICKS']
                                },
                                {
                                    title: 'AD SOLD',
                                    content: selectedItem['AD SOLD']
                                },
                                {
                                    title: 'AD CVR',
                                    content: selectedItem['AD CVR']
                                }
                            ];
                            break;
                        ...
                        case 'price view':
                            fieldsToDisplay = [{
                                ...
                                {
                                    title: 'S MSRP',
                                    content: dataToUse['S MSRP']
                                },
                                {
                                    title: 'AMZ PRICE',
                                    content: selectedItem['AMZ PRICE']
                                },
                                {
                                    title: 'AMZ PRICE',
                                    content: dataToUse['AMZ PRICE']
                                },
                                {
                                    title: '% DIS',
                                    content: dataToUse['% DIS']
                                ...
                                {
                                    title: 'sPFT%',
                                    content: dataToUse['sPFT%'] !== undefined && dataToUse['sPFT%'] !==
                                        null && !
                                        isNaN(dataToUse['sPFT%']) ?
                                        (Math.abs(dataToUse['sFT%']) < 1 ?
                                            (dataToUse['sPFT%'] * 100).toFixed(2) :
                                            dataToUse['sPFT%'].toFixed(2)
                                        ) + ' %' : '0 %'
                                },
                                {
                                    title: 'SRoi%',
                                ...
                                {
                                    title: 'lmp2',
                                    content: dataToUse['lmp2']
                                },
                                {
                                    title: 'c link 2',
                                    content: dataToUse['c link 2']
                                }
                            ];
                            break;
                        case 'advertisement view':
                            fieldsToDisplay = [{
                                ...
                                {
                                    title: 'AD SALES',
                                    content: selectedItem['AD SALES']
                                },
                                {
                                    title: 'ACOS',
                                    content: selectedItem['ACOS']
                                },
                                {
                                    title: 'TACOS',
                                    content: selectedItem['TACOS']
                                }
                            ];
                            break;
                        case 'wmpnm view':
            ...
            function createFieldCard(field, data, type, itemId) {
                const hyperlinkFields = ['C link', 'c link 2'];

                const percentageFields = ['ROI%', 'SROI', 'Ebay', 'CtrY', 'PFT%', 'CtrY',
                    'TACOS', 'ACOS', 'AD CVR', 'TPFT', 'SRoi%'
                ];
                ...
                const getIndicatorColor = (fieldTitle, fieldValue) => {
                    ...
                    if (type === 'price view') {
                        // PFT%, sPFT% fields (same ranges)
                        if (['PFT%', 'sPFT%'].includes(fieldTitle)) {
                            if (value < 10) return 'red';
                            if (value >= 10 && value < 20) return 'yellow';
                            if (value >= 20 && value < 25) return 'blue';
                            if (value >= 25 && value < 40) return 'green';
                            if (value >= 40) return 'pink';
                        }
                        // TPFT field (different ranges)
                        if (fieldTitle === 'TPFT') {
                            if (value <= 10) return 'red';
                        ...
                        // ROI% and SRoi% fields (same ranges)
                        if (['ROI%', 'SRoi%'].includes(fieldTitle)) {
                    ...
                    if (type === 'advertisement view') {
                        ...
                        // TACOS fields (only direct 'TACOS' checks)
                        if (fieldTitle === 'TACOS') {
                            if (value < 5) return 'pink';
                            if (value >= 5 && value < 12) return 'green';
                            if (value >= 12 && value < 20) return 'yellow';
            ...
            function setupEditHandlers(modalId) {
                ...
                const editableFields = ['Promotion', '% DIS', 'S MSRP', 'sPrice', 'LMP 1', 'C link', 'lmp2',
                    'c link 2'
                ];
            ...
            function saveChanges(contentElement, title, slNo, isHyperlink, updatedValue, isCheckbox, rowElement) {
                ...
                macyDataCache.updateField(itemId, title, cacheUpdateValue);

                // 2. Update the filteredData array to reflect the change
                const index = filteredData.findIndex(item => item['Sr no'] == itemId);
                if (index !== -1) {
                    ...
                    if (title === 'sPrice' && filteredData[index].raw_data) {
                        ...
                        const WT = parseFloat(item.raw_data.WT) || 0;
                        const LP = parseFloat(item.raw_data.LP) || 0;
                        const SPRICE = parseFloat(updatedValue) || 0;

                        // Calculate Spft% using formula: (SPRICE * AMZ - SHIP - LP) / SPRICE
                        let Spft = 0;
                        if (SPRICE !== 0) {
                            Spft = (SPRICE * 0.77 - LP - WT) / SPRICE;
                        }

                        // Update Spft% in cache and local data
                        macyDataCache.updateField(itemId, 'sPFT%', Spft);
                ...
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        ...
                        // Revert cache
                        macyDataCache.updateField(itemId, title, originalValue);
            ...
            function calculateTotals() {
                try {
                    ...
                    filteredData.forEach((item, index) => {
                        ...
                        metrics.eDilTotal += parseFloat(item['M Dil%']) || 0;
                    ...
                    $('#ml30-total').text(metrics.el30Total.toLocaleString());
                    $('#mDil-total').text(Math.round(metrics.eDilTotal / divisor * 100) + '%');
