@extends('layouts.vertical', ['title' => 'Amz FBM Pricing KW', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
@section('css')
...
@section('content')
    @include('layouts.shared.page-title', [
        'page_title' => 'Amz FBM - AD CVR',
        'sub_title' => 'Amz FBM - AD CVR',
    ])
    <div class="row">
        <div class="col-12">
                    ...
                    },
                    {
                        ...
                        cellClick: function (e, cell) {
                            ...
                            if (target.classList.contains("info-icon")) {
                                ...
                                const percentage = {{ $amazonPercentage ?? 0 }};
                                const costPercentage = percentage + amazonAdUpdates;
                                ...
                                let popupTableHTML = `
                                    <table class="popup-inner-table">
                                        ...
                                        <tr>
                                            <th>SPRICE</th>
                                            <td>
                                                <input type="number" id="sprice-input" value="${parseFloat(rowData.amz_price ?? 0).toFixed(2)}" style="width:80px; margin-right:6px;" />
                                        ...
                                        <tr><th>SPFT%</th><td>${fmtColored(rowData.amz_pft, getColorProfit(rowData.amz_pft))}</td></tr>
                                        <tr><th>SROI%</th><td>${fmtColored(rowData.amz_roi, getColorProfit(rowData.amz_roi))}</td></tr>
                                    </table>
                                `;
                                ...
                                popup.querySelector("#approve-sprice").addEventListener("click", async function () {
                                    ...
                                    try {
                                        const res = await fetch("/update-amazon-price", {
                                            method: "POST",
                                            headers: {
                                        ...
                                        if (data.status === 200) {
                                            ...
                                            alert("Price updated successfully! Please refresh...");
