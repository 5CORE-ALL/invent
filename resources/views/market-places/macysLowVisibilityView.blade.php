@extends('layouts.vertical', ['title' => 'Macy Low View', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Macy Low View', 'sub_title' => 'Marketplace'])
    {{-- <div class="row">
        <div class="col-12">
            <div class="card">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Macy Low View</h4>
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-3">
                        ...
                        <!-- Loe view div after create task -->
                    ...
                    <div class="table-container">
                        <table class="custom-resizable-table" id="macyLowVisibility-table">
                            <thead>
                                <tr>
                    ...
                    <div id="data-loader" class="card-loader-overlay" style="display: none;">
                        <div class="loader-content">
                            ...
                            <div class="loader-text">Loading Macy Low View's data...</div>
                        </div>
                    </div>
                </div>
            </div>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // Cache system
            const macyLowVisibilityDataCache = {
                cache: {},
            ...
            window.addEventListener('load', function() {
                macyLowVisibilityDataCache.clear();
            });
            ...
            function checkParentRAStatus() {
             ...
             // Update the Loe view count using tableData directly (no Sess30 or views field needed)
            function updateZeroViewDiv() {
                // Count all rows in tableData
                const zeroCount = tableData.length;
                $('#zero-view-div').html(`Loe view - ${zeroCount}`);
            }
            ...
            function loadData() {
                showLoader();
                return $.ajax({
                    url: '/Macy/low-visibility/view-data',
                    type: 'GET',
                    dataType: 'json',
                    success: function(response) {
                        if (response && response.product_master_data) {
                            ...
                            window.macyLowVisibilitySheetData = response.sheet_data;
                            filteredData = [...tableData];
                        }
                    },
            ...
            function renderTable() {
                const $tbody = $('#macyLowVisibility-table tbody');
                ...
                filteredData.forEach(item => {
                    ...
                    $row.append($('<td>').html(`
                        ...
                        data-slno="${item['Sr no'] || item['sl_no']}" data-type="reason"></i>
                    `));
                    ...
                    $row.append($('<td>').html(`
                        ...
                        <i class="fas fa-plus reason-action-plus" style="cursor:pointer; color:#007bff; margin-left:8px;" 
                        data-slno="${item['Sr no'] || item['sl_no']}" data-type="action_required"></i>
                    `));
                    ...
                    $row.append($('<td>').html(`
                        ...
                        <i class="fas fa-plus reason-action-plus" style="cursor:pointer; color:#007bff; margin-left:8px;" 
                        data-slno="${item['Sr no'] || item['sl_no']}" data-type="action_taken"></i>
                    `));
            ...
            function initNREditHandlers() {
                ...
                $(document).on('click', '.nr-edit-container .nr-edit-icon, .nr-edit-container .fa-save', function(
                    ...
                    const rowData = filteredData.find(item => item['Sr no'] == slNo || item['SL No.'] ==
                        slNo);
            ...
            window.openModal = function(selectedItem, type) {
                try {
                    ...
                    const cachedData = macyLowVisibilityDataCache.get(itemId);
                    const dataToUse = cachedData || itemData;

                    // Store the data in cache if it wasn't already
                    if (!cachedData) {
                        macyLowVisibilityDataCache.set(itemId, itemData);
                    }
            ...
            function saveChanges(contentElement, title, slNo, isHyperlink, updatedValue, isCheckbox, rowElement) {
                ...
                macyLowVisibilityDataCache.updateField(itemId, title, cacheUpdateValue);
                ...
                if (index !== -1) {
                    ...
                    if (title === 'sPrice' && filteredData[index].raw_data) {
                        ...
                        macyLowVisibilityDataCache.updateField(itemId, 'sPFT%', Spft);
                ...
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        ...
                        // Revert cache
                        macyLowVisibilityDataCache.updateField(itemId, title, originalValue);
            ...
            function initResizableColumns() {
                const $table = $('#macyLowVisibility-table');
            ...
            $(document).on('click', '.reason-action-plus', function() {
                ...
                const row = filteredData.find(item => item['Sr no'] == slNo || item['sl_no'] == slNo);
            ...
            $('#saveReasonActionBtn').on('click', function() {
                ...
                const row = filteredData.find(item => item['Sr no'] == slNo);
                const sku = row ? row['sku'] : null;

                // Update data in filteredData and tableData
                [filteredData, tableData].forEach(arr => {
                    const row = arr.find(item => item['Sr no'] == slNo || item['sl_no'] == slNo);
                    if (row) {
                ...
                if (sku) {
                    $.ajax({
                        url: '/macy-low-visibility/reason-action/update',
                        method: 'POST',
                        data: {
                            sku: sku,
                            reason: reason,
