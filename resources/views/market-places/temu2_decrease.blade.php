...
@section('css')
    ...
    <style>
        ...
        @include('partials.ebay-sprc-dil', ['ebaySprcDilPart' => 'css', 'ebaySprcDilChannel' => 'temu2'])
    </style>
@endsection
...
@section('content')
        ...
        <div class="card shadow-sm">
            <div class="card-body py-2 d-flex flex-column">
                <div class="d-flex align-items-center flex-wrap gap-2" id="ebay-filter-bar">
                    ...
                    @include('partials.ebay-sprc-dil', ['ebaySprcDilPart' => 'buttons', 'ebaySprcDilChannel' => 'temu2'])
                ...
                <div id="summary-stats" class="mt-2 p-3 bg-light rounded">
                    <div class="ebay2-summary-badge-row" role="group" aria-label="Summary metrics">
                        ...
                        <span class="badge bg-danger fs-6 p-2 temu-badge-history" id="avg-cvr-badge"
                            ...
                            style="color: white; font-weight: bold; cursor: pointer;"
                            title="CVR = (Sold / Views) × 100 — Views from temu2_view_data, once per Goods ID">CVR: 0%</span>
    ...
    @include('partials.ebay-sprc-dil', ['ebaySprcDilPart' => 'modals', 'ebaySprcDilChannel' => 'temu2'])
@endsection
...
<script>
    ...
    const TEMU2_COL_CAT_STORAGE = 'temu2_decrease_col_cats_v1';
    let table = null;
    ...
    @include('partials.ebay-sprc-dil', ['ebaySprcDilPart' => 'script', 'ebaySprcDilChannel' => 'temu2'])
    ...
    const TEMU_SPRICE_BATCH_URL = '/temu2-pricing/save-sprice-batch';
    ...
    $(document).ready(function() {
        ...
        function updateSummary() {
            ...
            if (window.PriceGtLmpBadge && table) {
                PriceGtLmpBadge.update('#temu2-price-gt-lmp-badge', table.getData(), 'temu2', 'temu_price', function (row) {
            ...
            columns: [
                ...
                },
                {
                    ...
                    formatter: function(cell) {
                        ...
                        let displayPrice = +temu2FullPriceFromBase(basePrice).toFixed(2);
                        const sprice = typeof temuSpriceShownValue === 'function' ? temuSpriceShownValue(rowData) : 0;
                        if (sprice > 0 && typeof temuListingBasesMatch === 'function' && temuListingBasesMatch(rowData, sprice)) {
                            displayPrice = +Number(sprice).toFixed(2);
                        }
