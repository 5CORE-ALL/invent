...
@section('css')
    ...
    <style>
        ...
        @include('partials.ebay-sprc-dil', ['ebaySprcDilPart' => 'css', 'ebaySprcDilChannel' => 'doba_withoutship'])
    </style>
@endsection
...
@section('content')
        ...
        <div class="card shadow-sm">
            <div class="card-body py-1">
                ...
                <div class="d-flex flex-wrap align-items-center gap-1 mb-1 w-100">
                    ...
                    @include('partials.ebay-sprc-dil', ['ebaySprcDilPart' => 'buttons', 'ebaySprcDilChannel' => 'doba_withoutship'])
    ...
    @include('partials.ebay-sprc-dil', ['ebaySprcDilPart' => 'modals', 'ebaySprcDilChannel' => 'doba_withoutship'])
@endsection
        ...
        $(document).ready(function() {
            ...
            function applyFilters() {
                ...
                if (priceGtLmpFilterActive && window.PriceGtLmpBadge) {
                    table.addFilter(function(data) {
                        return PriceGtLmpBadge.hasRedTriangle(data, 'self_pick_price');
                    });
                }
            ...
            if (window.PriceGtLmpBadge) {
                PriceGtLmpBadge.bind({
                    badge: '#dobawithoutship-price-gt-lmp-badge',
            ...
            if (window.PriceLt80LmpBadge) {
                PriceLt80LmpBadge.bind({
                    badge: '#dobawithoutship-price-lt80-lmp-badge',
            ...
            function updateSummary() {
                ...
                if (window.PriceGtLmpBadge && table) {
                    PriceGtLmpBadge.update('#dobawithoutship-price-gt-lmp-badge', table.getData(), 'dobawithoutship', 'self_pick_price');
                if (window.PriceLt80LmpBadge) {
            ...
            function buildColumnDropdown() {
                if (window.AnalyticsColVis) {
                    window.AnalyticsColVis.install({
                        ...
                        storageKey: 'doba_withoutship_col_cats_v1',
