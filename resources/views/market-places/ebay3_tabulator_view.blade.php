            ...
            <div class="card-body py-1 d-flex flex-column">
                ...
                <div id="summary-stats" class="bg-light rounded">
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        @include('partials.analytics-dil-badge', ['dilChannel' => 'ebay3'])
                        ...
                        <span class="badge fs-6 p-2" id="ebay3-lmp-missing-badge"
                            ...
                            LMP M. 0</span>
                        <span class="badge fs-6 p-2" id="ebay3-purple-triangle-badge"
                            style="background-color:#28a745;color:#fff;font-weight:700;cursor:pointer;"
...
<script>
    ...
    function ebay3SgroiAtPrice(rowData, price) {
        ...
        let margin = (isFinite(marginRaw) && marginRaw > 0) ? marginRaw : EBAY3_TAKEHOME;
    ...
    function ebay3SpriceAmount(rowData) {
        if (typeof ebay3DisplayedSprice === 'function') {
            const shown = ebay3DisplayedSprice(rowData);
        ...
        function saveSpriceWithRetry(sku, sprice, row, retryCount = 0, skipClear) {
            if (row && Number(sprice) > 0) {
                sprice = (typeof chPromoFinalSpriceToSave === 'function')
                    ...
                    : (typeof ebay3CapSpriceToLmp === 'function'
                        ? ebay3CapSpriceToLmp(row.getData(), sprice)
    ...
    $(document).ready(function() {
        ...
        function ebay3RowSpriceForAlert(data) {
            ...
            if (typeof ebay3DisplayedSprice === 'function') {
                const shown = ebay3DisplayedSprice(data);
                if (shown > 0) return shown;
            }
            if (typeof chPromoSavedOrLiveSprice === 'function') {
        ...
        $('#ebay3-lmp-missing-badge').on('click', function() {
        ...
        $('#ebay3-purple-triangle-badge').on('click', function() {
        ...
        table = new Tabulator("#ebay3-table", {
            ...
            columns: [
                ...
                @include('partials.analytics-sku-reviews-column', ['marketplace' => 'ebay3'])
                {
                    title: "L7 View",
                    field: "l7_views",
                    hozAlign: "center",
                ...
                },
                {
                    ...
                    formatter: function(cell) {
                        ...
                        return `$${value.toFixed(2)}` + purpleTri;
                    },
                    width: 80
                },
                {
                ...
                },
                {
                    ...
                    headerSort: true,
                    sorter: function(a, b, aRow, bRow) {
                        const av = (typeof ebay3SpriceAmount === 'function')
                            ? (ebay3SpriceAmount(aRow.getData()) || 0)
                            : (parseFloat(a) || 0);
                        const bv = (typeof ebay3SpriceAmount === 'function')
                            ? (ebay3SpriceAmount(bRow.getData()) || 0)
                            : (parseFloat(b) || 0);
                        return av - bv;
                    },
                    editable: false,
                    ...
                    formatter: function(cell) {
                        ...
                        const sgroiAtLmp = (typeof ebay3SgroiAtPrice === 'function')
                            ? ebay3SgroiAtPrice(rowData, lmpNow)
                            : null;
                        const ebayPrice = parseFloat(rowData['eBay Price']) || 0;
                ...
                },
                {
                    ...
                    formatter: function(cell) {
                        const rowData = cell.getRow().getData();
                        const sprice = ebay3SpriceAmount(rowData);
