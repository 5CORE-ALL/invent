@extends('layouts.vertical', ['title' => 'Amz FBM Pricing PT', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
@section('css')
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        formatter: function(cell){
                            ...
                            let cvr = Number.isInteger(value) ? value.toFixed(0) : value.toFixed(2);
                            let color = "";
                    ...
                    },
                    {
                        ...
                        hozAlign: "right",
                        formatter: function(cell) {
                            let acos_L90 = parseFloat(cell.getValue() || 0).toFixed(0);
                            return `
                                <span>${acos_L90 + "%"}</span>
                    ...
                    },
                    {
                        ...
                        hozAlign: "right",
                        formatter: function(cell) {
                            let spend_l90 = parseFloat(cell.getValue() || 0).toFixed(0);
                            return `
                                <span>${spend_l90}</span>
                    ...
                    },
                    {
                        ...
                        hozAlign: "right",
                        formatter: function(cell) {
                            let ad_sales_l90 = parseFloat(cell.getValue() || 0).toFixed(0);
                            return `
                                <span>${ad_sales_l90}</span>
                                <i class="fa fa-info-circle text-primary toggle-sales-cols-btn" 
                                data-lmp="${ad_sales_l90}" 
                                style="cursor:pointer; margin-left:8px;"></i>
                            `;
                        }
                    },
                    ...
                    },
                    {
                        ...
                        hozAlign: "right",
                        formatter: function(cell) {
                            let clicks_L90 = parseFloat(cell.getValue() || 0).toFixed(0);
                            return `
                                <span>${clicks_L90}</span>
