@extends('layouts.vertical', ['title' => 'Tiktok', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Tiktok', 'sub_title' => 'Market Place'])
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Tiktok Product Analysis</h4>
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-3 align-items-center justify-content-between">
                        ...
                        <div class="d-flex flex-wrap gap-2 align-items-center">
                            <!-- Export Button -->
                            <a href="{{ route('tiktok.analytics.export') }}" class="btn btn-success">
                                <i class="fas fa-file-export me-1"></i> Export Live/Listings
                            </a>

                            <!-- Import Button -->
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#tiktokImportModal">
                                <i class="fas fa-file-import me-1"></i> Import Live/Listings
                            </button>
                        </div>
                    </div>

                    <div class="modal fade" id="tiktokImportModal" tabindex="-1"
                        aria-labelledby="tiktokImportModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <form action="{{ route('tiktok.analytics.import') }}" method="POST"
                                enctype="multipart/form-data" class="modal-content" id="tiktokImportForm">
                                @csrf
                                <div class="modal-header">
                                    <h5 class="modal-title" id="tiktokImportModalLabel">Import TikTok Data</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <!-- File Input -->
                                    <div class="mb-3">
                                        <label for="tiktokExcelFile" class="form-label">Select Excel File</label>
                                        <input type="file" class="form-control" id="tiktokExcelFile"
                                    ...
                                    <div class="alert alert-info">
                                        <small>
                                            ...
                                            Download the <a href="{{ route('tiktok.analytics.sample') }}"
                    ...
                    <div id="data-loader" class="card-loader-overlay" style="display: none;">
                        <div class="loader-content">
                            ...
                            <div class="loader-text">Loading Tiktok data...</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        $(document).ready(function() {
            ...
            function renderTable() {
                ...
                filteredData.forEach(item => {
                    ...
                    $row.append($('<td>').html(`
                     <div class="sku-tooltip-container">
                     <span class="sku-text">${item.t_l30 || 0}</span>
                     <div class="sku-tooltip">
                    <div class="sku-link"><strong>Sheet L30:</strong> ${item.t_l30 || 0}</div>
                     </div>
                     </div>
                      `));
                ...
                try {
                    ...
                    filteredData.forEach(item => {
                        ...
                        if (
                            ...
                            const tSalesL30 = item.raw_data && item.t_l30 ? parseFloat(
                                item.t_l30) : 0;
