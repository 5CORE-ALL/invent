            ...
            <div class="modal-content">
                <div class="modal-header py-2" style="background:#ffc107;">
                    <h5 class="modal-title text-dark d-flex align-items-center flex-wrap gap-2 mb-0" id="spriceCvrRuleModalLabel">
                        ...
                        <span class="badge sprice-cvr-header-metric-badge ebay2-sprice-cvr-badge sprice-cvr-badge-bad"
...
@endsection
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // eBay2: CVR L30 vs prior L31–L60 (CVR L60) + band rules.
            ...
            function amazonRowCvrL30(rd) {
                if (!rd) return 0;
                // eBay2: SCVR is precomputed CVR L30 %
            ...
            function amazonRowCvrL60(rd) {
                if (!rd) return 0;
                // eBay2: CVR_60 is prior-period (L31–L60) CVR %
            ...
            function saveSpriceCvrDailySnapshot() {
                // eBay2: live pies only — do not overwrite Amazon daily stats table
                return;
                if (!table) return;
                const s = readSpriceCvrSlabInputs();
            ...
            $(document).on('click', '.sprice-cvr-metric-history-dot', function(e) {
                ...
                if (!metric || typeof showEbay2MetricChart !== 'function') return;
                showEbay2MetricChart(metric);
            });
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        formatter: function(cell) {
                            ...
                            if (ebay2Price > 0 && sprice > 0 && ebay2Price.toFixed(2) === sprice.toFixed(2)) {
                    ...
                    },
                    {
                        ...
                        hozAlign: "center",
                        width: 90,
                        headerTooltip: "Daily adjustment of the current C BID by L7 View band — green keeps C Bid, pink/red apply the direction + %/day set in the 'Sbid (Views)' button — clamped to the Min/Max caps. No C Bid → —. Same as /ebay2/campaign-ads.",
                        sorter: function(a, b, aRow, bRow) {
