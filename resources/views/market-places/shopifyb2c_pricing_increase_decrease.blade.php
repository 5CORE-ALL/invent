@extends('layouts.vertical', ['title' => 'Shopify B2C Pricing - Increase/Decrease', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Shopify B2C', 'sub_title' => 'Marketplace'])
    <div class="row">
        <div class="col-12">
            <div class="card">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Shopify B2C Product Analysis</h4>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="pft" style="vertical-align: middle; white-space: nowrap;">
                                        <div class="d-flex flex-column align-items-center">
                                            <div class="d-flex align-items-center" style="gap: 4px">
                                                LMP 4 <span class="sort-arrow">↓</span>
                                            </div>
                                            <div style="width: 100%; height: 5px; background-color: #9ec7f4;"></div>
                                            <div class="metric-total" id="pft-total">0%</div>
                                        </div>
                                    ...
                                    <th data-field="pft" style="vertical-align: middle; white-space: nowrap;">
                                        ...
                                        <div class="d-flex flex-column align-items-center">
                                            <div class="d-flex align-items-center" style="gap: 4px">
                                                LINK 4 <span class="sort-arrow">↓</span>
                                            </div>
                                            <div style="width: 100%; height: 5px; background-color: #9ec7f4;"></div>
                                            <div class="metric-total" id="pft-total">0%</div>
                                        </div>
                    ...
                    <div id="data-loader" class="card-loader-overlay" style="display: none;">
                        <div class="loader-content">
                            ...
                            <div class="loader-text">Loading Shopify B2C data...</div>
                        </div>
                    </div>
                </div>
            </div>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function loadData() {
                showLoader();
                return $.ajax({
                    url: '/shopifyB2C-data-view',
                    type: 'GET',
                    dataType: 'json',
                    success: function(response) {
                        if (response && response.data) {
                            // 1. No filtering — include all rows even if INV = 0 or views = 0
            ...
            function renderTable() {
                ...
                filteredData.forEach(item => {
                    ...
                    if (item.is_parent) {
                        ...
                        // Add checkbox with pen icon for editing NR
                        const $container = $(
                            '<div class="nr-edit-container d-flex align-items-center"></div>');
                        const $checkbox = $('<input type="checkbox" class="nr-checkbox" disabled />')
                            .prop('checked', item['NR'] === true || item['NR'] === 'true' || item['NR'] ===
                                '1')
                            .data('original-value', item['NR']);
                        const $editIcon = $(
                            '<i class="fas fa-pen nr-edit-icon ml-2 text-primary" style="cursor:pointer" title="Edit NR"></i>'
                        );
                        $container.append($checkbox, $editIcon);
                    ...
                    // ✅ PFT % Column (only percentage, no eye button)
                    $row.append($('<td>').html(
                        typeof item['PFT %'] === 'number' && !isNaN(item['PFT %']) ?
                        `
    <span class="dil-percent-value ${getPftColor(item['PFT %'])}">
        ${Math.round(item['PFT %'] * 100)}%
    </span>
    ` : ''
                    ));
                    ...
                    // ✅ SPRICE Column (with edit button)
    ...
    ` : '0'
                    ...
                    for (let i = 1; i <= 4; i++) {
                        $row.append($('<td>').html(
                            typeof item[`LMP ${i}`] === 'number' && !isNaN(item[`LMP ${i}`]) ?
                            `
            <span class="dil-percent-value ${getPftColor(item[`LMP ${i}`])}">
                ${Math.round(item[`LMP ${i}`])}
            </span>
        ` : ''
                        ));
                    }
                    ...
                    $row.append($('<td>').html(
                        item['L 1'] ? `
        <a href="${item['L 1']}" target="_blank" title="Open Link">
    ...
    `
                    ...
                    $row.append($('<td>').html(
                        item['L2'] ? `
        <a href="${item['L2']}" target="_blank" title="Open Link">
            <i class="fa fa-link"></i>
        </a>
    ` : `
        <span style="color: red; font-weight: bold;">✘</span>
    `
                    ...
                    $row.append($('<td>').html(
                        item['L 3'] ? `
        <a href="${item['L 3']}" target="_blank" title="Open Link">
            <i class="fa fa-link"></i>
        </a>
    ` : `
        <span style="color: red; font-weight: bold;">✘</span>  
    `
                    ...
                    $row.append($('<td>').html(
                        item['L4'] ? `
        <a href="${item['L4']}" target="_blank" title="Open Link">
            <i class="fa fa-link"></i>
        </a>
    ` : `
        <span style="color: red; font-weight: bold;">✘</span>
                    ...
                    switch (type.toLowerCase()) {
                        case 'conversion view':
                            fieldsToDisplay = [{
                                ...
                                {
                                    title: 'SldY',
                                    content: selectedItem['SldY']
                                },
                                {
                                    title: 'Sld60',
                                    content: selectedItem['Sld60']
                                },
                                {
                                    title: 'Sld30',
                                    content: selectedItem['Sld30']
                                },
                                {
                                    title: 'SldL7',
                                    content: selectedItem['SldL7']
                                },
                                {
                                    title: 'CvrY',
                                    content: selectedItem['CvrY']
                                },
                                {
                                    title: 'CvrL60',
                                    content: selectedItem['CvrL60']
                                },
                                {
                                    title: 'CvrL30',
                                    content: selectedItem['CvrL30']
                                },
                                {
                                    title: 'CvrL7',
                                    content: selectedItem['CvrL7']
                                }
                            ];
                            break;
                        ...
                        case 'price view':
                            fieldsToDisplay = [{
                                ...
                                {
                                    title: 'amazon',
                                    content: selectedItem['amazon']
                                },
                                {
                                    title: 'Ebay',
                                    content: selectedItem['Ebay']
                                },
                                {
                                    title: 'S Price',
                                    content: dataToUse['S Price']
                                },
                                {
                                    title: 'SPFT %',
                                    content: dataToUse['SPFT %'] !== 0 ?
                                        (Math.abs(dataToUse['SPFT %']) < 100 ?
                        ...
                        case 'advertisement view':
                            fieldsToDisplay = [{
                                ...
                                {
                                    title: 'SpndY',
                                    content: selectedItem['SpndY']
                                },
                                {
                                    title: 'SpndL60',
                                    content: selectedItem['SpndL60']
                                },
                                {
                                    title: 'SpndL30',
                                    content: selectedItem['SpndL30']
                                },
                                {
                                    title: 'SpndL7',
                                    content: selectedItem['SpndL7']
                                },
                                {
                                    title: 'CtrY',
                                    content: selectedItem['CtrY']
                                ...
                                {
                                    title: 'CpcY',
                                    content: selectedItem['CpcY']
                                },
                                {
                                    title: 'CPC 60',
                                    content: selectedItem['CPC 60']
                                },
                                {
                                    title: 'CPC 30',
                                    content: selectedItem['CPC 30']
                                },
                                {
                                    title: 'CPC 7',
                                    content: selectedItem['CPC 7']
                                },
                                {
                                    title: 'SldY',
                                    content: selectedItem['SldY']
                                ...
                                {
                                    title: 'SlsY',
                                    content: selectedItem['SlsY']
                                },
                                {
                                    title: 'SlsL60',
                                    content: selectedItem['SlsL60']
                                },
                                {
                                    title: 'SlsL30',
                                    content: selectedItem['SlsL30']
                                },
                                {
                                    title: 'SlsL30',
                                    content: selectedItem['SlsL30']
                                ...
                                {
                                    title: 'AcosY',
                                    content: selectedItem['AcosY']
                                },
                                {
                                    title: 'AcosL60',
                                    content: selectedItem['AcosL60']
                                },
                                {
                                    title: 'AcosL30',
                                    content: selectedItem['AcosL30']
                                },
                                {
                                    title: 'AcosL7',
                                    content: selectedItem['AcosL7']
                                },
                                {
                                    title: 'CvrY',
                                    content: selectedItem['CvrY']
                ...
                <div class="modal fade" id="pricingModal" tabindex="-1" aria-labelledby="pricingModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content p-3">
                            ...
                            <div class="modal-body">
                                <form id="pricingForm" method="POST" action="{{ url('//save-sprice') }}">
                                    @csrf
    ...
    <script>
        function openPricingModal({
            ...
            // 🟢 This sets the SKU hidden input correctly
            $('#skuInput').val(SKU);
            ...
            $sprInput.off('input').on('input', function() {
                ...
                if (SPRICE > 0) {
                    const SPFT = ((SPRICE * 0.72) - LP - SH) / SPRICE;
                    const SROI = ((SPRICE * 0.72) - LP - SH) / LP;
