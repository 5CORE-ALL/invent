                ...
                <div class="card-body">
                    <div class="d-flex flex-wrap align-items-center gap-2 mb-2">
                        <div class="d-flex align-items-center flex-wrap gap-2 py-1">
                            ...
                            <span class="shopify-b2c-stat-badge shopify-b2c-stat-badge--mismatch" title="Parents with missing or excess SKUs">MISMATCH:<span id="shopify-b2c-lvv-badge-mismatch">0</span></span>
                        </div>
        ...
        $(document).ready(function () {
            shopifyB2cLvvTable = new Tabulator('#shopify-b2c-listing-variation-verify-table', {
                ...
                rowFormatter: function (row) {
                    row.getElement().classList.add('shopify-b2c-lvv-parent-row');
                },
                columns: [
                    {
                        title: 'Parent',
