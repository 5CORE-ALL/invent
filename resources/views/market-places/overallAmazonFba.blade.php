...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Amz FBA Analysis', 'sub_title' => 'Amz'])
    {{-- <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Amz FBA Analysis</h4>
                    ...
                    <div id="data-loader" class="card-loader-overlay" style="display: none;">
                        <div class="loader-content">
                            ...
                            <div class="loader-text">Loading Amz FBA data...</div>
                        </div>
                    </div>
                </div>
            </div>
