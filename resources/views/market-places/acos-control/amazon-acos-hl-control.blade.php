@extends('layouts.vertical', ['title' => 'Amazon - ACOS CONTROL HL', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
@section('css')
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.addEventListener("change", function(e){
                ...
                if(e.target.classList.contains("campaign-status-toggle")){
                    ...
                    fetch('/toggle-amazon-sb-campaign-status', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
            ...
            document.getElementById("apr-all-sbid-btn").addEventListener("click", function(){
                ...
                fetch('/update-amazon-sb-campaign-bgt-price', {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
