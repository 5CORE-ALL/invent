@extends('layouts.vertical', ['title' => 'Temu', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Temu', 'sub_title' => 'MArket Place'])
                ...
                <div class="card-body">
                        ...
                        <table class="custom-resizable-table" id="temu-table">
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="ovDil" style="vertical-align: middle; white-space: nowrap;">
                                        <div class="d-flex flex-column align-items-center" style="gap: 4px">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <th data-field="views_l30" style="vertical-align: middle; white-space: nowrap;">
                                        <div class="d-flex flex-column align-items-center" style="gap: 4px">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <th data-field="sales_l30" style="vertical-align: middle; white-space: nowrap;">
                                        <div class="d-flex flex-column align-items-center" style="gap: 4px">
                                            <div class="d-flex align-items-center">
                                                Sales L30 <span class="sort-arrow">↓</span>
                                            </div>
                                            <div style="width: 100%; height: 5px; background-color: #9ec7f4;"></div>
                                            <div class="metric-total" id="sales-l30-total">0</div>
                                        </div>
                                    </th>
                                    <th data-field="growth" style="vertical-align: middle; white-space: nowrap;">
                                        <div class="d-flex flex-column align-items-center">
                                            <div class="d-flex align-items-center">
                                                Growth <span class="sort-arrow">↓</span>
                                            </div>
                                        </div>
                                    </th>
                                    ...
                                    <th data-field="SPRICE" style="vertical-align: middle; white-space: nowrap;">
                                        <div class="d-flex flex-column align-items-center" style="gap: 4px">
                                            ...
                                            <div style="width: 100%; height: 5px; background-color: #9ec7f4;"></div>
                                            <div class="metric-total" id="sprice-total">0</div>
                                        </div>
                                    </th>
                                    <th data-field="SPFT" style="vertical-align: middle; white-space: nowrap;">
                                        <div class="d-flex flex-column align-items-center" style="gap: 4px">
                                            <div class="d-flex align-items-center sortable-header">
                                                SPROFIT <span class="sort-arrow">↓</span>
                                            </div>
                                            <div style="width: 100%; height: 5px; background-color: #9ec7f4;"></div>
                                            <div class="metric-total" id="spft-total">0%</div>
                                        </div>
                                    </th>
                                    <th data-field="SROI" style="vertical-align: middle; white-space: nowrap;">
                                        <div class="d-flex flex-column align-items-center" style="gap: 4px">
                                            ...
                                            <div style="width: 100%; height: 5px; background-color: #9ec7f4;"></div>
                                            <div class="metric-total" id="sroi-total">0%</div>
                                        </div>
                                    </th>
                                    ...
                                    <th data-field="ship" style="vertical-align: middle; white-space: nowrap;">
                                        <div class="d-flex flex-column align-items-center">
                                            <div class="d-flex align-items-center">
                                                SHIP <span class="sort-arrow">↓</span>
                                            </div>
                                        </div>
                                    </th>
                                </tr>
                    ...
                    <div id="data-loader" class="card-loader-overlay" style="display: none;">
                        <div class="loader-content">
                            ...
                            <div class="loader-text">Loading Temu data...</div>
                        </div>
                    </div>
                </div>
            </div>
...
@section('script')
        ...
        $(document).ready(function() {
                    ...
                    success: function(response) {
                        ...
                        if (response && response.data) {
                            tableData = response.data.map((item, index) => {
                                ...
                                const tl30 = parseFloat(item.sales_l30) || 0; // Temu L30 sales
                                const tl60 = parseFloat(item.sales_l60) || 0; // Temu L60 sales
                                ...
                                return {
                                    ...
                                    sales_l30: tl30,
                                    sales_l60: tl60,
                                    clicks_l30: item.clicks_l30 || 0,
                                    clicks_l60: item.clicks_l60 || 0,
                                    ...
                                    LP: item.LP || 0,
                                    CVR: item.CVR || 0,
                                    // Additional Temu-specific metrics
                                    impressions_l30: item.product_impressions_l30 || 0,
                                    impressions_l60: item.product_impressions_l60 || 0,
                                    clicks_l30: item.product_clicks_l30 || 0,
                                    clicks_l60: item.product_clicks_l60 || 0,
                                    base_price: item.base_price || 0,
                                    SPRICE: (item.SPRICE !== null && !isNaN(parseFloat(item
                                            .SPRICE))) ?
                                        parseFloat(item.SPRICE) : 0,
                                    SPFT: (item.SPFT !== null && !isNaN(parseFloat(item
                                            .SPFT))) ?
                                        parseFloat(item.SPFT) : 0,
                                    SROI: (item.SROI !== null && !isNaN(parseFloat(item
                                            .SROI))) ?
                                        parseFloat(item.SROI) : 0,
            ...
            function renderTable() {
                ...
                filteredData.forEach(item => {
                    ...
                    $row.append($('<td>').html(`
                        <div class="sku-tooltip-container">
                            <span class="sku-text">${item.views_l30 || 0}</span>
                            <div class="sku-tooltip">
                                <div class="sku-link"><strong>L60:</strong> ${item.views_l60 || 0}</div>
                                <div class="sku-link"><strong>Clicks L30:</strong> ${item.clicks_l30 || 0}</div>
                                <div class="sku-link"><strong>Clicks L60:</strong> ${item.clicks_l60 || 0}</div>
                            </div>
                        </div>
                    `));

                    // Add sales_l30 with tooltip showing l60 data
                    $row.append($('<td>').html(`
                        <div class="sku-tooltip-container">
                            <span class="sku-text">${item.sales_l30 || 0}</span>
                            <div class="sku-tooltip">
                                <div class="sku-link"><strong>L60:</strong> ${item.sales_l60 || 0}</div>
                                <div class="sku-link"><strong>Growth:</strong> ${item.growth ? (item.growth * 100).toFixed(1) + '%' : '-'}</div>
                            </div>
                        </div>
                    `));
                    ...
                    // Growth percentage
                    $row.append($('<td>').html(
                        (parseFloat(item.sales_l30) !== 0 && !isNaN(item.sales_l30) && !isNaN(item
                            .sales_l60)) ?
                        `<span>${(((item.sales_l30 - item.sales_l60) / item.sales_l30) * 100).toFixed(1)}%</span>` :
                        '<span>-</span>'
                    ));

                    // T DIL with color coding
                    $row.append($('<td>').html(
                        `<span class="dil-percent-value ${getDilColor(item.tDil)}">${Math.round(item.tDil * 100)}%</span>`
                    ));
                    ...
                    // PFT percentage with color coding
                    $row.append($('<td>').html(
                        typeof item['PFT_percentage'] === 'number' && !isNaN(item[
                            'PFT_percentage']) ?
                        `<span class="dil-percent-value ${getPftColor(item['PFT_percentage'])}">${item['PFT_percentage']}%</span>` :
                        ''
                    ));
    ...
    ` : ''
                    ...
                    $row.append($('<td>').html(
                        ...
                        `<span class="dil-percent-value ${getRoiColor(parseFloat(item.SPFT) / 100)}">${Math.round(parseFloat(item.SPFT))}%</span>` :
                        ''
                    ));
                    ...
                    $row.append($('<td>').html(
                        ...
                        `<span class="dil-percent-value ${getRoiColor(parseFloat(item.SROI) / 100)}">${Math.round(parseFloat(item.SROI))}%</span>` :
                        ''
                    ));
    ...
    <span class="text-info tooltip-icon conversion-view-trigger" 
        ...
        data-item='${JSON.stringify(item.raw_data)}'>C</span>`
                    ...
                    $row.append($('<td>').html(
                        ...
                        `<span class="dil-percent-value" style="background-color: purple; color: #fff; padding:2px 6px; border-radius:4px; font-weight:600;">
                        ${Math.round(parseFloat(item.SHIP))}
                         </span>` :
                        ''
                    ));
...
<div class="mb-2">
    <label>SHIP ($)</label>
    <input type="number" step="0.01" class="form-control" id="shipInput" name="ship">
</div>
    ...
    `);
            ...
            function initSorting() {
                // Bind click only to th[data-field], not the input/search areas
                $('#temu-table thead').on('click', 'th[data-field]', function(e) {
                    if ($(e.target).is('input') || $(e.target).closest('.dropdown-search-container')
                        .length) {
                        return; // don’t sort when typing/searching
                    }

                    const th = $(this);
                    let dataField = th.data('field');

                    // Map HTML data-field → actual dataset key
                    const fieldMap = {
                        sl_no: "sl_no",
                        parent: "parent",
                        sku: "sku",
                        ...
                        growth: "growth",
                        tDil: "tDil",
                        price_wo_ship: "price_wo_ship",
                        price: "price",
                        pft_percentage: "pft_percentage",
                    ...
                    dataField = fieldMap[dataField] || dataField;
                    ...
                    // Reset all arrows
                    $('#temu-table .sort-arrow').text('↓');
                    // Update only the clicked th arrow
                    th.find('.sort-arrow').text(currentSort.direction === 1 ? '↑' : '↓');
            ...
            $(document).on('click', '.openPricingBtn', function() {
                ...
                $('#skuInput').val(SKU);
                $('#shipInput').val(SHIP); // modal me prefill karo
                ...
                $sprInput.off('input').on('input', function() {
                    ...
                    const shipVal = parseFloat($('#shipInput').val()) || 0; // latest SHIP value

                    if (SPRICE > 0) {
                        const SPFT = ((SPRICE * 0.90) - LP - shipVal) / SPRICE;
                        const SROI = ((SPRICE * 0.90) - LP - shipVal) / LP;
                ...
                // Agar user ship change kare to bhi recalc ho jaye
                $('#shipInput').off('input').on('input', function() {
                    $sprInput.trigger('input'); // SPRICE calculation ko dobara chalaye
                });
            ...
            $(document).on('click', '#savePricingBtn', function() {
                ...
                const shipVal = parseFloat($('#shipInput').val()) || 0; // ship bhi lo
                ...
                $.ajax({
                    url: '/temu/save-sprice',
                    type: 'POST',
                    data: {
                        _token: $('meta[name="csrf-token"]').attr('content'),
                        sku: sku,
                        sprice: sprice,
                        ship: shipVal, // ship bhejna
                        spft_percent: spft,
                        sroi_percent: sroi
                    },
                    dataType: 'json',
                    ...
                    success: function(response) {
                        ...
                        filteredData.forEach(item => {
                            console.log(item);
                            if (item.Sku === sku) {
                                item.SPRICE = parseFloat(sprice);
                                item.SPFT = parseFloat(spft);
                                item.SROI = parseFloat(sroi);
                                item.SHIP = parseFloat(shipVal); // ✅ new
                            }
                        });
                        calculateTotals();
