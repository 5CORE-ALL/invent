...
<div id="raw-images-card" class="p-3 bg-white rounded shadow-sm border dashboard-badge-panel">
    ...
    <div class="dashboard-badge-panel__body">
        ...
        <div class="dashboard-badge-panel__badges">
            ...
            <span class="badge fs-6 p-2" style="background-color:#0f766e;color:#fff;font-weight:bold;cursor:pointer;" onclick="window.location.href='{{ route('raw.images.hero.2') }}'" role="button" title="Hero Image 2 — SKU count">Hero Image 2 SKUs: {{ number_format((int) ($riHero2['sku_count'] ?? 0)) }}</span>
            <span class="badge bg-danger text-white fs-6 p-2" style="font-weight:bold;cursor:pointer;" onclick="window.location.href='{{ route('raw.images.hero.2') }}'" role="button" title="SKUs missing Hero Image 2">Missing Hero Image 2: {{ number_format((int) ($riHero2['missing'] ?? 0)) }}</span>
        </div>
    </div>
</div>
