...
<div id="advertisement-card" class="col-12 p-3 bg-white rounded shadow-sm border dashboard-badge-panel">
    ...
    <div class="dashboard-badge-panel__body">
        ...
        <div class="dashboard-badge-panel__badges">
            ...
            <span class="badge fs-6 p-2" style="background-color:#ef4444;color:#fff;font-weight:bold;cursor:pointer;" onclick="window.location.href='{{ route('advertisement.master') }}'" role="button" title="Total ad spend on active channels">SPEND: {{ $fmtAdmDollar($adm['spend']) }}</span>
            ...
            <span class="badge fs-6 p-2" style="background-color:#0d9488;color:#fff;font-weight:bold;cursor:pointer;" onclick="window.location.href='{{ route('advertisement.master') }}'" role="button" title="Sum of L30 Sales on active channels">TOTAL SALES: {{ $fmtAdmDollar($adm['ssales']) }}</span>
...
<div id="raw-images-card" class="col-12 p-3 bg-white rounded shadow-sm border dashboard-badge-panel">
    ...
    <div class="dashboard-badge-panel__body">
        ...
        <div class="dashboard-badge-panel__badges">
            ...
            <span class="badge bg-danger text-white fs-6 p-2" style="font-weight:bold;cursor:pointer;" onclick="window.location.href='{{ route('raw.images.batch.coo') }}'" role="button" title="SKUs with inventory missing Batch +COO (0 INV excluded)">Missing Batch +COO: {{ number_format((int) ($riBatch['missing'] ?? 0)) }}</span>
