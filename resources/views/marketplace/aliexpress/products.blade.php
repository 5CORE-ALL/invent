...
<div class="row">
    <div class="col-12">
        ...
        <p class="text-muted mb-3">
            ...
            <strong>Active &amp; Matched</strong> / <strong>Inactive &amp; Matched</strong> = qty matched, split by AE status.
...
document.getElementById('btn-sync-mismatch-now')?.addEventListener('click', function () {
    var btn = this;
    if (!confirm('Sync all Mismatch SKUs from live Shopify → AliExpress right now (no queue)? This runs in batches and may take a few minutes.')) {
        return;
    }
    btn.disabled = true;
