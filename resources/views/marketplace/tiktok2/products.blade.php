...
<div class="row">
    <div class="col-12">
        ...
        @include('marketplace._page-heading', ['slug' => 'tiktok2', 'heading' => 'TikTok 2 Listings', 'mb' => 'mb-3'])
        <p class="text-muted mb-3">Listings from <code>tiktok_products_two</code> (Shop API sync).</p>
...
document.getElementById('btn-refresh-api')?.addEventListener('click', async function () {
    ...
    try {
        const res = await fetch(@json(route('marketplace.manager.tiktok2.refresh')), {
            method: 'POST',
