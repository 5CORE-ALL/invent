...
@include('marketplace._sync-mismatch-now', [
    'url' => route('marketplace.manager.doba.sync.mismatch.inventory'),
    'confirm' => 'Push the actual live Shopify quantity to every Inv SKU Mismatch on Doba right now (batched, no queue)?',
    'limit' => 25,
])
