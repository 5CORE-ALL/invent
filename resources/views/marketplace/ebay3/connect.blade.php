@extends('layouts.vertical', ['title' => $title ?? 'eBay 3 — Connect', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
<div class="row">
    <div class="col-12">
        ...
        @include('marketplace._page-heading', ['slug' => 'ebay3', 'heading' => 'eBay 3 — Connect', 'mb' => 'mb-3'])

        @include('marketplace.ebay3._nav', ['active' => 'connect'])
        ...
        @if($credentialsReady ?? false)
            <div class="alert alert-success d-flex align-items-start gap-2">
                ...
                <div>
                    ...
                    <p class="mb-0 small">EBAY_3_* keys are configured. Click <strong>Test connection</strong> to verify (bearer token + GetItem).</p>
                </div>
            </div>
        @else
            <div class="alert alert-warning">
                <strong>Setup required</strong> — add <code>EBAY_3_APP_ID</code>, <code>EBAY_3_CERT_ID</code>, <code>EBAY_3_DEV_ID</code>, and <code>EBAY_3_REFRESH_TOKEN</code> to <code>.env</code>, then refresh.
            </div>
        @endif
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-3">
                            Credentials are read from <code>.env</code> / <code>config/services.php</code> → <code>ebay3</code>.
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span class="cred-miss">Missing — <code>EBAY_3_APP_ID</code></span>
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span class="cred-miss">Missing — <code>EBAY_3_CERT_ID</code></span>
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span class="cred-miss">Missing — <code>EBAY_3_DEV_ID</code></span>
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span class="cred-miss">Missing — <code>EBAY_3_REFRESH_TOKEN</code></span>
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <button type="button" class="btn btn-primary" id="ebay3-test-connection">
                            <i class="ri-plink"></i> Test connection
                        </button>
                        <div id="ebay3-test-result" class="mt-3" style="display:none;"></div>
                    </div>
                </div>
            </div>
        </div>
...
<script>
(function () {
    const btn = document.getElementById('ebay3-test-connection');
    const box = document.getElementById('ebay3-test-result');
    if (!btn || !box) return;
    btn.addEventListener('click', async function () {
        ...
        try {
            const res = await fetch('{{ route('marketplace.manager.ebay3.test') }}', {
                method: 'POST',
                headers: {
