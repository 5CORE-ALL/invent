...
<div class="row">
    <div class="col-12">
        ...
        <p class="text-muted mb-3">Orders stored locally from Wayfair API. Push to Shopify manually or enable auto-import in <a href="{{ route('marketplace.settings', 'wayfair') }}">Settings</a>.</p>
