...
<div class="row">
    <div class="col-12">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-start gap-2 mt-2 mb-1">
            ...
            <div class="d-flex gap-2">
                @if(!empty($shopify['shopify_order_id']))
                    @include('marketplace._fetch-tracking-button', ['fetchTrackingMarketplace' => 'tiktok'])
                @endif
        ...
        <div class="alert alert-info py-2 small mb-3">
            ...
            After you buy/download a shipping label in Shopify, use <strong>Push tracking to TikTok</strong> so TikTok is marked shipped with that tracking number.@include('marketplace._fetch-tracking-hint')
        </div>
