...
<div class="row">
    <div class="col-12">
        ...
        <p class="text-muted mb-3">
            ...
            <strong>Active SKU / Inactive SKU</strong> = qty matched, split by Temu status.
            <strong>Active SKU Mismatch / Inactive SKU Mismatch</strong> = qty differs, split by Temu status.
