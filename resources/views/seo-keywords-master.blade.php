@extends('layouts.vertical', ['title' => 'SEO Keywords master', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    ...
    @include('layouts.shared.page-title', [
        'page_title' => 'SEO Keywords master',
        'sub_title' => 'SEO Keywords master Analysis',
    ])
            ...
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" id="customSearch" class="form-control"
                                    placeholder="Search SEO keywords...">
                    ...
                    <div class="table-responsive">
                        <table id="seo-keywords-master-datatable" class="table dt-responsive nowrap w-100">
                            <thead>
                                <tr>
                                    <th>Image</th>
                                    <th>
                    ...
                    <div id="rainbow-loader" class="rainbow-loader">
                        ...
                        <div class="wave"></div>
                        <div class="wave"></div>
                        <div class="loading-text">Loading SEO Keywords master Data...</div>
                    </div>
                </div>
            </div>
        </div>
...
@section('script')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Load SEO keywords data from server
            function loadData() {
                const cacheParam = '?ts=' + new Date().getTime();
                makeRequest('/seo-keywords-master-data-view' + cacheParam, 'GET')
                    .then(response => {
                        if (!response.ok) {
                    ...
                    .catch(error => {
                        console.error('Failed to load SEO keywords data: ' + error.message);
                        document.getElementById('rainbow-loader').style.display = 'none';
                    });
            }
            ...
            function renderTable(data) {
                ...
                if (data.length === 0) {
                    tbody.innerHTML = '<tr><td colspan="6" class="text-center">No SEO keywords found</td></tr>';
                    return;
                }
                ...
                document.getElementById('downloadExcel').addEventListener('click', function() {
                    ...
                    setTimeout(() => {
                        try {
                            ...
                            XLSX.utils.book_append_sheet(wb, ws, "SEO Keywords master");

                            // Generate Excel file and trigger download
                            XLSX.writeFile(wb, "seo_keywords_master_export.xlsx");
