...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('layouts.shared/page-title', ['page_title' => 'Stock Mapping', 'sub_title' => 'View Stock'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                ...
                                <tr>
                                     ...
                                     <th style="vertical-align: middle; white-space: nowrap;">
                                        <div data-field="INV_shopify" class="d-flex flex-column align-items-center sortable">
                                            <div class="d-flex align-items-left">
                                                ...
                                                <a href="<?php echo e(route('listing.shopifyb2c')); ?>" target="_blank"><span class="text-danger text-center mx-auto d-block" id="hShopifynm"></span></a>
                                            </div>
                                        </div>
                                    </th>
                                    ...
                                    <th style="vertical-align: middle; white-space: nowrap;">
                                        <div data-field="INV_amazon" class="d-flex flex-column align-items-center">
                                            ...
                                            <a href="<?php echo e(route('listing.amazon')); ?>" target="_blank"><span class="text-danger text-center mx-auto d-block" id="hAmazonnm"></span></a>
                                        </div>
                                    </th>
                                     ...
                                     <th style="vertical-align: middle; white-space: nowrap;">
                                        <div data-field="INV_wallmart" class="d-flex flex-column align-items-center">
                                            ...
                                            <a href="<?php echo e(route('listing.walmart')); ?>" target="_blank"><span class="text-danger text-center mx-auto d-block" id="hWalmartnm"></span></a>
                                        </div>
                                    </th>
                                     ...
                                     <th style="vertical-align: middle; white-space: nowrap;">                                        
                                        ...
                                        <a href="<?php echo e(route('listing.reverb')); ?>" target="_blank"><span class="text-danger text-center mx-auto d-block" id="hReverbnm"></span></a>
                                    </th>
                                    ...
                                    <th style="vertical-align: middle; white-space: nowrap;">
                                        <div data-field="INV_shein" class="d-flex flex-column align-items-center">
                                            ...
                                            <a href="<?php echo e(route('listing.shein')); ?>" target="_blank"><span class="text-danger text-center mx-auto d-block" id="hSheinnm"></span></a>
                                        </div>
                                    </th>
                                    ...
                                    <th style="vertical-align: middle; white-space: nowrap;">
                                        <div data-field="INV_doba" class="d-flex flex-column align-items-center">
                                            ...
                                            <a href="<?php echo e(route('listing.doba')); ?>" target="_blank"><span class="text-danger text-center mx-auto d-block" id="hDobanm"></span></a>
                                        </div>
                                    </th>
                                    ...
                                    <th style="vertical-align: middle; white-space: nowrap;">
                                        <div data-field="INV_temu" class="d-flex flex-column align-items-center">
                                            ...
                                            <a href="<?php echo e(route('listing.temu')); ?>" target="_blank"><span class="text-danger text-center mx-auto d-block" id="hTemunm"></span></a>
                                        </div>
                                    </th>
                                    ...
                                    <th style="vertical-align: middle; white-space: nowrap;">
                                        <div data-field="INV_macy" class="d-flex flex-column align-items-center">
                                            ...
                                            <a href="<?php echo e(route('listing.macys')); ?>" target="_blank"><span class="text-danger text-center mx-auto d-block" id="hMacynm"></span></a>
                                        </div>
                                    </th>
                                    ...
                                    <th style="vertical-align: middle; white-space: nowrap;">
                                        <div data-field="INV_ebay1" class="d-flex flex-column align-items-center">
                                            ...
                                            <a href="<?php echo e(route('listing.ebay')); ?>" target="_blank"><span class="text-danger text-center mx-auto d-block" id="hEbay1nm"></span></a>
                                        </div>
                                    </th>
                                    <th style="vertical-align: middle; white-space: nowrap;">
                                        <div data-field="INV_ebay2" class="d-flex flex-column align-items-center">
                                            ...
                                            <a href="<?php echo e(route('listing.ebayTwo')); ?>" target="_blank"><span class="text-danger text-center mx-auto d-block" id="hEbay2nm"></span></a>
                                        </div>
                                    </th>
                                    <th style="vertical-align: middle; white-space: nowrap;">
                                        <div data-field="INV_ebay3" class="d-flex flex-column align-items-center">
                                            ...
                                            <a href="<?php echo e(route('listing.ebayThree')); ?>" target="_blank"><span class="text-danger text-center mx-auto d-block" id="hEbay3nm"></span></a>
                                        </div>
                                    </th>
                                    ...
                                    <th style="vertical-align: middle; white-space: nowrap;">
                                        <div data-field="INV_bestbuy" class="d-flex flex-column align-items-center">
                                            ...
                                            <a href="<?php echo e(route('listing.bestbuyusa')); ?>" target="_blank"><span class="text-danger text-center mx-auto d-block" id="hbestbuynm"></span></a>
                                        </div>
                                    </th>
                                    ...
                                    <th style="vertical-align: middle; white-space: nowrap;">
                                        <div data-field="INV_tiendamia" class="d-flex flex-column align-items-center">
                                            ...
                                            <a href="<?php echo e(route('listing.tiendamia')); ?>" target="_blank"><span class="text-danger text-center mx-auto d-block" id="htiendamianm"></span></a>
                                        </div>
                                    </th>
                                </tr>
                                <tr>
    ...
    $(document).ready(function () {
        ...
        function loadData() {
            ...
            return $.ajax({
                ...
                try {
                    const sideBadge = document.getElementById('stockMappingNotMatchingBadge');
                    if (sideBadge) sideBadge.textContent = totalNotMatching.toLocaleString('en-US');
...
<?php echo $__env->make('layouts.vertical', ['title' => 'View Stock Mapping', 'mode' => $mode ?? '', 'demo' => $demo ?? ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\5core_inventory\resources\views/stock_mapping/view-stock-mapping.blade.php ENDPATH**/ ?>