...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-4">
            <div class="card stats-card card-success <?php echo e(($todayUpdates ?? 0) >= 0 ? 'positive' : 'negative'); ?>">
                <div class="card-body text-center">
                    <i class="fas <?php echo e(($todayUpdates ?? 0) >= 0 ? 'fa-arrow-up' : 'fa-arrow-down'); ?> card-icon"></i>
                    <h5 class="card-title">Total Diff (<?php echo e(date('d M Y')); ?>)</h5>
                    <span class="badge" id="todayUpdatesBadge">
                        <?php echo e(($todayUpdates ?? 0) >= 0 ? '+' : ''); ?><?php echo e($todayUpdates ?? 0); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        window.totalSkuCount = <?php echo e($totalSkuCount); ?>;
        window.zeroInvCount = <?php echo e($zeroInvCount); ?>;
    </script>
    ...
    <script>
        ...
        jq(document).ready(function() {
            // Set data
            originalChannelData = <?php echo json_encode($data, 15, 512) ?>;
...
<?php echo $__env->make('layouts.vertical', ['title' => 'Live Pending Master', 'mode' => $mode ?? '', 'demo' => $demo ?? ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\5core_inventory\resources\views/marketing-masters/live-pending-masters.blade.php ENDPATH**/ ?>