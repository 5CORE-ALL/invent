...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('layouts.shared/page-title', ['page_title' => 'Faire Zero View', 'sub_title' => 'Faire'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Faire Zero View</h4>
                    ...
                    <div id="data-loader" class="card-loader-overlay" style="display: none;">
                        <div class="loader-content">
                            ...
                            <div class="loader-text">Loading Faire Zero...</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#saveReasonActionBtn').on('click', function() {
                ...
                if (sku) {
                    $.ajax({
                        url: '/zero_faire/reason-action/update-data',
                        method: 'POST',
                        data: {
                            sku: sku,
                            reason: reason,
...
<?php echo $__env->make('layouts.vertical', ['title' => 'Faire Zero View', 'mode' => $mode ?? '', 'demo' => $demo ?? ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\5core_inventory\resources\views/market-places/zero-market-places/faireZeroView.blade.php ENDPATH**/ ?>