        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $(document).ready(function () {
                ...
                $('#incomingForm').on('submit', function (e) {
                    ...
                    $.ajax({
                        url: '<?php echo e(route("incoming.store")); ?>',
                        method: 'POST',
                        data: formData,
...
<?php echo $__env->make('layouts.vertical', ['title' => 'Incoming', 'mode' => $mode ?? '', 'demo' => $demo ?? ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\5core_inventory\resources\views/inventory-management/incoming-view.blade.php ENDPATH**/ ?>