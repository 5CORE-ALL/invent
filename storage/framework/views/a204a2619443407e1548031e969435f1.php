...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('layouts.shared/page-title', ['page_title' => 'Tiktok', 'sub_title' => 'Market Place'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <div id="percent-edit-div" class="d-flex align-items-center">
                        <div class="input-group" style="width: 150px;">
                            <input type="number" id="updateAllSkusPercent" class="form-control" min="0"
                                max="100" value="<?php echo e($percentage); ?>" step="0.01" title="Percent" disabled />
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-3 align-items-center justify-content-between">
                        ...
                        <div class="d-flex flex-wrap gap-2 align-items-center">
                            <!-- Export Button -->
                            <a href="<?php echo e(route('tiktok.analytics.export')); ?>" class="btn btn-success">
                    ...
                    <div class="modal fade" id="tiktokImportModal" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <form action="<?php echo e(route('tiktok.analytics.import')); ?>" method="POST"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="alert alert-info">
                                        <small>
                                            ...
                                            Download the <a href="<?php echo e(route('tiktok.analytics.sample')); ?>"
...
<?php echo $__env->make('layouts.vertical', ['title' => 'Tiktok', 'mode' => $mode ?? '', 'demo' => $demo ?? ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\5core_inventory\resources\views/market-places/tiktok_analysis.blade.php ENDPATH**/ ?>