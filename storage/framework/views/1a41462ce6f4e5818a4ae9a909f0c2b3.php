                                        ...
                                        <form method="POST" action="<?php echo e(route('login')); ?>">
                                            ...
                                            <div class="text-center mt-4">
                                                ...
                                                <div class="d-flex gap-2 justify-content-center mt-3">
                                                    <a href="<?php echo e(route('auth.google')); ?>" class="btn btn-soft-danger">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <p class="text-dark-emphasis">Don't have an account? <a
                            href="<?php echo e(route('second', ['auth', 'register'])); ?>"
...
<?php /**PATH C:\xampp\htdocs\5core_inventory\resources\views/auth/login.blade.php ENDPATH**/ ?>