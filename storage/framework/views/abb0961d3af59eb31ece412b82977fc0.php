...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('layouts.shared/page-title', [
        'page_title' => 'BestBuy USA Analytics',
        'sub_title' => 'BestBuy USA',
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">BestBuy USA Zero Analytics</h4>
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-3 align-items-center justify-content-between">
                        ...
                        <div class="d-flex flex-wrap gap-2 align-items-center">
                            <!-- Export Button -->
                            <a href="<?php echo e(route('bestbuyusa.analytics.export')); ?>" class="btn btn-success">
                                <i class="fas fa-file-export me-1"></i> Export Live/Listings
                            </a>

                            <!-- Import Button -->
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#bestbuyusaImportModal">
                                <i class="fas fa-file-import me-1"></i> Import Live/Listings
                            </button>
                        </div>
                    </div>

                    <div class="modal fade" id="bestbuyusaImportModal" tabindex="-1"
                        aria-labelledby="bestbuyusaImportModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <form action="<?php echo e(route('bestbuyusa.analytics.import')); ?>" method="POST"
                                enctype="multipart/form-data" class="modal-content" id="bestbuyusaImportForm">
                                <?php echo csrf_field(); ?>
                                <div class="modal-header">
                                    <h5 class="modal-title" id="bestbuyusaImportModalLabel">Import BestBuy USA Data</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <!-- File Input -->
                                    <div class="mb-3">
                                        <label for="bestbuyusaExcelFile" class="form-label">Select Excel File</label>
                                        <input type="file" class="form-control" id="bestbuyusaExcelFile"
                                    ...
                                    <div class="alert alert-info">
                                        <small>
                                            ...
                                            Download the <a href="<?php echo e(route('bestbuyusa.analytics.sample')); ?>"
                    ...
                    <div id="data-loader" class="card-loader-overlay" style="display: none;">
                        <div class="loader-content">
                            ...
                            <div class="loader-text">Loading BestBuy USA Zero...</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <i class="fas fa-check-circle text-success tooltip-icon conversion-view-trigger ms-2"
        ...
        data-item='${JSON.stringify(item.raw_data)}'></i>`
            ...
            $('#saveReasonActionBtn').on('click', function() {
                ...
                if (sku) {
                    $.ajax({
                        url: '/zero_bestbuyusa/reason-action/update-data',
                        method: 'POST',
                        data: {
                            sku: sku,
                            reason: reason,
...
<?php echo $__env->make('layouts.vertical', ['title' => 'BestBuy USA Analytics', 'mode' => $mode ?? '', 'demo' => $demo ?? ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\5core_inventory\resources\views/market-places/zero-market-places/bestbuyUSAAnalytics.blade.php ENDPATH**/ ?>