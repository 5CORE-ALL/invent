...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('layouts.shared.page-title', ['page_title' => 'Categories', 'sub_title' => 'Categories'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div class="card-body">
                        ...
                        <table class="table table-centered table-hover mb-0 border" id="category-table-body">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <div>
                                                    <h5 class="mb-0 fw-semibold"><?php echo e($category->name); ?></h5>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <div
                                                    ...
                                                    <span
                                                        class="fw-semibold text-info"><?php echo e($category->supplier_count); ?></span>
                                        ...
                                        <td class="text-center">
                                            <span
                                                class="badge <?php echo e($category->status === 'active' ? 'bg-success-subtle text-success' : 'bg-danger-subtle text-danger'); ?> px-3 py-2 rounded-pill">
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center align-items-center gap-1">
                                                <a href="#" class="btn btn-soft-primary btn-sm"
                                                    ...
                                                    data-bs-target="#editCategoryModal<?php echo e($category->id); ?>" title="Edit">
                                    ...
                                    <!-- Edit Category Modal -->
                                    <div id="editCategoryModal<?php echo e($category->id); ?>" class="modal fade" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-lg shadow-none">
                                            <div class="modal-content border-0">
                                                ...
                                                <div class="edit-category-container"
                                                    id="edit-container-<?php echo e($category->id); ?>"
                                                    data-category-id="<?php echo e($category->id); ?>">
                                                    <div class="modal-body p-4">
                                                        <!-- Name & Status -->
                                                        <div class="row g-2 mb-3">
                                                            <div class="col-md-6">
                                                                <label for="category_name_<?php echo e($category->id); ?>"
                                                                    class="form-label fw-semibold">
                                                                    Category Name <span class="text-danger">*</span>
                                                                </label>
                                                                <input type="text" class="form-control"
                                                                    id="category_name_<?php echo e($category->id); ?>"
                                                                    name="category_name" value="<?php echo e($category->name); ?>">
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label for="category_status_<?php echo e($category->id); ?>"
                                                                    class="form-label fw-semibold">Status</label>
                                                                <select class="form-select"
                                                                    id="category_status_<?php echo e($category->id); ?>"
                                                                    name="status">
                                                                    <option value="active"
                                                                        <?php if($category->status == 'active'): ?> selected <?php endif; ?>>
                                                                        Active</option>
                                                                    <option value="inactive"
                                                                        <?php if($category->status == 'inactive'): ?> selected <?php endif; ?>>
                                                                        Inactive</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div id="fields-container-<?php echo e($category->id); ?>">
                                                                <?php
                                                                ...
                                                                <?php $__currentLoopData = $decoded_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <div class="row g-2 align-items-center mb-2 field-row">
                                                                        <div class="col-md-4">
                                                                            <input type="text"
                                                                                name="field_label[<?php echo e($category->id); ?>][]"
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <input type="text"
                                                                                name="field_name[<?php echo e($category->id); ?>][]"
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <select
                                                                                name="field_type[<?php echo e($category->id); ?>][]"
                                                                                class="form-select">
                                                                                <option value="text"
                                                                                    <?php echo e(($field['type'] ?? '') == 'text' ? 'selected' : ''); ?>>
                                                                                    Text</option>
                                                                                <option value="number"
                                                                                    <?php echo e(($field['type'] ?? '') == 'number' ? 'selected' : ''); ?>>
                                                                                    Number</option>
                                                                                <option value="textarea"
                                                                                    <?php echo e(($field['type'] ?? '') == 'textarea' ? 'selected' : ''); ?>>
                                                                                    Textarea</option>
                                                                                <option value="select"
                                                                                    <?php echo e(($field['type'] ?? '') == 'select' ? 'selected' : ''); ?>>
                                                                                    Select</option>
                                                                            </select>
                                                                        </div>
                                                            ...
                                                            <button type="button" class="btn btn-sm btn-secondary mt-2"
                                                                onclick="addField('<?php echo e($category->id); ?>', this)">
                                                                + Add Field
                                                            </button>
                                                        </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-primary"
                                                            id="submit-edit-<?php echo e($category->id); ?>">
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <div class="pagination-wrapper" id="pagination-wrapper">
                            <?php echo e($categories->onEachSide(1)->links('pagination::bootstrap-5')); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#bulkDeleteBtn').click(function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('category.bulk-delete')); ?>",
                    method: 'POST',
                    data: {
...
<?php echo $__env->make('layouts.vertical', ['title' => 'Categories', 'mode' => $mode ?? '', 'demo' => $demo ?? ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\5core_inventory\resources\views/purchase-master/category/category_list.blade.php ENDPATH**/ ?>