        ...
        $(document).on('click', '#topSaveBtn', function() {
            ...
            if($btn.attr('id') === 'topPushBtn') {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    data: { sku: sku, price: price, _token: '<?php echo e(csrf_token()); ?>' },
                    success: function(response) {
...
<?php echo $__env->make('layouts.vertical', ['title' => 'Pricing Masters Analysis'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\5core_inventory\resources\views/pricing-master/pricing_master_incr.blade.php ENDPATH**/ ?>