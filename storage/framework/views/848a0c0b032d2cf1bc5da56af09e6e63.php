...
<?php $__env->startSection('css'); ?>
    <?php echo app('Illuminate\Foundation\Vite')(['node_modules/admin-resources/rwd-table/rwd-table.min.css']); ?>
...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('layouts.shared/page-title', [
        'page_title' => 'Stock Transfer Inventory',
        'sub_title' => 'Stock Transfer',
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6 d-flex align-items-center">
                            <button type="button" class="btn btn-primary" id="openAddWarehouseModal" data-bs-toggle="modal" data-bs-target="#addWarehouseModal">
                                <i class="fas fa-plus me-1"></i> CREATE STOCK TRANSFER
                            </button>
                            ...
                            <form id="stockTransferForm">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header bg-primary text-white">
                                        <h5 class="modal-title" id="incomingModalLabel">Add Stock Transfer</h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="sku" name="sku" required>
                                                ...
                                                <?php $__currentLoopData = $skus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item->sku); ?>" data-parent="<?php echo e($item->parent); ?>"><?php echo e($item->sku); ?></option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="reason" name="reason" required>
                                                ...
                                                <option value="Shut Out">Shut Out</option>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $(document).ready(function () {
                ...
                $('#stockTransferForm').on('submit', function (e) {
                    ...
                    $.ajax({
                        url: '<?php echo e(route("stock.transfer.store")); ?>',
                        method: 'POST',
                        data: formData,
                        success: function (response) {
                            $('#addWarehouseModal').modal('hide');
                            loadData(); // Reload after store
                            $('#stockTransferForm')[0].reset(); // Optional: clear form
                        },
                        error: function (xhr) {
                            console.log(xhr.responseJSON);
                            alert('Error storing stock transfer.');
                        }
                    });
                });
                ...
                $(document).on('click', '#openAddWarehouseModal', function () {
                    $('#stockTransferForm')[0].reset(); // Only resets for add
                    $('#warehouseId').val('');
...
<?php echo $__env->make('layouts.vertical', ['title' => 'Stock Transfer', 'mode' => $mode ?? '', 'demo' => $demo ?? ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\5core_inventory\resources\views/inventory-management/stock-transfer-view.blade.php ENDPATH**/ ?>