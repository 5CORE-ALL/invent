                    ...
                    <div id="ads-edit-div" class="d-flex align-items-center ms-4">
                        <div class="input-group" style="width: 120px;">
                            <input type="number" id="updateAllSkusAds" class="form-control" min="0" max="1000"
                                value="<?php echo e($ebayAdUpdates); ?>" step="0.01" placeholder="Ads Percentage" disabled />
                            <span class="input-group-text"></span>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-3 align-items-center justify-content-between">
                        ...
                        <div class="d-flex flex-wrap gap-2 align-items-center">
                            <!-- Export Button -->
                            <a href="<?php echo e(route('ebay.analytics.export')); ?>" class="btn btn-success">
                    ...
                    <div class="modal fade" id="ebayImportModal" tabindex="-1" aria-labelledby="ebayImportModalLabel"
                        ...
                        <div class="modal-dialog">
                            <form action="<?php echo e(route('ebay.analytics.import')); ?>" method="POST"
                                    ...
                                    <button id="close-all-modals" class="btn btn-danger btn-sm" style="display: none;">
                                        ...
                                        <div class="alert alert-info">
                                            <small>
                                                ...
                                                Download the <a href="<?php echo e(route('ebay.analytics.sample')); ?>"
        ...
        $(document).ready(function() {
            ...
            function renderTable() {
                ...
                filteredData.forEach(item => {
                    ...
                    const ebayPercentage = <?php echo e($ebayPercentage ?? 0); ?>;
                    const ebayAdPercentage = <?php echo e($ebayAdUpdates ?? 0); ?>;
    ...
    `);
            ...
            function calculateTotals() {
                try {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('adv-ebay.total-sales.save-data')); ?>",
                        method: 'GET',
                        data: {
...
<?php echo $__env->make('layouts.vertical', ['title' => 'eBay', 'mode' => $mode ?? '', 'demo' => $demo ?? ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\5core_inventory\resources\views/market-places/ebay.blade.php ENDPATH**/ ?>