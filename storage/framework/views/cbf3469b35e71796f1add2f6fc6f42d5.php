        ...
        <div class="col-md-12 mt-0 pt-0 mb-1 pb-1">
            <div class="row justify-content-center align-items-center g-3">
                ...
                <div class="col d-flex align-items-center gap-2 flex-wrap">
                    ...
                    <button type="button" id="toggleBtn" class="badge bg-primary text-white px-3 py-2" style="font-size: 1rem; border-radius: 8px;" onclick="showBarGraph()">Show Daily Sales Bar Graph</button>
...
function showBarGraph() {
    ...
    if (chart.is(":visible")) {
        button.text("Hide Daily Sales Bar Graph");
    } else {
        button.text("Show Daily Sales Bar Graph");
    }
}
</script>
...
<?php echo $__env->make('layouts.vertical', ['title' => 'Channel Master', 'mode' => $mode ?? '', 'demo' => $demo ?? ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\5core_inventory\resources\views/channels/channel-masters.blade.php ENDPATH**/ ?>