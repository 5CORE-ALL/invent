                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="sku" name="sku" required>
                                                ...
                                                <?php $__currentLoopData = $skus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item->sku); ?>" data-parent="<?php echo e($item->parent); ?>" data-available_qty="<?php echo e($item->available_quantity); ?>"><?php echo e($item->sku); ?></option>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $(document).ready(function () {
                ...
                $('#outgoingForm').on('submit', function (e) {
                    ...
                    $.ajax({
                        url: '<?php echo e(route("outgoing.store")); ?>',
                        method: 'POST',
                        data: formData,
...
<?php echo $__env->make('layouts.vertical', ['title' => 'Outgoing', 'mode' => $mode ?? '', 'demo' => $demo ?? ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\5core_inventory\resources\views/inventory-management/outgoing-view.blade.php ENDPATH**/ ?>