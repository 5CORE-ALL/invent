...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('layouts.shared/page-title', ['page_title' => 'Listing eBay', 'sub_title' => 'eBay'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="d-flex align-items-center mb-3 gap-2">
                            ...
                            <a href="<?php echo e(route('listing_ebay.export')); ?>" class="btn btn-sm btn-success mr-3">Export</a>
                    ...
                    <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            ...
                            <div class="modal-body">
                                ...
                                <a href="<?php echo e(asset('sample_excel/sample_listing_file.csv')); ?>" download class="btn btn-outline-secondary mb-3">📄 Download Sample File</a>
...
<?php $__env->startSection('script'); ?>
    ...
    return updatedItem;
                    ...
                    $(document).on('click', '#confirmImportBtn', function () {
                        ...
                        $.ajax({
                            url: "<?php echo e(route('listing_ebay.import')); ?>",
                            type: "POST",
                            data: formData,
                            processData: false,
                            contentType: false,
...
<?php echo $__env->make('layouts.vertical', ['title' => 'Listing eBay', 'mode' => $mode ?? '', 'demo' => $demo ?? ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\5core_inventory\resources\views/market-places/listing-market-places/listingEbay.blade.php ENDPATH**/ ?>