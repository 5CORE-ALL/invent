#!/usr/bin/env bash
# Ensures the alibaba queue worker is running (crontab watchdog).
#
# Processes Alibaba marketplace jobs: order import to Shopify, inventory sync, etc.
...
#   */5 * * * * /var/www/inventory_5c_usr/data/www/inventory.5coremanagement.com/scripts/cron-alibaba-worker.sh #alibaba queue worker
#
...
QUEUE="alibaba"
LOG="${ROOT}/storage/logs/alibaba-worker.log"
