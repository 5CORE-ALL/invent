#!/usr/bin/env bash
# Ensures the aliexpress queue worker is running (crontab watchdog).
#
# Processes AliExpress marketplace jobs: order import to Shopify, inventory sync, etc.
...
#   */5 * * * * /var/www/inventory_5c_usr/data/www/inventory.5coremanagement.com/scripts/cron-aliexpress-worker.sh #aliexpress queue worker
#
...
QUEUE="aliexpress"
LOG="${ROOT}/storage/logs/aliexpress-worker.log"
