...
#   */5 * * * * /var/www/inventory_5c_usr/data/www/inventory.5coremanagement.com/scripts/cron-video-master-push-worker.sh #video-master-push queue worker
#
# chmod +x scripts/cron-video-master-push-worker.sh
#
set -euo pipefail
...
QUEUE="video-master-push"
LOG="${ROOT}/storage/logs/video-master-push-worker.log"
