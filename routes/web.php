...
use App\Http\Controllers\ProductMaster\AboutBrandController;
use App\Http\Controllers\ProductMaster\APlusContentController;
use App\Http\Controllers\ProductMaster\DescriptionForHtmlController;
...
Route::group(['prefix' => '/', 'middleware' => 'auth'], function () {
    ...
    Route::prefix('marketplace-manager')->name('marketplace.manager.')->group(function () {
        ...
        Route::post('/alibaba/sync-tracking', [\App\Http\Controllers\MarketPlace\AlibabaSyncController::class, 'syncTrackingNow'])->name('alibaba.sync.tracking');
        Route::post('/alibaba/sync-mismatch-inventory', [\App\Http\Controllers\MarketPlace\AlibabaSyncController::class, 'syncMismatchInventoryNow'])->name('alibaba.sync.mismatch.inventory');
        ...
        Route::get('/shein/connect', [\App\Http\Controllers\MarketPlace\SheinSyncController::class, 'connect'])->name('shein.connect');
        Route::post('/shein/test-connection', [\App\Http\Controllers\MarketPlace\SheinSyncController::class, 'testConnection'])->name('shein.test');
        Route::post('/shein/refresh-products', [\App\Http\Controllers\MarketPlace\SheinSyncController::class, 'refreshProducts'])->name('shein.refresh');
        Route::get('/shein/refresh-products/status', [\App\Http\Controllers\MarketPlace\SheinSyncController::class, 'refreshProductsStatus'])->name('shein.refresh.status');
        Route::post('/shein/fetch-orders', [\App\Http\Controllers\MarketPlace\SheinSyncController::class, 'fetchOrders'])->name('shein.fetch.orders');
        ...
        Route::get('/amazon/connect', [\App\Http\Controllers\MarketPlace\AmazonSyncController::class, 'connect'])->name('amazon.connect');
        Route::post('/amazon/test-connection', [\App\Http\Controllers\MarketPlace\AmazonSyncController::class, 'testConnection'])->name('amazon.test');
        Route::post('/amazon/fetch-orders', [\App\Http\Controllers\MarketPlace\AmazonSyncController::class, 'fetchOrders'])->name('amazon.fetch.orders');
        Route::post('/amazon/refresh-products', [\App\Http\Controllers\MarketPlace\AmazonSyncController::class, 'refreshProducts'])->name('amazon.refresh');
        Route::get('/amazon/refresh-products/status', [\App\Http\Controllers\MarketPlace\AmazonSyncController::class, 'refreshProductsStatus'])->name('amazon.refresh.status');
        Route::post('/amazon/sync-inventory', [\App\Http\Controllers\MarketPlace\AmazonSyncController::class, 'syncInventoryNow'])->name('amazon.sync.inventory');
        Route::post('/amazon/sync-mismatch-inventory', [\App\Http\Controllers\MarketPlace\AmazonSyncController::class, 'syncMismatchInventoryNow'])->name('amazon.sync.mismatch.inventory');
        Route::post('/amazon/sync-tracking', [\App\Http\Controllers\MarketPlace\AmazonSyncController::class, 'syncTrackingNow'])->name('amazon.sync.tracking');
        Route::get('/topdawg/connect', [\App\Http\Controllers\MarketPlace\TopDawgSyncController::class, 'connect'])->name('topdawg.connect');
        Route::post('/topdawg/test-connection', [\App\Http\Controllers\MarketPlace\TopDawgSyncController::class, 'testConnection'])->name('topdawg.test');
        Route::post('/topdawg/refresh-products', [\App\Http\Controllers\MarketPlace\TopDawgSyncController::class, 'refreshProducts'])->name('topdawg.refresh');
        Route::get('/topdawg/refresh-products/status', [\App\Http\Controllers\MarketPlace\TopDawgSyncController::class, 'refreshProductsStatus'])->name('topdawg.refresh.status');
        Route::post('/topdawg/fetch-orders', [\App\Http\Controllers\MarketPlace\TopDawgSyncController::class, 'fetchOrders'])->name('topdawg.fetch.orders');
        Route::post('/topdawg/sync-inventory', [\App\Http\Controllers\MarketPlace\TopDawgSyncController::class, 'syncInventoryNow'])->name('topdawg.sync.inventory');
        Route::post('/topdawg/sync-mismatch-inventory', [\App\Http\Controllers\MarketPlace\TopDawgSyncController::class, 'syncMismatchInventoryNow'])->name('topdawg.sync.mismatch.inventory');
        Route::post('/topdawg/sync-tracking', [\App\Http\Controllers\MarketPlace\TopDawgSyncController::class, 'syncTrackingNow'])->name('topdawg.sync.tracking');
        Route::get('/temu/connect', [\App\Http\Controllers\MarketPlace\TemuSyncController::class, 'connect'])->name('temu.connect');
        Route::post('/temu/test-connection', [\App\Http\Controllers\MarketPlace\TemuSyncController::class, 'testConnection'])->name('temu.test');
        Route::post('/temu/refresh-products', [\App\Http\Controllers\MarketPlace\TemuSyncController::class, 'refreshProducts'])->name('temu.refresh');
        Route::get('/temu/refresh-products/status', [\App\Http\Controllers\MarketPlace\TemuSyncController::class, 'refreshProductsStatus'])->name('temu.refresh.status');
        Route::post('/temu/fetch-orders', [\App\Http\Controllers\MarketPlace\TemuSyncController::class, 'fetchOrders'])->name('temu.fetch.orders');
        ...
        Route::get('/ebay1/refresh-products/status', [\App\Http\Controllers\MarketPlace\Ebay1SyncController::class, 'refreshProductsStatus'])->name('ebay1.refresh.status');
        Route::post('/ebay1/fetch-orders', [\App\Http\Controllers\MarketPlace\Ebay1SyncController::class, 'fetchOrders'])->name('ebay1.fetch.orders');
        Route::post('/ebay1/sync-inventory', [\App\Http\Controllers\MarketPlace\Ebay1SyncController::class, 'syncInventoryNow'])->name('ebay1.sync.inventory');
        Route::post('/ebay1/sync-mismatch-inventory', [\App\Http\Controllers\MarketPlace\Ebay1SyncController::class, 'syncMismatchInventoryNow'])->name('ebay1.sync.mismatch.inventory');
        Route::post('/ebay1/sync-tracking', [\App\Http\Controllers\MarketPlace\Ebay1SyncController::class, 'syncTrackingNow'])->name('ebay1.sync.tracking');
        Route::get('/ebay2/connect', [\App\Http\Controllers\MarketPlace\Ebay2SyncController::class, 'connect'])->name('ebay2.connect');
        Route::post('/ebay2/test-connection', [\App\Http\Controllers\MarketPlace\Ebay2SyncController::class, 'testConnection'])->name('ebay2.test');
        Route::post('/ebay2/refresh-products', [\App\Http\Controllers\MarketPlace\Ebay2SyncController::class, 'refreshProducts'])->name('ebay2.refresh');
    ...
    Route::prefix('marketplace/{marketplace}')->where(['marketplace' => \App\Services\MarketplaceManager\MarketplaceManagerRegistry::routePattern().'|ebay|walmart'])->group(function () {
        ...
        Route::post('/orders/reverse-push', [\App\Http\Controllers\MarketplaceController::class, 'reversePushOrders'])->name('marketplace.orders.reverse-push');
    ...
    Route::post('/verification-adjustment-refresh-shopify', [VerificationAdjustmentController::class, 'refreshShopifyInventoryForSku']);
    ...
    Route::post('/push-verification-shopify-adjustment', [VerificationAdjustmentController::class, 'pushVerificationShopifyAdjustment']);
    ...
    Route::post('/amazon-ads/missing/ai-positives', [\App\Http\Controllers\AmazonAdsMissingController::class, 'aiPositiveKeywords'])->name('amazon.ads.missing.ai-positives');
    Route::post('/amazon-ads/missing/push-positives', [\App\Http\Controllers\AmazonAdsMissingController::class, 'pushPositiveKeywords'])->name('amazon.ads.missing.push-positives');
    ...
    Route::get('/temu/daily-data-l7', [TemuController::class, 'getDailyDataL7'])->name('temu.daily.data.l7');
    ...
    // Purchasing Power Sales Routes — Shopify orders from shopify_raw_orders (/shopify)
    ...
    Route::post('/reverb-push-std/cancel', [\App\Http\Controllers\MarketPlace\ReverbController::class, 'cancelPushStd'])->name('reverb.push-std.cancel');
    Route::post('/reverb-push-prmt', [\App\Http\Controllers\MarketPlace\ReverbController::class, 'queuePushPrmt'])->name('reverb.push-prmt.queue');
    Route::get('/reverb-push-prmt/status', [\App\Http\Controllers\MarketPlace\ReverbController::class, 'pushPrmtJobStatus'])->name('reverb.push-prmt.status');
    Route::post('/reverb-push-prmt/cancel', [\App\Http\Controllers\MarketPlace\ReverbController::class, 'cancelPushPrmt'])->name('reverb.push-prmt.cancel');
    Route::post('/reverb-push-bump', [\App\Http\Controllers\MarketPlace\ReverbController::class, 'queuePushBump'])->name('reverb.push-bump.queue');
    Route::get('/reverb-push-bump/status', [\App\Http\Controllers\MarketPlace\ReverbController::class, 'pushBumpJobStatus'])->name('reverb.push-bump.status');
    Route::post('/reverb-push-bump/cancel', [\App\Http\Controllers\MarketPlace\ReverbController::class, 'cancelPushBump'])->name('reverb.push-bump.cancel');
    ...
    Route::post('/reverb-save-recommended-bids', [\App\Http\Controllers\MarketPlace\ReverbController::class, 'saveRecommendedBids'])->name('reverb.save.recommended.bids');
    ...
    Route::post('/pricing-errors-fix-ebay-pull-prices', [CvrMasterController::class, 'pricingErrorsFixEbayPullPrices'])->name('pricing.errors.fix.ebay-pull-prices');
    ...
    Route::get('/about-brand', [AboutBrandController::class, 'index'])->name('about.brand');
    Route::get('/about-brand-data', [AboutBrandController::class, 'getData'])->name('about.brand.data');
    Route::post('/about-brand/save', [AboutBrandController::class, 'save'])->name('about.brand.save');
    Route::get('/technical-specifications', [TechnicalSpecificationsController::class, 'index'])->name('technical.specifications');
    Route::get('/technical-specifications-data', [TechnicalSpecificationsController::class, 'getData'])->name('technical.specifications.data');
    Route::post('/technical-specifications/save', [TechnicalSpecificationsController::class, 'save'])->name('technical.specifications.save');
    Route::get('/description-for-html', [DescriptionForHtmlController::class, 'index'])->name('description.for.html');
    Route::get('/description-for-html-data', [DescriptionForHtmlController::class, 'getData'])->name('description.for.html.data');
    Route::post('/description-for-html/save', [DescriptionForHtmlController::class, 'save'])->name('description.for.html.save');
    Route::get('/images-a-plus-content', [ImagesAPlusContentController::class, 'index'])->name('images.a.plus.content');
    Route::get('/images-a-plus-content-data', [ImagesAPlusContentController::class, 'getData'])->name('images.a.plus.content.data');
    Route::post('/images-a-plus-content/save', [ImagesAPlusContentController::class, 'save'])->name('images.a.plus.content.save');
    ...
    Route::get('/tabulator-column-order', [ChannelTabulatorColumnController::class, 'showOrder'])->name('tabulator.column.order.get');
    Route::post('/tabulator-column-order', [ChannelTabulatorColumnController::class, 'storeOrder'])->name('tabulator.column.order.set');
    ...
    Route::get('/forecast-analysis/available-pct-history', [ForecastAnalysisController::class, 'getAvailablePctHistory'])->name('forecast.analysis.available.pct.history');
    ...
    Route::post('/a-plus-images-master/update-db-link', [CategoryController::class, 'updateDBLink'])->name('a.plus.images.master.update.db');
    ...
    Route::get('/channel-promo-pricing/{channel}/dil-bump', [ChannelPromoPricingController::class, 'dilBumpRules'])->name('channel.promo.dil-bump.get');
    ...
    // Shein Daily Data routes (API sync)
    ...
    Route::controller(GoogleShoppingAdsMissingController::class)->group(function () {
        ...
        Route::post('/google/shopping/missing/delete', 'delete')->name('google.shopping.ads.missing.delete');
        ...
        Route::post('/google/shopping/missing/push-negatives', 'pushNegativeKeywords')->name('google.shopping.ads.missing.push-negatives');
    });
    ...
    Route::controller(GoogleShoppingCampaignsController::class)->group(function () {
        ...
        // "Revised" page — campaign + negative-keyword count + amazon-style red/green audit dot & history
        Route::get('/google/shopping/google-shopping/revised', 'revisedPage')->name('google.shopping.campaigns.revised');
        Route::get('/google/shopping/google-shopping/revised/data', 'revisedPageData')->name('google.shopping.campaigns.revised.data');
        Route::post('/google/shopping/google-shopping/revised/save', 'revisedPageSave')->name('google.shopping.campaigns.revised.save');
    ...
    Route::controller(GoogleYoutubeAdsCampaignsController::class)->group(function () {
        ...
        Route::get('/google/shopping/youtube-ads/pause-script', 'latestPauseScript')->name('google.youtube.ads.campaigns.pause.script');
