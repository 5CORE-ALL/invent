...
return new class extends Migration
{
    /**
     * Run the migrations.
     * Create L60 sales table for Shein (same structure as shein_daily_data)
     */
    public function up(): void
    {
        ...
        Schema::create('shein_daily_data_l60', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('shein_daily_data_l60');
    }
};
