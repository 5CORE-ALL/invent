...
{
    /**
     * Ensure temu_daily_data_l7 has same schema as L30/L60 upload tables.
     */
    public function up(): void
    {
        if (Schema::hasTable('temu_daily_data_l7') && !Schema::hasColumn('temu_daily_data_l7', 'purchase_date')) {
