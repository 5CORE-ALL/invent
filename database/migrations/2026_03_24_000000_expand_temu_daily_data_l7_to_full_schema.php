...
/**
 * Replace simplified temu_daily_data_l7 with full schema (same as L30/L60) for chunked uploads.
 */
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (Schema::hasColumn('temu_daily_data_l7', 'purchase_date')) {
            return;
        }

        Schema::drop('temu_daily_data_l7');
        $this->createFullTable();
    }
