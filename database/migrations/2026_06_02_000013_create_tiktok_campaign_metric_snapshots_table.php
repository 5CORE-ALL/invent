...
/**
 * Per-campaign daily snapshot of merged-view metrics on /tiktok-video-ads.
...
return new class extends Migration
{
    ...
    {
        Schema::create('tiktok_campaign_metric_snapshots', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['campaign_id', 'snapshot_date'], 'tiktok_campaign_day_uq');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('tiktok_campaign_metric_snapshots');
    }
};
