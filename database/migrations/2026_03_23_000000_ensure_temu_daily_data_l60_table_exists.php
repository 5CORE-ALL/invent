...
/**
 * Safety migration: create temu_daily_data_l60 if missing (e.g. migration never ran or DB was restored without this table).
 */
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('temu_daily_data_l60', function (Blueprint $table) {
            $table->id();
    ...
    {
        // Do not drop: table may have been created by the original migration.
    }
};
