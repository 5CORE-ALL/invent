...
/**
 * Audit log for YouTube campaigns viewed on /youtube-video-ads. Each row is
...
return new class extends Migration
{
    ...
    {
        Schema::create('youtube_campaign_audits', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('youtube_campaign_audits');
    }
};
