...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('shipping_health_channel_data')) {
            Schema::create('shipping_health_channel_data', function (Blueprint $table) {
                $table->id();
        ...
        if (! Schema::hasTable('shipping_health_status_histories')) {
            Schema::create('shipping_health_status_histories', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('shipping_health_status_histories');
        Schema::dropIfExists('shipping_health_channel_data');
    }
};
