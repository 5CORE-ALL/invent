...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('cc_audit_logs')) {
            return;
        }

        Schema::create('cc_audit_logs', function (Blueprint $table) {
            $table->id();
            ...
            $table->index(['channel_id', 'audited_at'], 'cc_audit_logs_channel_date_idx');
    ...
    {
        Schema::dropIfExists('cc_audit_logs');
    }
};
