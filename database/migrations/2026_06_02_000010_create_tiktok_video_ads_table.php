...
/**
 * Stores rows imported from user-uploaded TikTok ad sheets (CSV / Excel /
 * TSV) on the "TikTok Video Ads" page. Independent of the Facebook sheet —
...
return new class extends Migration
{
    ...
    {
        Schema::create('tiktok_video_ads_sheet', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tiktok_video_ads_sheet');
    }
};
