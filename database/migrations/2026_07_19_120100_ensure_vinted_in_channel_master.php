...
{
    /**
     * All Marketplace Master lists rows from channel_master; ensure Vinted appears like other channels.
     */
    ...
    public function down(): void
    {
        ...
        DB::table('channel_master')->whereRaw('LOWER(TRIM(channel)) = ?', ['vinted'])->delete();
    }
};
