...
{
    /**
     * TikTok Shop 2 order lines (second Partner Center app) — mirror of tiktok_orders.
     */
    public function up(): void
    {
        ...
        Schema::create('tiktok2_orders', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['order_id', 'line_item_id'], 'tiktok2_orders_order_line_unique');
    ...
    {
        Schema::dropIfExists('tiktok2_orders');
    }
};
