...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('aliexpress_order_metrics', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['order_id', 'sku'], 'aliexpress_order_metrics_order_sku_unique');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('aliexpress_order_metrics');
    }
};
