...
/**
 * Mirrors `ebay_campaign_ads` / `ebay2_campaign_ads` for eBay account 3
 * (EBAY_3_* credentials). Used by `ebay3:sync-campaign-listings` to store
 * raw campaign ad data pulled from eBay Marketing + Recommendation APIs.
 */
return new class extends Migration
{
    public function up(): void
    {
        Schema::dropIfExists('ebay3_campaign_ads');

        Schema::create('ebay3_campaign_ads', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['listing_id', 'campaign_id'], 'uniq_ebay3_listing_campaign');
        });
    }
