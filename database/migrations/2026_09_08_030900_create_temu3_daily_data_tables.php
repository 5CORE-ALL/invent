...
{
    /**
     * Temu 3 Sales Data tabulator tables — same structure as Temu 2 daily data.
     */
    public function up(): void
    {
        foreach (['temu3_daily_data', 'temu3_daily_data_l60', 'temu3_daily_data_l7'] as $tableName) {
    ...
    {
        Schema::dropIfExists('temu3_daily_data_l7');
        Schema::dropIfExists('temu3_daily_data_l60');
        Schema::dropIfExists('temu3_daily_data');
    }
};
